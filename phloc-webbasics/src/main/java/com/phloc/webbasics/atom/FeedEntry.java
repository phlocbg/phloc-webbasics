...
public final class FeedEntry extends AbstractFeedElement
{
  ...
  {
    return ContainerHelper.makeUnmodifiable (m_aAuthors);
  }
  ...
  {
    return ContainerHelper.makeUnmodifiable (m_aCategories);
  }
  ...
  {
    return ContainerHelper.makeUnmodifiable (m_aContributors);
  }
