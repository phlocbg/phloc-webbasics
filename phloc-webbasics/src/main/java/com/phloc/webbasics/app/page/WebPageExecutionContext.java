...
public class WebPageExecutionContext
{
  ...
  private final IRequestWebScopeWithoutResponse m_aRequestScope = WebScopeManager.getRequestScope ();
  private final HCNodeList m_aNodeList = new HCNodeList ();

  public WebPageExecutionContext (@Nonnull final IWebPage aWebPage, @Nonnull final Locale aDisplayLocale)
  {
    if (aWebPage == null)
