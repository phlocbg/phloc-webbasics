...
public final class ActionContainer
{
  ...
  @Nonnull
  public ESuccess executeAction (@Nullable final String sActionName, @Nonnull final IRequestWebScope aRequestScope) throws Exception
  {
    // Find the executor
    ...
    if (aActionExecutor == null)
    {
      ...
      aRequestScope.getResponse ().setStatus (HttpServletResponse.SC_NOT_FOUND);
