...
public class UserManager extends AbstractSimpleDAO implements IUserManager, IReloadableDAO
{
  ...
  protected EChange onInit ()
  {
    ...
    _addUser (new User (CSecurity.USER_ADMINISTRATOR_ID,
                        ...
                        GlobalPasswordSettings.createUserDefaultPasswordHash (CSecurity.USER_ADMINISTRATOR_PASSWORD),
    ...
    _addUser (new User (CSecurity.USER_USER_ID,
                        ...
                        GlobalPasswordSettings.createUserDefaultPasswordHash (CSecurity.USER_USER_PASSWORD),
    ...
    _addUser (new User (CSecurity.USER_GUEST_ID,
                        ...
                        GlobalPasswordSettings.createUserDefaultPasswordHash (CSecurity.USER_GUEST_PASSWORD),
