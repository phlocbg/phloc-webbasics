...
public final class JavaInc
{
  ...
  private static final String data1 = "<?php\n"
                                      ...
                                      + "$this->channel=new java_EmptyChannel($this);\n"
                                      + "}\n";
  private static final String data2 = "function createChannel() {\n"
  ...
  static
  {
    // It's important to chain it in 2 string, otherwise the Java 1.6.0_43
    // commandline compiler thinks of a stack overflow :)
    bytes = (data1 + data2).getBytes (Util.ISO88591);
  }
}
