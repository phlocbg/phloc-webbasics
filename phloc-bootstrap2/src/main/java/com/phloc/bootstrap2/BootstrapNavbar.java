...
public class BootstrapNavbar extends AbstractHCDiv <BootstrapNavbar>
{
  ...
  public BootstrapNavbar (@Nonnull final EBootstrapNavBarType eType, final boolean bAddResponsiveToggle)
  {
    ...
    if (bAddResponsiveToggle)
    {
      ...
      aToggle.setDataAttr ("target", "." + CBootstrapCSS.NAV_COLLAPSE.getCSSClass ());
  ...
  public BootstrapNavbar addElementLeft (final boolean bCollapsible, @Nonnull final IHCElement <?> aElement)
  {
    ...
    return addElement (bCollapsible, aElement);
  }
  ...
  @Nonnull
  public BootstrapNavbar addElement (final boolean bCollapsible, @Nonnull final IHCElement <?> aElement)
  {
