...
public final class DefaultSecurity
{
  ...
  public static void init ()
  {
    ...
    if (!aAM.containsRoleWithID (CDemoAppSecurity.ROLEID_VIEW))
      aAM.createPredefinedRole (CDemoAppSecurity.ROLEID_VIEW, "View user");
    ...
    aAM.assignRoleToUserGroup (CSecurity.USERGROUP_ADMINISTRATORS_ID, CDemoAppSecurity.ROLEID_VIEW);
    ...
    if (!aAM.containsUserGroupWithID (CDemoAppSecurity.USERGROUPID_VIEW))
      aAM.createPredefinedUserGroup (CDemoAppSecurity.USERGROUPID_VIEW, "View user");
    aAM.assignRoleToUserGroup (CDemoAppSecurity.USERGROUPID_VIEW, CDemoAppSecurity.ROLEID_VIEW);
  }
}
