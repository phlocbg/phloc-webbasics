...
public final class MenuConfig
{
  ...
  public static void init (@Nonnull final IMenuTree aMenuTree)
  {
    ...
    // Administrator
    {
      ...
      // - Security
      final IMenuItemPage aAdminSecurity = aMenuTree.createItem (aAdmin,
                                                                 new PageShowChildren (CDemoAppMenuConfig.MENU_ADMIN_SECURITY,
                                                                                       "Security",
                                                                                       aMenuTree))
                                                    .setDisplayFilter (aFilterSuperUser);
      ...
      // - Monitoring
      final IMenuItemPage aAdminMonitoring = aMenuTree.createItem (aAdmin,
                                                                   new PageShowChildren (CDemoAppMenuConfig.MENU_ADMIN_MONITORING,
                                                                                         "Monitoring",
                                                                                         aMenuTree))
                                                      .setDisplayFilter (aFilterSuperUser);
