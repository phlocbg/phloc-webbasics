...
import com.phloc.webctrls.bootstrap.ext.BootstrapBreadcrumbProvider;
...
final class ViewNavbarProvider
{
  ...
  {
    final BootstrapBreadcrumb aBreadcrumb = BootstrapBreadcrumbProvider.createBreadCrumbs (ApplicationMenuTree.getInstance (),
