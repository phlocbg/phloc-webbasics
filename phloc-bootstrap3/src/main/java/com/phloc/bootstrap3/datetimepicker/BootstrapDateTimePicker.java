 ...
 * http://www.malot.fr/bootstrap-datetimepicker/index.php<br>
...
public class BootstrapDateTimePicker implements IHCNodeBuilder, Serializable
{
  ...
  {
    return ContainerHelper.newEnumSet (EDateTimePickerDayOfWeek.class, m_aDaysOfWeekDisabled);
  }
  ...
  public BootstrapDateTimePicker setDaysOfWeekDisabled (@Nullable final Set <EDateTimePickerDayOfWeek> aDaysOfWeekDisabled)
  {
    if (aDaysOfWeekDisabled == null)
      ...
      m_aDaysOfWeekDisabled = ContainerHelper.newEnumSet (EDateTimePickerDayOfWeek.class, m_aDaysOfWeekDisabled);
    return this;
  }
