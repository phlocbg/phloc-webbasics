...
public enum EEmailAttachmentDisposition implements IHasID <String>
{
  ...
  @Nullable
  public static EEmailAttachmentDisposition getFromIDOrNull (@Nullable final String sID)
  {
    return EnumHelper.getFromIDOrNull (EEmailAttachmentDisposition.class, sID);
  }
}
