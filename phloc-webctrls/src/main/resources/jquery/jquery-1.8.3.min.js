...
Da.split("|");a=a.createDocumentFragment();if(a.createElement)for(;b.length;)a.createElement(b.pop());return a}function Ea(a,b){if(1===b.nodeType&&c.hasData(a)){var d,e,f;e=c._data(a);var g=c._data(b,e),h=e.events;if(h)for(d in delete g.handle,g.events={},h){e=0;for(f=h[d].length;e<f;e++)c.event.add(b,d,h[d][e])}g.data&&(g.data=c.extend({},g.data))}}function Fa(a,b){var d;1===b.nodeType&&(b.clearAttributes&&b.clearAttributes(),b.mergeAttributes&&b.mergeAttributes(a),d=b.nodeName.toLowerCase(),"object"===
...
""),""===d.style.display&&R(d)&&(f[g]=c._data(d,"olddisplay",La(d.nodeName)))):(e=v(d,"display"),!f[g]&&"none"!==e&&c._data(d,"olddisplay",e)));for(g=0;g<h;g++)if(d=a[g],d.style&&(!b||"none"===d.style.display||""===d.style.display))d.style.display=b?f[g]||"":"none";return a}function Ma(a,b,d){return(a=Db.exec(b))?Math.max(0,a[1]-(d||0))+(a[2]||"px"):b}function Na(a,b,d,e){b=d===(e?"border":"content")?4:"width"===b?1:0;for(var f=0;4>b;b+=2)"margin"===d&&(f+=c.css(a,d+C[b],!0)),e?("content"===d&&(f-=
parseFloat(v(a,"padding"+C[b]))||0),"margin"!==d&&(f-=parseFloat(v(a,"border"+C[b]+"Width"))||0)):(f+=parseFloat(v(a,"padding"+C[b]))||0,"padding"!==d&&(f+=parseFloat(v(a,"border"+C[b]+"Width"))||0));return f}function Oa(a,b,d){var e="width"===b?a.offsetWidth:a.offsetHeight,f=!0,g=c.support.boxSizing&&"border-box"===c.css(a,"boxSizing");if(0>=e||null==e){e=v(a,b);if(0>e||null==e)e=a.style[b];if(ca.test(e))return e;f=g&&(c.support.boxSizingReliable||e===a.style[b]);e=parseFloat(e)||0}return e+Na(a,
b,d||(g?"border":"content"),f)+"px"}function La(a){if(na[a])return na[a];var b=c("<"+a+">").appendTo(q.body),d=b.css("display");b.remove();if("none"===d||""===d){F=q.body.appendChild(F||c.extend(q.createElement("iframe"),{frameBorder:0,width:0,height:0}));if(!U||!F.createElement)U=(F.contentWindow||F.contentDocument).document,U.write("<!doctype html><html><body>"),U.close();b=U.body.appendChild(U.createElement(a));d=v(b,"display");q.body.removeChild(F)}return na[a]=d}function oa(a,b,d,e){var f;if(c.isArray(b))c.each(b,
...
"ms-").replace(Ub,Vb)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toLowerCase()===b.toLowerCase()},each:function(a,b,d){var e,f=0,g=a.length,h=g===n||c.isFunction(a);if(d)if(h)for(e in a){if(!1===b.apply(a[e],d))break}else for(;f<g&&!1!==b.apply(a[f++],d););else if(h)for(e in a){if(!1===b.call(a[e],e,a[e]))break}else for(;f<g&&!1!==b.call(a[f],f,a[f++]););return a},trim:ra&&!ra.call("﻿ ")?function(a){return null==a?"":ra.call(a)}:function(a){return null==a?"":(a+"").replace(Nb,"")},makeArray:function(a,
b){var d,e=b||[];null!=a&&(d=c.type(a),null==a.length||"string"===d||"function"===d||"regexp"===d||c.isWindow(a)?Wa.call(e,a):c.merge(e,a));return e},inArray:function(a,b,d){var c;if(b){if(Xa)return Xa.call(b,a,d);c=b.length;for(d=d?0>d?Math.max(0,c+d):d:0;d<c;d++)if(d in b&&b[d]===a)return d}return-1},merge:function(a,b){var d=b.length,c=a.length,f=0;if("number"===typeof d)for(;f<d;f++)a[c++]=b[f];else for(;b[f]!==n;)a[c++]=b[f++];a.length=c;return a},grep:function(a,b,d){var c,f=[],g=0,h=a.length;
for(d=!!d;g<h;g++)c=!!b(a[g],g),d!==c&&f.push(a[g]);return f},map:function(a,b,d){var e,f,g=[],h=0,k=a.length;if(a instanceof c||k!==n&&"number"===typeof k&&(0<k&&a[0]&&a[k-1]||0===k||c.isArray(a)))for(;h<k;h++)e=b(a[h],h,d),null!=e&&(g[g.length]=e);else for(f in a)e=b(a[f],f,d),null!=e&&(g[g.length]=e);return g.concat.apply([],g)},guid:1,proxy:function(a,b){var d,e;"string"===typeof b&&(d=a[b],b=a,a=d);if(!c.isFunction(a))return n;e=w.call(arguments,2);d=function(){return a.apply(b,e.concat(w.call(arguments)))};
d.guid=a.guid=a.guid||c.guid++;return d},access:function(a,b,d,e,f,g,h){var k,l=null==d,m=0,s=a.length;if(d&&"object"===typeof d){for(m in d)c.access(a,b,m,d[m],1,g,e);f=1}else if(e!==n){k=h===n&&c.isFunction(e);l&&(k?(k=b,b=function(a,b,d){return k.call(c(a),d)}):(b.call(a,e),b=null));if(b)for(;m<s;m++)b(a[m],d,k?e.call(a[m],m,b(a[m],d)):e,h);f=1}return f?a:l?b.call(a):s?b(a[0],d):g},now:function(){return(new Date).getTime()}});c.ready.promise=function(a){if(!fa)if(fa=c.Deferred(),"complete"===q.readyState)setTimeout(c.ready,
...
Va=c(q);var ya={};c.Callbacks=function(a){a="string"===typeof a?ya[a]||zb(a):c.extend({},a);var b,d,e,f,g,h,k=[],l=!a.once&&[],m=function(c){b=a.memory&&c;d=!0;h=f||0;f=0;g=k.length;for(e=!0;k&&h<g;h++)if(!1===k[h].apply(c[0],c[1])&&a.stopOnFalse){b=!1;break}e=!1;k&&(l?l.length&&m(l.shift()):b?k=[]:s.disable())},s={add:function(){if(k){var d=k.length;(function Wb(b){c.each(b,function(b,d){var e=c.type(d);"function"===e?(!a.unique||!s.has(d))&&k.push(d):d&&(d.length&&"string"!==e)&&Wb(d)})})(arguments);
e?g=k.length:b&&(f=d,m(b))}return this},remove:function(){k&&c.each(arguments,function(a,b){for(var d;-1<(d=c.inArray(b,k,d));)k.splice(d,1),e&&(d<=g&&g--,d<=h&&h--)});return this},has:function(a){return-1<c.inArray(a,k)},empty:function(){k=[];return this},disable:function(){k=l=b=n;return this},disabled:function(){return!k},lock:function(){l=n;b||s.disable();return this},locked:function(){return!l},fireWith:function(a,b){b=b||[];b=[a,b.slice?b.slice():b];if(k&&(!d||l))e?l.push(b):m(b);return this},
fire:function(){s.fireWith(this,arguments);return this},fired:function(){return!!d}};return s};c.extend({Deferred:function(a){var b=[["resolve","done",c.Callbacks("once memory"),"resolved"],["reject","fail",c.Callbacks("once memory"),"rejected"],["notify","progress",c.Callbacks("memory")]],d="pending",e={state:function(){return d},always:function(){f.done(arguments).fail(arguments);return this},then:function(){var a=arguments;return c.Deferred(function(d){c.each(b,function(b,e){var m=e[0],s=a[b];
f[e[1]](c.isFunction(s)?function(){var a=s.apply(this,arguments);if(a&&c.isFunction(a.promise))a.promise().done(d.resolve).fail(d.reject).progress(d.notify);else d[m+"With"](this===f?d:this,[a])}:d[m])});a=null}).promise()},promise:function(a){return null!=a?c.extend(a,e):e}},f={};e.pipe=e.then;c.each(b,function(a,c){var k=c[2],l=c[3];e[c[1]]=k.add;l&&k.add(function(){d=l},b[a^1][2].disable,b[2][2].lock);f[c[0]]=k.fire;f[c[0]+"With"]=k.fireWith});e.promise(f);a&&a.call(f,f);return f},when:function(a){var b=
0,d=w.call(arguments),e=d.length,f=1!==e||a&&c.isFunction(a.promise)?e:0,g=1===f?a:c.Deferred(),h=function(a,b,d){return function(c){b[a]=this;d[a]=1<arguments.length?w.call(arguments):c;d===k?g.notifyWith(b,d):--f||g.resolveWith(b,d)}},k,l,m;if(1<e){k=Array(e);l=Array(e);for(m=Array(e);b<e;b++)d[b]&&c.isFunction(d[b].promise)?d[b].promise().done(h(b,m,d)).fail(g.reject).progress(h(b,l,k)):--f}f||g.resolveWith(m,d);return g.promise()}});c.support=function(){var a,b,d,e,f,g,h,k=q.createElement("div");
k.setAttribute("className","t");k.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>";b=k.getElementsByTagName("*");d=k.getElementsByTagName("a")[0];if(!b||!d||!b.length)return{};e=q.createElement("select");f=e.appendChild(q.createElement("option"));b=k.getElementsByTagName("input")[0];d.style.cssText="top:1px;float:left;opacity:.5";a={leadingWhitespace:3===k.firstChild.nodeType,tbody:!k.getElementsByTagName("tbody").length,htmlSerialize:!!k.getElementsByTagName("link").length,
...
(g.handle=h=function(a){return"undefined"!==typeof c&&(!a||c.event.triggered!==a.type)?c.event.dispatch.apply(h.elem,arguments):n},h.elem=a);b=c.trim(gb(b)).split(" ");for(g=0;g<b.length;g++){l=eb.exec(b[g])||[];m=l[1];s=(l[2]||"").split(".").sort();r=c.event.special[m]||{};m=(f?r.delegateType:r.bindType)||m;r=c.event.special[m]||{};l=c.extend({type:m,origType:l[1],data:e,handler:d,guid:d.guid,selector:f,needsContext:f&&c.expr.match.needsContext.test(f),namespace:s.join(".")},p);q=k[m];if(!q&&(q=
k[m]=[],q.delegateCount=0,!r.setup||!1===r.setup.call(a,e,s,h)))a.addEventListener?a.addEventListener(m,h,!1):a.attachEvent&&a.attachEvent("on"+m,h);r.add&&(r.add.call(a,l),l.handler.guid||(l.handler.guid=d.guid));f?q.splice(q.delegateCount++,0,l):q.push(l);c.event.global[m]=!0}a=null}},global:{},remove:function(a,b,d,e,f){var g,h,k,l,m,s,p,n,q,r,v=c.hasData(a)&&c._data(a);if(v&&(p=v.events)){b=c.trim(gb(b||"")).split(" ");for(g=0;g<b.length;g++)if(h=eb.exec(b[g])||[],k=l=h[1],h=h[2],k){n=c.event.special[k]||
{};k=(e?n.delegateType:n.bindType)||k;q=p[k]||[];m=q.length;h=h?RegExp("(^|\\.)"+h.split(".").sort().join("\\.(?:.*\\.|)")+"(\\.|$)"):null;for(s=0;s<q.length;s++)if(r=q[s],(f||l===r.origType)&&(!d||d.guid===r.guid)&&(!h||h.test(r.namespace))&&(!e||e===r.selector||"**"===e&&r.selector))q.splice(s--,1),r.selector&&q.delegateCount--,n.remove&&n.remove.call(a,r);0===q.length&&m!==q.length&&((!n.teardown||!1===n.teardown.call(a,h,v.handle))&&c.removeEvent(a,k,v.handle),delete p[k])}else for(k in p)c.event.remove(a,
k+b[g],d,e,!0);c.isEmptyObject(p)&&(delete v.handle,c.removeData(a,"events",!0))}},customEvent:{getData:!0,setData:!0,changeData:!0},trigger:function(a,b,d,e){if(!d||!(3===d.nodeType||8===d.nodeType)){var f,g,h,k,l,m,s=a.type||a;h=[];if(!fb.test(s+c.event.triggered)&&(0<=s.indexOf("!")&&(s=s.slice(0,-1),f=!0),0<=s.indexOf(".")&&(h=s.split("."),s=h.shift(),h.sort()),d&&!c.event.customEvent[s]||c.event.global[s]))if(a="object"===typeof a?a[c.expando]?a:new c.Event(s,a):new c.Event(s),a.type=s,a.isTrigger=
!0,a.exclusive=f,a.namespace=h.join("."),a.namespace_re=a.namespace?RegExp("(^|\\.)"+h.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,h=0>s.indexOf(":")?"on"+s:"",d){if(a.result=n,a.target||(a.target=d),b=null!=b?c.makeArray(b):[],b.unshift(a),k=c.event.special[s]||{},!(k.trigger&&!1===k.trigger.apply(d,b))){m=[[d,k.bindType||s]];if(!e&&!k.noBubble&&!c.isWindow(d)){l=k.delegateType||s;f=fb.test(l+s)?d:d.parentNode;for(g=d;f;f=f.parentNode)m.push([f,l]),g=f;if(g===(d.ownerDocument||q))m.push([g.defaultView||
g.parentWindow||r,l])}for(g=0;g<m.length&&!a.isPropagationStopped();g++)f=m[g][0],a.type=m[g][1],(l=(c._data(f,"events")||{})[a.type]&&c._data(f,"handle"))&&l.apply(f,b),(l=h&&f[h])&&(c.acceptData(f)&&l.apply&&!1===l.apply(f,b))&&a.preventDefault();a.type=s;if(!e&&!a.isDefaultPrevented()&&(!k._default||!1===k._default.apply(d.ownerDocument,b))&&!("click"===s&&c.nodeName(d,"a"))&&c.acceptData(d))if(h&&d[s]&&("focus"!==s&&"blur"!==s||0!==a.target.offsetWidth)&&!c.isWindow(d))(g=d[h])&&(d[h]=null),c.event.triggered=
s,d[s](),c.event.triggered=n,g&&(d[h]=g);return a.result}}else for(g in d=c.cache,d)d[g].events&&d[g].events[s]&&c.event.trigger(a,b,d[g].handle.elem,!0)}},dispatch:function(a){a=c.event.fix(a||r.event);var b,d,e,f,g,h,k=(c._data(this,"events")||{})[a.type]||[],l=k.delegateCount,m=w.call(arguments),s=!a.exclusive&&!a.namespace,p=c.event.special[a.type]||{},q=[];m[0]=a;a.delegateTarget=this;if(!(p.preDispatch&&!1===p.preDispatch.call(this,a))){if(l&&!(a.button&&"click"===a.type))for(d=a.target;d!=
this;d=d.parentNode||this)if(!0!==d.disabled||"click"!==a.type){f={};g=[];for(b=0;b<l;b++)e=k[b],h=e.selector,f[h]===n&&(f[h]=e.needsContext?0<=c(h,this).index(d):c.find(h,this,null,[d]).length),f[h]&&g.push(e);g.length&&q.push({elem:d,matches:g})}k.length>l&&q.push({elem:this,matches:k.slice(l)});for(b=0;b<q.length&&!a.isPropagationStopped();b++){f=q[b];a.currentTarget=f.elem;for(d=0;d<f.matches.length&&!a.isImmediatePropagationStopped();d++)if(e=f.matches[d],s||!a.namespace&&!e.namespace||a.namespace_re&&
...
"submit._submit",function(a){a._submit_bubble=!0}),c._data(a,"_submit_attached",!0)})},postDispatch:function(a){a._submit_bubble&&(delete a._submit_bubble,this.parentNode&&!a.isTrigger&&c.event.simulate("submit",this.parentNode,a,!0))},teardown:function(){if(c.nodeName(this,"form"))return!1;c.event.remove(this,"._submit")}});c.support.changeBubbles||(c.event.special.change={setup:function(){if(sa.test(this.nodeName)){if("checkbox"===this.type||"radio"===this.type)c.event.add(this,"propertychange._change",
...
--d&&q.removeEventListener(a,e,!0)}}});c.fn.extend({on:function(a,b,d,e,f){var g,h;if("object"===typeof a){"string"!==typeof b&&(d=d||b,b=n);for(h in a)this.on(h,b,d,a[h],f);return this}null==d&&null==e?(e=b,d=b=n):null==e&&("string"===typeof b?(e=d,d=n):(e=d,d=b,b=n));if(!1===e)e=N;else if(!e)return this;1===f&&(g=e,e=function(a){c().off(a);return g.apply(this,arguments)},e.guid=g.guid||(g.guid=c.guid++));return this.each(function(){c.event.add(this,a,e,d,b)})},one:function(a,b,d,c){return this.on(a,
...
c){null==c&&(c=a,a=null);return 0<arguments.length?this.on(b,null,a,c):this.trigger(b)};bc.test(b)&&(c.event.fixHooks[b]=c.event.keyHooks);cc.test(b)&&(c.event.fixHooks[b]=c.event.mouseHooks)});(function(a,b){function d(a,b,d,c){d=d||[];b=b||O;var e,f,g,h,k=b.nodeType;if(!a||"string"!==typeof a)return d;if(1!==k&&9!==k)return[];g=w(b);if(!g&&!c&&(e=Y.exec(a)))if(h=e[1])if(9===k)if((f=b.getElementById(h))&&f.parentNode){if(f.id===h)return d.push(f),d}else return d;else{if(b.ownerDocument&&(f=b.ownerDocument.getElementById(h))&&
t(b,f)&&f.id===h)return d.push(f),d}else{if(e[2])return y.apply(d,D.call(b.getElementsByTagName(a),0)),d;if((h=e[3])&&Z&&b.getElementsByClassName)return y.apply(d,D.call(b.getElementsByClassName(h),0)),d}return r(a.replace(F,"$1"),b,d,c,g)}function e(a){return function(b){return"input"===b.nodeName.toLowerCase()&&b.type===a}}function f(a){return function(b){var d=b.nodeName.toLowerCase();return("input"===d||"button"===d)&&b.type===a}}function g(a){return K(function(b){b=+b;return K(function(d,c){for(var e,
f=a([],d.length,b),g=f.length;g--;)if(d[e=f[g]])d[e]=!(c[e]=d[e])})})}function h(a,b,d){if(a===b)return d;for(a=a.nextSibling;a;){if(a===b)return-1;a=a.nextSibling}return 1}function k(a,b){var c,e,f,g,h,k,l;if(h=H[A][a+" "])return b?0:h.slice(0);h=a;k=[];for(l=u.preFilter;h;){if(!c||(e=U.exec(h)))e&&(h=h.slice(e[0].length)||h),k.push(f=[]);c=!1;if(e=V.exec(h))f.push(c=new jb(e.shift())),h=h.slice(c.length),c.type=e[0].replace(F," ");for(g in u.filter)if((e=R[g].exec(h))&&(!l[g]||(e=l[g](e))))f.push(c=
new jb(e.shift())),h=h.slice(c.length),c.type=g,c.matches=e;if(!c)break}return b?h.length:h?d.error(a):H(a,k).slice(0)}function l(a,b,d){var c=b.dir,e=d&&"parentNode"===b.dir,f=I++;return b.first?function(b,d,f){for(;b=b[c];)if(e||1===b.nodeType)return a(b,d,f)}:function(b,d,g){if(g)for(;b=b[c];){if((e||1===b.nodeType)&&a(b,d,g))return b}else for(var h,k=ga+" "+f+" ",hb=k+B;b=b[c];)if(e||1===b.nodeType){if((h=b[A])===hb)return b.sizset;if("string"===typeof h&&0===h.indexOf(k)){if(b.sizset)return b}else{b[A]=
hb;if(a(b,d,g))return b.sizset=!0,b;b.sizset=!1}}}}function m(a){return 1<a.length?function(b,d,c){for(var e=a.length;e--;)if(!a[e](b,d,c))return!1;return!0}:a[0]}function s(a,b,d,c,e){for(var f,g=[],h=0,k=a.length,l=null!=b;h<k;h++)if(f=a[h])if(!d||d(f,c,e))g.push(f),l&&b.push(h);return g}function p(a,b,c,e,f,g){e&&!e[A]&&(e=p(e));f&&!f[A]&&(f=p(f,g));return K(function(g,h,k,l){var m,p,n=[],q=[],ib=h.length,r;if(!(r=g)){r=b||"*";for(var t=k.nodeType?[k]:k,M=[],u=0,T=t.length;u<T;u++)d(r,t[u],M);
r=M}r=a&&(g||!b)?s(r,n,a,k,l):r;t=c?f||(g?a:ib||e)?[]:h:r;c&&c(r,t,k,l);if(e){m=s(t,q);e(m,[],k,l);for(k=m.length;k--;)if(p=m[k])t[q[k]]=!(r[q[k]]=p)}if(g){if(f||a){if(f){m=[];for(k=t.length;k--;)if(p=t[k])m.push(r[k]=p);f(null,t=[],m,l)}for(k=t.length;k--;)if((p=t[k])&&-1<(m=f?C.call(g,p):n[k]))g[m]=!(h[m]=p)}}else t=s(t===h?t.splice(ib,t.length):t),f?f(null,h,t,l):y.apply(h,t)})}function n(a){var b,d,c,e=a.length,f=u.relative[a[0].type];d=f||u.relative[" "];for(var g=f?1:0,h=l(function(a){return a===
b},d,!0),k=l(function(a){return-1<C.call(b,a)},d,!0),s=[function(a,d,c){return!f&&(c||d!==ja)||((b=d).nodeType?h(a,d,c):k(a,d,c))}];g<e;g++)if(d=u.relative[a[g].type])s=[l(m(s),d)];else{d=u.filter[a[g].type].apply(null,a[g].matches);if(d[A]){for(c=++g;c<e&&!u.relative[a[c].type];c++);return p(1<g&&m(s),1<g&&a.slice(0,g-1).join("").replace(F,"$1"),d,g<c&&n(a.slice(g,c)),c<e&&n(a=a.slice(c)),c<e&&a.join(""))}s.push(d)}return m(s)}function q(a,b){var c=0<b.length,e=0<a.length,f=function(g,h,k,l,m){var p,
n,q=[],r=0,t="0",M=g&&[],T=null!=m,L=ja,v=g||e&&u.find.TAG("*",m&&h.parentNode||h),A=ga+=null==L?1:Math.E;T&&(ja=h!==O&&h,B=f.el);for(;null!=(m=v[t]);t++){if(e&&m){for(p=0;n=a[p];p++)if(n(m,h,k)){l.push(m);break}T&&(ga=A,B=++f.el)}c&&((m=!n&&m)&&r--,g&&M.push(m))}r+=t;if(c&&t!==r){for(p=0;n=b[p];p++)n(M,q,h,k);if(g){if(0<r)for(;t--;)!M[t]&&!q[t]&&(q[t]=dc.call(l));q=s(q)}y.apply(l,q);T&&(!g&&0<q.length&&1<r+b.length)&&d.uniqueSort(l)}T&&(ga=A,ja=L);return M};f.el=0;return c?K(f):f}function r(a,b,
d,c,e){var f,g,h,l,m=k(a);if(!c&&1===m.length){g=m[0]=m[0].slice(0);if(2<g.length&&"ID"===(h=g[0]).type&&9===b.nodeType&&!e&&u.relative[g[1].type]){b=u.find.ID(h.matches[0].replace($,""),b,e)[0];if(!b)return d;a=a.slice(g.shift().length)}for(f=R.POS.test(a)?-1:g.length-1;0<=f;f--){h=g[f];if(u.relative[l=h.type])break;if(l=u.find[l])if(c=l(h.matches[0].replace($,""),S.test(g[0].type)&&b.parentNode||b,e)){g.splice(f,1);a=c.length&&g.join("");if(!a)return y.apply(d,D.call(c,0)),d;break}}}x(a,m)(c,b,
e,d,S.test(a));return d}function v(){}var B,z,u,J,w,t,x,G,M,ja,T=!0,A=("sizcache"+Math.random()).replace(".",""),jb=String,O=a.document,L=O.documentElement,ga=0,I=0,dc=[].pop,y=[].push,D=[].slice,C=[].indexOf||function(a){for(var b=0,d=this.length;b<d;b++)if(this[b]===a)return b;return-1},K=function(a,b){a[A]=null==b||b;return a},E=function(){var a={},b=[];return K(function(d,c){b.push(d)>u.cacheLength&&delete a[b.shift()];return a[d+" "]=c},a)},P=E(),H=E(),Q=E(),E="\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[-\\w]|[^\\x00-\\xa0])+)[\\x20\\t\\r\\n\\f]*(?:([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|("+
"(?:\\\\.|[-\\w]|[^\\x00-\\xa0])+".replace("w","w#")+")|)|)[\\x20\\t\\r\\n\\f]*\\]",N=":((?:\\\\.|[-\\w]|[^\\x00-\\xa0])+)(?:\\((?:(['\"])((?:\\\\.|[^\\\\])*?)\\2|([^()[\\]]*|(?:(?:"+E+")|[^:]|\\\\.)*|.*))\\)|)",F=/^[\x20\t\r\n\f]+|((?:^|[^\\])(?:\\.)*)[\x20\t\r\n\f]+$/g,U=/^[\x20\t\r\n\f]*,[\x20\t\r\n\f]*/,V=/^[\x20\t\r\n\f]*([\x20\t\r\n\f>+~])[\x20\t\r\n\f]*/,X=RegExp(N),Y=/^(?:#([\w\-]+)|(\w+)|\.([\w\-]+))$/,S=/[\x20\t\r\n\f]*[+~]/,aa=/h\d/i,ba=/input|select|textarea|button/i,$=/\\(?!\\)/g,R={ID:/^#((?:\\.|[-\w]|[^\x00-\xa0])+)/,
CLASS:/^\.((?:\\.|[-\w]|[^\x00-\xa0])+)/,NAME:/^\[name=['"]?((?:\\.|[-\w]|[^\x00-\xa0])+)['"]?\]/,TAG:RegExp("^("+"(?:\\\\.|[-\\w]|[^\\x00-\\xa0])+".replace("w","w*")+")"),ATTR:RegExp("^"+E),PSEUDO:RegExp("^"+N),POS:/:(even|odd|eq|gt|lt|nth|first|last)(?:\([\x20\t\r\n\f]*((?:-\d)?\d*)[\x20\t\r\n\f]*\)|)(?=[^-]|$)/i,CHILD:RegExp("^:(only|nth|first|last)-child(?:\\([\\x20\\t\\r\\n\\f]*(even|odd|(([+-]|)(\\d*)n|)[\\x20\\t\\r\\n\\f]*(?:([+-]|)[\\x20\\t\\r\\n\\f]*(\\d+)|))[\\x20\\t\\r\\n\\f]*\\)|)","i"),
needsContext:RegExp("^[\\x20\\t\\r\\n\\f]*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\([\\x20\\t\\r\\n\\f]*((?:-\\d)?\\d*)[\\x20\\t\\r\\n\\f]*\\)|)(?=[^-]|$)","i")},W=function(a){var b=O.createElement("div");try{return a(b)}catch(d){return!1}finally{}},E=W(function(a){a.appendChild(O.createComment(""));return!a.getElementsByTagName("*").length}),ca=W(function(a){a.innerHTML="<a href='#'></a>";return a.firstChild&&"undefined"!==typeof a.firstChild.getAttribute&&"#"===a.firstChild.getAttribute("href")}),
da=W(function(a){a.innerHTML="<select></select>";a=typeof a.lastChild.getAttribute("multiple");return"boolean"!==a&&"string"!==a}),Z=W(function(a){a.innerHTML="<div class='hidden e'></div><div class='hidden'></div>";if(!a.getElementsByClassName||!a.getElementsByClassName("e").length)return!1;a.lastChild.className="e";return 2===a.getElementsByClassName("e").length}),ea=W(function(a){a.id=A+0;a.innerHTML="<a name='"+A+"'></a><div name='"+A+"'></div>";L.insertBefore(a,L.firstChild);var b=O.getElementsByName&&
O.getElementsByName(A).length===2+O.getElementsByName(A+0).length;z=!O.getElementById(A);L.removeChild(a);return b});try{D.call(L.childNodes,0)[0].nodeType}catch(fa){D=function(a){for(var b,d=[];b=this[a];a++)d.push(b);return d}}d.matches=function(a,b){return d(a,null,null,b)};d.matchesSelector=function(a,b){return 0<d(b,null,null,[a]).length};J=d.getText=function(a){var b,d="",c=0;if(b=a.nodeType)if(1===b||9===b||11===b){if("string"===typeof a.textContent)return a.textContent;for(a=a.firstChild;a;a=
a.nextSibling)d+=J(a)}else{if(3===b||4===b)return a.nodeValue}else for(;b=a[c];c++)d+=J(b);return d};w=d.isXML=function(a){return(a=a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};t=d.contains=L.contains?function(a,b){var d=9===a.nodeType?a.documentElement:a,c=b&&b.parentNode;return a===c||!(!c||!(1===c.nodeType&&d.contains&&d.contains(c)))}:L.compareDocumentPosition?function(a,b){return b&&!!(a.compareDocumentPosition(b)&16)}:function(a,b){for(;b=b.parentNode;)if(b===a)return!0;
...
CLASS:Z&&function(a,b,d){if("undefined"!==typeof b.getElementsByClassName&&!d)return b.getElementsByClassName(a)}},relative:{">":{dir:"parentNode",first:!0}," ":{dir:"parentNode"},"+":{dir:"previousSibling",first:!0},"~":{dir:"previousSibling"}},preFilter:{ATTR:function(a){a[1]=a[1].replace($,"");a[3]=(a[4]||a[5]||"").replace($,"");"~="===a[2]&&(a[3]=" "+a[3]+" ");return a.slice(0,4)},CHILD:function(a){a[1]=a[1].toLowerCase();"nth"===a[1]?(a[2]||d.error(a[0]),a[3]=+(a[3]?a[4]+(a[5]||1):2*("even"===
a[2]||"odd"===a[2])),a[4]=+(a[6]+a[7]||"odd"===a[2])):a[2]&&d.error(a[0]);return a},PSEUDO:function(a){var b,d;if(R.CHILD.test(a[0]))return null;if(a[3])a[2]=a[3];else if(b=a[4]){if(X.test(b)&&(d=k(b,!0))&&(d=b.indexOf(")",b.length-d)-b.length))b=b.slice(0,d),a[0]=a[0].slice(0,d);a[2]=b}return a.slice(0,3)}},filter:{ID:z?function(a){a=a.replace($,"");return function(b){return b.getAttribute("id")===a}}:function(a){a=a.replace($,"");return function(b){return(b="undefined"!==typeof b.getAttributeNode&&
b.getAttributeNode("id"))&&b.value===a}},TAG:function(a){if("*"===a)return function(){return!0};a=a.replace($,"").toLowerCase();return function(b){return b.nodeName&&b.nodeName.toLowerCase()===a}},CLASS:function(a){var b=P[A][a+" "];return b||(b=RegExp("(^|[\\x20\\t\\r\\n\\f])"+a+"([\\x20\\t\\r\\n\\f]|$)"))&&P(a,function(a){return b.test(a.className||"undefined"!==typeof a.getAttribute&&a.getAttribute("class")||"")})},ATTR:function(a,b,c){return function(e,f){var g=d.attr(e,a);if(null==g)return"!="===
...
b){if(a===b)return M=!0,0;if(a.sourceIndex&&b.sourceIndex)return a.sourceIndex-b.sourceIndex;var d,c,e=[],f=[];d=a.parentNode;c=b.parentNode;var g=d;if(d===c)return h(a,b);if(d){if(!c)return 1}else return-1;for(;g;)e.unshift(g),g=g.parentNode;for(g=c;g;)f.unshift(g),g=g.parentNode;d=e.length;c=f.length;for(g=0;g<d&&g<c;g++)if(e[g]!==f[g])return h(e[g],f[g]);return g===d?h(a,f[g],-1):h(e[g],b,1)};[0,0].sort(G);T=!M;d.uniqueSort=function(a){var b,d=[],c=1,e=0;M=T;a.sort(G);if(M){for(;b=a[c];c++)b===
a[c-1]&&(e=d.push(c));for(;e--;)a.splice(d[e],1)}return a};d.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};x=d.compile=function(a,b){var d,c=[],e=[],f=Q[A][a+" "];if(!f){b||(b=k(a));for(d=b.length;d--;)f=n(b[d]),f[A]?c.push(f):e.push(f);f=Q(a,q(e,c))}return f};O.querySelectorAll&&function(){var a,b=r,c=/'|\\/g,e=/\=[\x20\t\r\n\f]*([^'"\]]*)[\x20\t\r\n\f]*\]/g,f=[":focus"],g=[":active"],h=L.matchesSelector||L.mozMatchesSelector||L.webkitMatchesSelector||L.oMatchesSelector||
L.msMatchesSelector;W(function(a){a.innerHTML="<select><option selected=''></option></select>";a.querySelectorAll("[selected]").length||f.push("\\[[\\x20\\t\\r\\n\\f]*(?:checked|disabled|ismap|multiple|readonly|selected|value)");a.querySelectorAll(":checked").length||f.push(":checked")});W(function(a){a.innerHTML="<p test=''></p>";a.querySelectorAll("[test^='']").length&&f.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:\"\"|'')");a.innerHTML="<input type='hidden'/>";a.querySelectorAll(":enabled").length||f.push(":enabled",
":disabled")});f=RegExp(f.join("|"));r=function(a,d,e,g,h){if(!g&&!h&&!f.test(a)){var l,m,p=!0,n=A;m=d;l=9===d.nodeType&&a;if(1===d.nodeType&&"object"!==d.nodeName.toLowerCase()){l=k(a);(p=d.getAttribute("id"))?n=p.replace(c,"\\$&"):d.setAttribute("id",n);n="[id='"+n+"'] ";for(m=l.length;m--;)l[m]=n+l[m].join("");m=S.test(a)&&d.parentNode||d;l=l.join(",")}if(l)try{return y.apply(e,D.call(m.querySelectorAll(l),0)),e}catch(s){}finally{p||d.removeAttribute("id")}}return b(a,d,e,g,h)};h&&(W(function(b){a=
h.call(b,"div");try{h.call(b,"[test!='']:sizzle"),g.push("!=",N)}catch(d){}}),g=RegExp(g.join("|")),d.matchesSelector=function(b,c){c=c.replace(e,"='$1']");if(!w(b)&&!g.test(c)&&!f.test(c))try{var k=h.call(b,c);if(k||a||b.document&&11!==b.document.nodeType)return k}catch(l){}return 0<d(c,null,null,[b]).length})}();u.pseudos.nth=u.pseudos.eq;u.filters=v.prototype=u.pseudos;u.setFilters=new v;d.attr=c.attr;c.find=d;c.expr=d.selectors;c.expr[":"]=c.expr.pseudos;c.unique=d.uniqueSort;c.text=d.getText;
...
h[f]){h.splice(f--,1);break}return h},has:function(a){var b,d=c(a,this),e=d.length;return this.filter(function(){for(b=0;b<e;b++)if(c.contains(this,d[b]))return!0})},not:function(a){return this.pushStack(Ba(this,a,!1),"not",a)},filter:function(a){return this.pushStack(Ba(this,a,!0),"filter",a)},is:function(a){return!!a&&("string"===typeof a?kb.test(a)?0<=c(a,this.context).index(this[0]):0<c.filter(a,this).length:0<this.filter(a).length)},closest:function(a,b){for(var d,e=0,f=this.length,g=[],h=kb.test(a)||
...
b=0;null!=(a=this[b]);b++)for(1===a.nodeType&&c.cleanData(a.getElementsByTagName("*"));a.firstChild;)a.removeChild(a.firstChild);return this},clone:function(a,b){a=null==a?!1:a;b=null==b?a:b;return this.map(function(){return c.clone(this,a,b)})},html:function(a){return c.access(this,function(a){var d=this[0]||{},e=0,f=this.length;if(a===n)return 1===d.nodeType?d.innerHTML.replace(hc,""):n;if("string"===typeof a&&!kc.test(a)&&(c.support.htmlSerialize||!ua.test(a))&&(c.support.leadingWhitespace||!ta.test(a))&&
!z[(mb.exec(a)||["",""])[1].toLowerCase()]){a=a.replace(lb,"<$1></$2>");try{for(;e<f;e++)d=this[e]||{},1===d.nodeType&&(c.cleanData(d.getElementsByTagName("*")),d.innerHTML=a);d=0}catch(g){}}d&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(a){if(!Y(this[0])){if(c.isFunction(a))return this.each(function(b){var d=c(this),e=d.html();d.replaceWith(a.call(this,b,e))});"string"!==typeof a&&(a=c(a).detach());return this.each(function(){var b=this.nextSibling,d=this.parentNode;c(this).remove();
b?c(b).before(a):c(d).append(a)})}return this.length?this.pushStack(c(c.isFunction(a)?a():a),"replaceWith",a):this},detach:function(a){return this.remove(a,!0)},domManip:function(a,b,d){a=[].concat.apply([],a);var e,f,g,h=0,k=a[0],l=[],m=this.length;if(!c.support.checkClone&&1<m&&"string"===typeof k&&nb.test(k))return this.each(function(){c(this).domManip(a,b,d)});if(c.isFunction(k))return this.each(function(e){var f=c(this);a[0]=k.call(this,e,b?f.html():n);f.domManip(a,b,d)});if(this[0]){e=c.buildFragment(a,
this,l);g=e.fragment;f=g.firstChild;1===g.childNodes.length&&(g=f);if(f){b=b&&c.nodeName(f,"tr");for(e=e.cacheable||m-1;h<m;h++)d.call(b&&c.nodeName(this[h],"table")?this[h].getElementsByTagName("tbody")[0]||this[h].appendChild(this[h].ownerDocument.createElement("tbody")):this[h],h===e?g:c.clone(g,!0,!0))}g=f=null;l.length&&c.each(l,function(a,b){b.src?c.ajax?c.ajax({url:b.src,type:"GET",dataType:"script",async:!1,global:!1,"throws":!0}):c.error("no ajax"):c.globalEval((b.text||b.textContent||b.innerHTML||
"").replace(nc,""));b.parentNode&&b.parentNode.removeChild(b)})}return this}});c.buildFragment=function(a,b,d){var e,f,g,h=a[0];b=b||q;b=!b.nodeType&&b[0]||b;b=b.ownerDocument||b;if(1===a.length&&"string"===typeof h&&512>h.length&&b===q&&"<"===h.charAt(0)&&!lc.test(h)&&(c.support.checkClone||!nb.test(h))&&(c.support.html5Clone||!ua.test(h)))f=!0,e=c.fragments[h],g=e!==n;e||(e=b.createDocumentFragment(),c.clean(a,b,e,d),f&&(c.fragments[h]=g&&e));return{fragment:e,cacheable:f}};c.fragments={};c.each({appendTo:"append",
prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){c.fn[a]=function(d){var e,f=0,g=[];d=c(d);var h=d.length;e=1===this.length&&this[0].parentNode;if((null==e||e&&11===e.nodeType&&1===e.childNodes.length)&&1===h)return d[b](this[0]),this;for(;f<h;f++)e=(0<f?this.clone(!0):this).get(),c(d[f])[b](e),g=g.concat(e);return this.pushStack(g,a,d.selector)}});c.extend({clone:function(a,b,d){var e,f,g,h;c.support.html5Clone||c.isXMLDoc(a)||!ua.test("<"+a.nodeName+
">")?h=a.cloneNode(!0):(va.innerHTML=a.outerHTML,va.removeChild(h=va.firstChild));if((!c.support.noCloneEvent||!c.support.noCloneChecked)&&(1===a.nodeType||11===a.nodeType)&&!c.isXMLDoc(a)){Fa(a,h);e=ba(a);f=ba(h);for(g=0;e[g];++g)f[g]&&Fa(e[g],f[g])}if(b&&(Ea(a,h),d)){e=ba(a);f=ba(h);for(g=0;e[g];++g)Ea(e[g],f[g])}return h},clean:function(a,b,d,e){var f,g,h,k,l,m,n=b===q&&ob,p=[];if(!b||"undefined"===typeof b.createDocumentFragment)b=q;for(f=0;null!=(h=a[f]);f++)if("number"===typeof h&&(h+=""),h){if("string"===
typeof h)if(jc.test(h)){n=n||Ca(b);m=b.createElement("div");n.appendChild(m);h=h.replace(lb,"<$1></$2>");g=(mb.exec(h)||["",""])[1].toLowerCase();k=z[g]||z._default;l=k[0];for(m.innerHTML=k[1]+h+k[2];l--;)m=m.lastChild;if(!c.support.tbody){l=ic.test(h);k="table"===g&&!l?m.firstChild&&m.firstChild.childNodes:"<table>"===k[1]&&!l?m.childNodes:[];for(g=k.length-1;0<=g;--g)c.nodeName(k[g],"tbody")&&!k[g].childNodes.length&&k[g].parentNode.removeChild(k[g])}!c.support.leadingWhitespace&&ta.test(h)&&m.insertBefore(b.createTextNode(ta.exec(h)[0]),
m.firstChild);h=m.childNodes;m.parentNode.removeChild(m)}else h=b.createTextNode(h);h.nodeType?p.push(h):c.merge(p,h)}m&&(h=m=n=null);if(!c.support.appendChecked)for(f=0;null!=(h=p[f]);f++)c.nodeName(h,"input")?Ha(h):"undefined"!==typeof h.getElementsByTagName&&c.grep(h.getElementsByTagName("input"),Ha);if(d){a=function(a){if(!a.type||mc.test(a.type))return e?e.push(a.parentNode?a.parentNode.removeChild(a):a):d.appendChild(a)};for(f=0;null!=(h=p[f]);f++)if(!c.nodeName(h,"script")||!a(h))d.appendChild(h),
...
(function(){var a,b;c.uaMatch=function(a){a=a.toLowerCase();a=/(chrome)[ \/]([\w.]+)/.exec(a)||/(webkit)[ \/]([\w.]+)/.exec(a)||/(opera)(?:.*version|)[ \/]([\w.]+)/.exec(a)||/(msie) ([\w.]+)/.exec(a)||0>a.indexOf("compatible")&&/(mozilla)(?:.*? rv:([\w.]+)|)/.exec(a)||[];return{browser:a[1]||"",version:a[2]||"0"}};a=c.uaMatch(Ib.userAgent);b={};a.browser&&(b[a.browser]=!0,b.version=a.version);b.chrome?b.webkit=!0:b.webkit&&(b.safari=!0);c.browser=b;c.sub=function(){function a(b,c){return new a.fn.init(b,
c)}c.extend(!0,a,this);a.superclass=this;a.fn=a.prototype=this();a.fn.constructor=a;a.sub=this.sub;a.fn.init=function(f,g){g&&(g instanceof c&&!(g instanceof a))&&(g=a(g));return c.fn.init.call(this,f,g,b)};a.fn.init.prototype=a.fn;var b=a(q);return a}})();var v,F,U,wa=/alpha\([^)]*\)/i,oc=/opacity=([^)]*)/,pc=/^(top|right|bottom|left)$/,qc=/^(none|table(?!-c[ea]).+)/,pb=/^margin/,Db=RegExp("^("+ha+")(.*)$","i"),ca=RegExp("^("+ha+")(?!px)[a-z%]+$","i"),rc=RegExp("^([-+])=("+ha+")","i"),na={BODY:"block"},
sc={position:"absolute",visibility:"hidden",display:"block"},qb={letterSpacing:0,fontWeight:400},C=["Top","Right","Bottom","Left"],Ja=["Webkit","O","Moz","ms"],tc=c.fn.toggle;c.fn.extend({css:function(a,b){return c.access(this,function(a,b,f){return f!==n?c.style(a,b,f):c.css(a,b)},a,b,1<arguments.length)},show:function(){return Ka(this,!0)},hide:function(){return Ka(this)},toggle:function(a,b){var d="boolean"===typeof a;return c.isFunction(a)&&c.isFunction(b)?tc.apply(this,arguments):this.each(function(){(d?
a:R(this))?c(this).show():c(this).hide()})}});c.extend({cssHooks:{opacity:{get:function(a,b){if(b){var d=v(a,"opacity");return""===d?"1":d}}}},cssNumber:{fillOpacity:!0,fontWeight:!0,lineHeight:!0,opacity:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":c.support.cssFloat?"cssFloat":"styleFloat"},style:function(a,b,d,e){if(a&&!(3===a.nodeType||8===a.nodeType||!a.style)){var f,g,h,k=c.camelCase(b),l=a.style;b=c.cssProps[k]||(c.cssProps[k]=Ia(l,k));h=c.cssHooks[b]||c.cssHooks[k];if(d!==
n){g=typeof d;if("string"===g&&(f=rc.exec(d)))d=(f[1]+1)*f[2]+parseFloat(c.css(a,b)),g="number";if(!(null==d||"number"===g&&isNaN(d)))if("number"===g&&!c.cssNumber[k]&&(d+="px"),!h||!("set"in h)||(d=h.set(a,d,e))!==n)try{l[b]=d}catch(m){}}else return h&&"get"in h&&(f=h.get(a,!1,e))!==n?f:l[b]}},css:function(a,b,d,e){var f,g;g=c.camelCase(b);b=c.cssProps[g]||(c.cssProps[g]=Ia(a.style,g));(g=c.cssHooks[b]||c.cssHooks[g])&&"get"in g&&(f=g.get(a,!0,e));f===n&&(f=v(a,b));"normal"===f&&b in qb&&(f=qb[b]);
return d||e!==n?(a=parseFloat(f),d||c.isNumeric(a)?a||0:f):f},swap:function(a,b,d){var c,f={};for(c in b)f[c]=a.style[c],a.style[c]=b[c];d=d.call(a);for(c in b)a.style[c]=f[c];return d}});r.getComputedStyle?v=function(a,b){var d,e,f,g,h=r.getComputedStyle(a,null),k=a.style;h&&(d=h.getPropertyValue(b)||h[b],""===d&&!c.contains(a.ownerDocument,a)&&(d=c.style(a,b)),ca.test(d)&&pb.test(b)&&(e=k.width,f=k.minWidth,g=k.maxWidth,k.minWidth=k.maxWidth=k.width=d,d=h.width,k.width=e,k.minWidth=f,k.maxWidth=
g));return d}:q.documentElement.currentStyle&&(v=function(a,b){var d,c,f=a.currentStyle&&a.currentStyle[b],g=a.style;null==f&&(g&&g[b])&&(f=g[b]);if(ca.test(f)&&!pc.test(b)){d=g.left;if(c=a.runtimeStyle&&a.runtimeStyle.left)a.runtimeStyle.left=a.currentStyle.left;g.left="fontSize"===b?"1em":f;f=g.pixelLeft+"px";g.left=d;c&&(a.runtimeStyle.left=c)}return""===f?"auto":f});c.each(["height","width"],function(a,b){c.cssHooks[b]={get:function(a,e,f){if(e)return 0===a.offsetWidth&&qc.test(v(a,"display"))?
c.swap(a,sc,function(){return Oa(a,b,f)}):Oa(a,b,f)},set:function(a,e,f){return Ma(a,e,f?Na(a,b,f,c.support.boxSizing&&"border-box"===c.css(a,"boxSizing")):0)}}});c.support.opacity||(c.cssHooks.opacity={get:function(a,b){return oc.test((b&&a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?0.01*parseFloat(RegExp.$1)+"":b?"1":""},set:function(a,b){var d=a.style,e=a.currentStyle,f=c.isNumeric(b)?"alpha(opacity="+100*b+")":"",g=e&&e.filter||d.filter||"";d.zoom=1;if(1<=b&&(""===c.trim(g.replace(wa,
""))&&d.removeAttribute)&&(d.removeAttribute("filter"),e&&!e.filter))return;d.filter=wa.test(g)?g.replace(wa,f):g+" "+f}});c(function(){c.support.reliableMarginRight||(c.cssHooks.marginRight={get:function(a,b){return c.swap(a,{display:"inline-block"},function(){if(b)return v(a,"marginRight")})}});!c.support.pixelPosition&&c.fn.position&&c.each(["top","left"],function(a,b){c.cssHooks[b]={get:function(a,e){if(e){var f=v(a,b);return ca.test(f)?c(a).position()[b]+"px":f}}}})});c.expr&&c.expr.filters&&
(c.expr.filters.hidden=function(a){return 0===a.offsetWidth&&0===a.offsetHeight||!c.support.reliableHiddenOffsets&&"none"===(a.style&&a.style.display||v(a,"display"))},c.expr.filters.visible=function(a){return!c.expr.filters.hidden(a)});c.each({margin:"",padding:"",border:"Width"},function(a,b){c.cssHooks[a+b]={expand:function(c){var e="string"===typeof c?c.split(" "):[c],f={};for(c=0;4>c;c++)f[a+C[c]+b]=e[c]||e[c-2]||e[0];return f}};pb.test(a)||(c.cssHooks[a+b].set=Ma)});var uc=/%20/g,Eb=/\[\]$/,
rb=/\r?\n/g,vc=/^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,wc=/^(?:select|textarea)/i;c.fn.extend({serialize:function(){return c.param(this.serializeArray())},serializeArray:function(){return this.map(function(){return this.elements?c.makeArray(this.elements):this}).filter(function(){return this.name&&!this.disabled&&(this.checked||wc.test(this.nodeName)||vc.test(this.type))}).map(function(a,b){var d=c(this).val();return null==
d?null:c.isArray(d)?c.map(d,function(a,c){return{name:b.name,value:a.replace(rb,"\r\n")}}):{name:b.name,value:d.replace(rb,"\r\n")}}).get()}});c.param=function(a,b){var d,e=[],f=function(a,b){b=c.isFunction(b)?b():null==b?"":b;e[e.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};b===n&&(b=c.ajaxSettings&&c.ajaxSettings.traditional);if(c.isArray(a)||a.jquery&&!c.isPlainObject(a))c.each(a,function(){f(this.name,this.value)});else for(d in a)oa(d,a[d],b,f);return e.join("&").replace(uc,"+")};
var P,Q,xc=/#.*$/,yc=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,zc=/^(?:GET|HEAD)$/,Ac=/^\/\//,sb=/\?/,Bc=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,Cc=/([?&])_=[^&]*/,tb=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/,ub=c.fn.load,pa={},vb={},wb=["*/"]+["*"];try{Q=Hb.href}catch(Jc){Q=q.createElement("a"),Q.href="",Q=Q.href}P=tb.exec(Q.toLowerCase())||[];c.fn.load=function(a,b,d){if("string"!==typeof a&&ub)return ub.apply(this,arguments);if(!this.length)return this;var e,f,g,h=this,k=a.indexOf(" ");
0<=k&&(e=a.slice(k,a.length),a=a.slice(0,k));c.isFunction(b)?(d=b,b=n):b&&"object"===typeof b&&(f="POST");c.ajax({url:a,type:f,dataType:"html",data:b,complete:function(a,b){d&&h.each(d,g||[a.responseText,b,a])}}).done(function(a){g=arguments;h.html(e?c("<div>").append(a.replace(Bc,"")).find(e):a)});return this};c.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),function(a,b){c.fn[b]=function(a){return this.on(b,a)}});c.each(["get","post"],function(a,b){c[b]=function(a,
...
t.readyState=0<a?4:0;if(d){w=p;g=t;var x,y,D,C,K=w.contents,E=w.dataTypes,F=w.responseFields;for(y in F)y in d&&(g[F[y]]=d[y]);for(;"*"===E[0];)E.shift(),x===n&&(x=w.mimeType||g.getResponseHeader("content-type"));if(x)for(y in K)if(K[y]&&K[y].test(x)){E.unshift(y);break}if(E[0]in d)D=E[0];else{for(y in d){if(!E[0]||w.converters[y+" "+E[0]]){D=y;break}C||(C=y)}D=D||C}D?(D!==E[0]&&E.unshift(D),w=d[D]):w=void 0}if(200<=a&&300>a||304===a)if(p.ifModified&&((d=t.getResponseHeader("Last-Modified"))&&(c.lastModified[e]=
d),(d=t.getResponseHeader("Etag"))&&(c.etag[e]=d)),304===a)I="notmodified",l=!0;else{a:{s=p;u=w;var H,G,I=s.dataTypes.slice();x=I[0];y={};D=0;s.dataFilter&&(u=s.dataFilter(u,s.dataType));if(I[1])for(H in s.converters)y[H.toLowerCase()]=s.converters[H];for(;d=I[++D];)if("*"!==d){if("*"!==x&&x!==d){H=y[x+" "+d]||y["* "+d];if(!H)for(G in y)if(l=G.split(" "),l[1]===d&&(H=y[x+" "+l[0]]||y["* "+l[0]])){!0===H?H=y[G]:!0!==y[G]&&(d=l[0],I.splice(D--,0,d));break}if(!0!==H)if(H&&s["throws"])u=H(u);else try{u=
H(u)}catch(N){l={state:"parsererror",error:H?N:"No conversion from "+x+" to "+d};break a}}x=d}l={state:"success",data:u}}I=l.state;s=l.data;u=l.error;l=!u}else if(u=I,!I||a)I="error",0>a&&(a=0);t.status=a;t.statusText=(b||I)+"";l?v.resolveWith(q,[s,I,t]):v.rejectWith(q,[t,I,u]);t.statusCode(z);z=n;m&&r.trigger("ajax"+(l?"Success":"Error"),[t,p,l?s:u]);B.fireWith(q,[t,I]);m&&(r.trigger("ajaxComplete",[t,p]),--c.active||c.event.trigger("ajaxStop"))}}"object"===typeof a&&(b=a,a=n);b=b||{};var e,f,g,
h,k,l,m,s,p=c.ajaxSetup({},b),q=p.context||p,r=q!==p&&(q.nodeType||q instanceof c)?c(q):c.event,v=c.Deferred(),B=c.Callbacks("once memory"),z=p.statusCode||{},w={},u={},J=0,x="canceled",t={readyState:0,setRequestHeader:function(a,b){if(!J){var c=a.toLowerCase();a=u[c]=u[c]||a;w[a]=b}return this},getAllResponseHeaders:function(){return 2===J?f:null},getResponseHeader:function(a){var b;if(2===J){if(!g)for(g={};b=yc.exec(f);)g[b[1].toLowerCase()]=b[2];b=g[a.toLowerCase()]}return b===n?null:b},overrideMimeType:function(a){J||
(p.mimeType=a);return this},abort:function(a){a=a||x;h&&h.abort(a);d(0,a);return this}};v.promise(t);t.success=t.done;t.error=t.fail;t.complete=B.add;t.statusCode=function(a){if(a){var b;if(2>J)for(b in a)z[b]=[z[b],a[b]];else b=a[t.status],t.always(b)}return this};p.url=((a||p.url)+"").replace(xc,"").replace(Ac,P[1]+"//");p.dataTypes=c.trim(p.dataType||"*").toLowerCase().split(G);null==p.crossDomain&&(l=tb.exec(p.url.toLowerCase()),p.crossDomain=!(!l||!(l[1]!==P[1]||l[2]!==P[2]||(l[3]||("http:"===
l[1]?80:443))!=(P[3]||("http:"===P[1]?80:443)))));p.data&&(p.processData&&"string"!==typeof p.data)&&(p.data=c.param(p.data,p.traditional));da(pa,p,b,t);if(2===J)return t;m=p.global;p.type=p.type.toUpperCase();p.hasContent=!zc.test(p.type);m&&0===c.active++&&c.event.trigger("ajaxStart");if(!p.hasContent&&(p.data&&(p.url+=(sb.test(p.url)?"&":"?")+p.data,delete p.data),e=p.url,!1===p.cache)){l=c.now();var C=p.url.replace(Cc,"$1_="+l);p.url=C+(C===p.url?(sb.test(p.url)?"&":"?")+"_="+l:"")}(p.data&&p.hasContent&&
!1!==p.contentType||b.contentType)&&t.setRequestHeader("Content-Type",p.contentType);p.ifModified&&(e=e||p.url,c.lastModified[e]&&t.setRequestHeader("If-Modified-Since",c.lastModified[e]),c.etag[e]&&t.setRequestHeader("If-None-Match",c.etag[e]));t.setRequestHeader("Accept",p.dataTypes[0]&&p.accepts[p.dataTypes[0]]?p.accepts[p.dataTypes[0]]+("*"!==p.dataTypes[0]?", "+wb+"; q=0.01":""):p.accepts["*"]);for(s in p.headers)t.setRequestHeader(s,p.headers[s]);if(p.beforeSend&&(!1===p.beforeSend.call(q,t,
p)||2===J))return t.abort();x="abort";for(s in{success:1,error:1,complete:1})t[s](p[s]);if(h=da(vb,p,b,t)){t.readyState=1;m&&r.trigger("ajaxSend",[t,p]);p.async&&0<p.timeout&&(k=setTimeout(function(){t.abort("timeout")},p.timeout));try{J=1,h.send(w,d)}catch(F){if(2>J)d(-1,F);else throw F;}}else d(-1,"No Transport");return t},active:0,lastModified:{},etag:{}});var xb=[],Dc=/\?/,ka=/(=)\?(?=&|$)|\?\?/,Ec=c.now();c.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var a=xb.pop()||c.expando+"_"+Ec++;
this[a]=!0;return a}});c.ajaxPrefilter("json jsonp",function(a,b,d){var e,f,g,h=a.data,k=a.url,l=!1!==a.jsonp,m=l&&ka.test(k),s=l&&!m&&"string"===typeof h&&!(a.contentType||"").indexOf("application/x-www-form-urlencoded")&&ka.test(h);if("jsonp"===a.dataTypes[0]||m||s)return e=a.jsonpCallback=c.isFunction(a.jsonpCallback)?a.jsonpCallback():a.jsonpCallback,f=r[e],m?a.url=k.replace(ka,"$1"+e):s?a.data=h.replace(ka,"$1"+e):l&&(a.url+=(Dc.test(k)?"&":"?")+a.jsonp+"="+e),a.converters["script json"]=function(){g||
c.error(e+" was not called");return g[0]},a.dataTypes[0]="json",r[e]=function(){g=arguments},d.always(function(){r[e]=f;a[e]&&(a.jsonpCallback=b.jsonpCallback,xb.push(e));g&&c.isFunction(f)&&f(g[0]);g=f=n}),"script"});c.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},contents:{script:/javascript|ecmascript/},converters:{"text script":function(a){c.globalEval(a);return a}}});c.ajaxPrefilter("script",function(a){a.cache===n&&(a.cache=
!1);a.crossDomain&&(a.type="GET",a.global=!1)});c.ajaxTransport("script",function(a){if(a.crossDomain){var b,c=q.head||q.getElementsByTagName("head")[0]||q.documentElement;return{send:function(e,f){b=q.createElement("script");b.async="async";a.scriptCharset&&(b.charset=a.scriptCharset);b.src=a.url;b.onload=b.onreadystatechange=function(a,e){if(e||!b.readyState||/loaded|complete/.test(b.readyState))b.onload=b.onreadystatechange=null,c&&b.parentNode&&c.removeChild(b),b=n,e||f(200,"success")};c.insertBefore(b,
c.firstChild)},abort:function(){if(b)b.onload(0,1)}}}});var X,xa=r.ActiveXObject?function(){for(var a in X)X[a](0,1)}:!1,Fc=0;c.ajaxSettings.xhr=r.ActiveXObject?function(){var a;if(!(a=!this.isLocal&&Ra()))a:{try{a=new r.ActiveXObject("Microsoft.XMLHTTP");break a}catch(b){}a=void 0}return a}:Ra;(function(a){c.extend(c.support,{ajax:!!a,cors:!!a&&"withCredentials"in a})})(c.ajaxSettings.xhr());c.support.ajax&&c.ajaxTransport(function(a){if(!a.crossDomain||c.support.cors){var b;return{send:function(d,
e){var f,g,h=a.xhr();a.username?h.open(a.type,a.url,a.async,a.username,a.password):h.open(a.type,a.url,a.async);if(a.xhrFields)for(g in a.xhrFields)h[g]=a.xhrFields[g];a.mimeType&&h.overrideMimeType&&h.overrideMimeType(a.mimeType);!a.crossDomain&&!d["X-Requested-With"]&&(d["X-Requested-With"]="XMLHttpRequest");try{for(g in d)h.setRequestHeader(g,d[g])}catch(k){}h.send(a.hasContent&&a.data||null);b=function(d,g){var k,p,q,r,v;try{if(b&&(g||4===h.readyState))if(b=n,f&&(h.onreadystatechange=c.noop,xa&&
delete X[f]),g)4!==h.readyState&&h.abort();else{k=h.status;q=h.getAllResponseHeaders();r={};if((v=h.responseXML)&&v.documentElement)r.xml=v;try{r.text=h.responseText}catch(w){}try{p=h.statusText}catch(x){p=""}!k&&a.isLocal&&!a.crossDomain?k=r.text?200:404:1223===k&&(k=204)}}catch(z){g||e(-1,z)}r&&e(k,p,r,q)};a.async?4===h.readyState?setTimeout(b,0):(f=++Fc,xa&&(X||(X={},c(r).unload(xa)),X[f]=b),h.onreadystatechange=b):b()},abort:function(){b&&b(0,1)}}}});var V,la,Gc=/^(?:toggle|show|hide)$/,Hc=RegExp("^(?:([-+])=|)("+
ha+")([a-z%]*)$","i"),Ic=/queueHooks$/,Z=[function(a,b,d){var e,f,g,h,k,l,m=this,n=a.style,p={},q=[],r=a.nodeType&&R(a);d.queue||(k=c._queueHooks(a,"fx"),null==k.unqueued&&(k.unqueued=0,l=k.empty.fire,k.empty.fire=function(){k.unqueued||l()}),k.unqueued++,m.always(function(){m.always(function(){k.unqueued--;c.queue(a,"fx").length||k.empty.fire()})}));if(1===a.nodeType&&("height"in b||"width"in b))d.overflow=[n.overflow,n.overflowX,n.overflowY],"inline"===c.css(a,"display")&&"none"===c.css(a,"float")&&
(!c.support.inlineBlockNeedsLayout||"inline"===La(a.nodeName)?n.display="inline-block":n.zoom=1);d.overflow&&(n.overflow="hidden",c.support.shrinkWrapBlocks||m.done(function(){n.overflow=d.overflow[0];n.overflowX=d.overflow[1];n.overflowY=d.overflow[2]}));for(e in b)g=b[e],Gc.exec(g)&&(delete b[e],f=f||"toggle"===g,g!==(r?"hide":"show")&&q.push(e));if(b=q.length){g=c._data(a,"fxshow")||c._data(a,"fxshow",{});"hidden"in g&&(r=g.hidden);f&&(g.hidden=!r);r?c(a).show():m.done(function(){c(a).hide()});
m.done(function(){var b;c.removeData(a,"fxshow",!0);for(b in p)c.style(a,b,p[b])});for(e=0;e<b;e++)f=q[e],h=m.createTween(f,r?g[f]:0),p[f]=g[f]||c.style(a,f),f in g||(g[f]=h.start,r&&(h.end=h.start,h.start="width"===f||"height"===f?1:0))}}],S={"*":[function(a,b){var d,e,f=this.createTween(a,b),g=Hc.exec(b),h=f.cur(),k=+h||0,l=1,m=20;if(g){d=+g[2];e=g[3]||(c.cssNumber[a]?"":"px");if("px"!==e&&k){k=c.css(f.elem,a,!0)||d||1;do l=l||".5",k/=l,c.style(f.elem,a,k+e);while(l!==(l=f.cur()/h)&&1!==l&&--m)}f.unit=
...
c.fx.step={};c.expr&&c.expr.filters&&(c.expr.filters.animated=function(a){return c.grep(c.timers,function(b){return a===b.elem}).length});var yb=/^(?:body|html)$/i;c.fn.offset=function(a){if(arguments.length)return a===n?this:this.each(function(b){c.offset.setOffset(this,a,b)});var b,d,e,f,g,h={top:0,left:0};if(e=(f=this[0])&&f.ownerDocument){if((d=e.body)===f)return c.offset.bodyOffset(f);b=e.documentElement;if(!c.contains(b,f))return h;"undefined"!==typeof f.getBoundingClientRect&&(h=f.getBoundingClientRect());
