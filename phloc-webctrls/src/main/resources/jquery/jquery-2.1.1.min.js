...
{},0,{get:function(){return{}}});this.expando=d.expando+Math.random()}function Ua(a,b,c){if(void 0===c&&1===a.nodeType)if(c="data-"+b.replace(Kb,"-$1").toLowerCase(),c=a.getAttribute(c),"string"===typeof c){try{c="true"===c?!0:"false"===c?!1:"null"===c?null:+c+""===c?+c:Lb.test(c)?d.parseJSON(c):c}catch(e){}G.set(a,b,c)}else c=void 0;return c}function na(){return!0}function X(){return!1}function Va(){try{return s.activeElement}catch(a){}}function Wa(a,b){return d.nodeName(a,"table")&&d.nodeName(11!==
b.nodeType?b:b.firstChild,"tr")?a.getElementsByTagName("tbody")[0]||a.appendChild(a.ownerDocument.createElement("tbody")):a}function Mb(a){a.type=(null!==a.getAttribute("type"))+"/"+a.type;return a}function Nb(a){var b=Ob.exec(a.type);b?a.type=b[1]:a.removeAttribute("type");return a}function Ea(a,b){for(var c=0,d=a.length;c<d;c++)n.set(a[c],"globalEval",!b||n.get(b[c],"globalEval"))}function Xa(a,b){var c,e,f,g;if(1===b.nodeType){if(n.hasData(a)&&(g=n.access(a),c=n.set(b,g),g=g.events))for(f in delete c.handle,
...
b.type===a}}function l(a){return function(b){var c=b.nodeName.toLowerCase();return("input"===c||"button"===c)&&b.type===a}}function p(a){return d(function(b){b=+b;return d(function(c,d){for(var e,f=a([],c.length,b),g=f.length;g--;)c[e=f[g]]&&(c[e]=!(d[e]=c[e]))})})}function q(a){return a&&typeof a.getElementsByTagName!==K&&a}function m(){}function t(a){for(var b=0,c=a.length,d="";b<c;b++)d+=a[b].value;return d}function y(a,b,c){var d=b.dir,e=c&&"parentNode"===d,f=L++;return b.first?function(b,c,f){for(;b=
...
l&&b.push(h);return g}function s(a,c,f,g,h,k){g&&!g[E]&&(g=s(g));h&&!h[E]&&(h=s(h,k));return d(function(d,e,k,l){var m,p,q=[],r=[],ob=e.length,t;if(!(t=d)){t=c||"*";for(var n=k.nodeType?[k]:k,y=[],s=0,ia=n.length;s<ia;s++)b(t,n[s],y);t=y}t=!a||!d&&c?t:u(t,q,a,k,l);n=f?h||(d?a:ob||g)?[]:e:t;f&&f(t,n,k,l);if(g)for(m=u(n,r),g(m,[],k,l),k=m.length;k--;)if(p=m[k])n[r[k]]=!(t[r[k]]=p);if(d){if(h||a){if(h){m=[];for(k=n.length;k--;)(p=n[k])&&m.push(t[k]=p);h(null,n=[],m,l)}for(k=n.length;k--;)(p=n[k])&&-1<
(m=h?ha.call(d,p):q[k])&&(d[m]=!(e[m]=p))}}else n=u(n===e?n.splice(ob,n.length):n),h?h(null,e,n,l):ca.apply(e,n)})}function w(a){var b,c,d,e=a.length,f=r.relative[a[0].type];c=f||r.relative[" "];for(var g=f?1:0,h=y(function(a){return a===b},c,!0),k=y(function(a){return-1<ha.call(b,a)},c,!0),l=[function(a,c,d){return!f&&(d||c!==z)||((b=c).nodeType?h(a,c,d):k(a,c,d))}];g<e;g++)if(c=r.relative[a[g].type])l=[y(n(l),c)];else{c=r.filter[a[g].type].apply(null,a[g].matches);if(c[E]){for(d=++g;d<e&&!r.relative[a[d].type];d++);
return s(1<g&&n(l),1<g&&t(a.slice(0,g-1).concat({value:" "===a[g-2].type?"*":""})).replace(Q,"$1"),c,g<d&&w(a.slice(g,d)),d<e&&w(a=a.slice(d)),d<e&&t(a))}l.push(c)}return n(l)}function G(a,c){var f=0<c.length,g=0<a.length,h=function(d,e,h,k,l){var m,p,q,t=0,n="0",xa=d&&[],y=[],s=z,ia=d||g&&r.find.TAG("*",l),w=I+=null==s?1:Math.random()||0.1,v=ia.length;for(l&&(z=e!==B&&e);n!==v&&null!=(m=ia[n]);n++){if(g&&m){for(p=0;q=a[p++];)if(q(m,e,h)){k.push(m);break}l&&(I=w)}f&&((m=!q&&m)&&t--,d&&xa.push(m))}t+=
n;if(f&&n!==t){for(p=0;q=c[p++];)q(xa,y,e,h);if(d){if(0<t)for(;n--;)xa[n]||y[n]||(y[n]=Z.call(k));y=u(y)}ca.apply(k,y);l&&!d&&0<y.length&&1<t+c.length&&b.uniqueSort(k)}l&&(I=w,z=s);return xa};return f?d(h):h}var J,v,r,x,ia,ua,Na,A,z,da,ra,ba,B,H,R,D,F,ya,ta,E="sizzle"+-new Date,C=a.document,I=0,L=0,N=c(),O=c(),P=c(),M=function(a,b){a===b&&(ra=!0);return 0},K="undefined",S=-2147483648,X={}.hasOwnProperty,ea=[],Z=ea.pop,$=ea.push,ca=ea.push,V=ea.slice,ha=ea.indexOf||function(a){for(var b=0,c=this.length;b<
c;b++)if(this[b]===a)return b;return-1},W="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w#"),Y="\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:[\\x20\\t\\r\\n\\f]*([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|("+W+"))|)[\\x20\\t\\r\\n\\f]*\\]",U=":((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|"+Y+")*)|.*)\\)|)",Q=/^[\x20\t\r\n\f]+|((?:^|[^\\])(?:\\.)*)[\x20\t\r\n\f]+$/g,ja=
/^[\x20\t\r\n\f]*,[\x20\t\r\n\f]*/,ka=/^[\x20\t\r\n\f]*([>+~]|[\x20\t\r\n\f])[\x20\t\r\n\f]*/,la=/=[\x20\t\r\n\f]*([^\]'"]*?)[\x20\t\r\n\f]*\]/g,ma=RegExp(U),na=RegExp("^"+W+"$"),T={ID:/^#((?:\\.|[\w-]|[^\x00-\xa0])+)/,CLASS:/^\.((?:\\.|[\w-]|[^\x00-\xa0])+)/,TAG:RegExp("^("+"(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w*")+")"),ATTR:RegExp("^"+Y),PSEUDO:RegExp("^"+U),CHILD:RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\([\\x20\\t\\r\\n\\f]*(even|odd|(([+-]|)(\\d*)n|)[\\x20\\t\\r\\n\\f]*(?:([+-]|)[\\x20\\t\\r\\n\\f]*(\\d+)|))[\\x20\\t\\r\\n\\f]*\\)|)",
"i"),bool:RegExp("^(?:checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)$","i"),needsContext:RegExp("^[\\x20\\t\\r\\n\\f]*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\([\\x20\\t\\r\\n\\f]*((?:-\\d)?\\d*)[\\x20\\t\\r\\n\\f]*\\)|)(?=[^-]|$)","i")},oa=/^(?:input|select|textarea|button)$/i,pa=/^h\d$/i,va=/^[^{]+\{\s*\[native \w/,qa=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,aa=/[+~]/,sa=/'|\\/g,fa=/\\([\da-f]{1,6}[\x20\t\r\n\f]?|([\x20\t\r\n\f])|.)/ig,
ga=function(a,b,c){a="0x"+b-65536;return a!==a||c?b:0>a?String.fromCharCode(a+65536):String.fromCharCode(a>>10|55296,a&1023|56320)};try{ca.apply(ea=V.call(C.childNodes),C.childNodes),ea[C.childNodes.length].nodeType}catch(wa){ca={apply:ea.length?function(a,b){$.apply(a,V.call(b))}:function(a,b){for(var c=a.length,d=0;a[c++]=b[d++];);a.length=c-1}}}v=b.support={};ia=b.isXML=function(a){return(a=a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};ba=b.setDocument=function(a){var b=a?a.ownerDocument||
a:C;a=b.defaultView;if(b===B||9!==b.nodeType||!b.documentElement)return B;B=b;H=b.documentElement;R=!ia(b);a&&a!==a.top&&(a.addEventListener?a.addEventListener("unload",function(){ba()},!1):a.attachEvent&&a.attachEvent("onunload",function(){ba()}));v.attributes=f(function(a){a.className="i";return!a.getAttribute("className")});v.getElementsByTagName=f(function(a){a.appendChild(b.createComment(""));return!a.getElementsByTagName("*").length});v.getElementsByClassName=va.test(b.getElementsByClassName)&&
f(function(a){a.innerHTML="<div class='a'></div><div class='a i'></div>";a.firstChild.className="i";return 2===a.getElementsByClassName("i").length});v.getById=f(function(a){H.appendChild(a).id=E;return!b.getElementsByName||!b.getElementsByName(E).length});v.getById?(r.find.ID=function(a,b){if(typeof b.getElementById!==K&&R){var c=b.getElementById(a);return c&&c.parentNode?[c]:[]}},r.filter.ID=function(a){var b=a.replace(fa,ga);return function(a){return a.getAttribute("id")===b}}):(delete r.find.ID,
r.filter.ID=function(a){var b=a.replace(fa,ga);return function(a){return(a=typeof a.getAttributeNode!==K&&a.getAttributeNode("id"))&&a.value===b}});r.find.TAG=v.getElementsByTagName?function(a,b){if(typeof b.getElementsByTagName!==K)return b.getElementsByTagName(a)}:function(a,b){var c,d=[],e=0,f=b.getElementsByTagName(a);if("*"===a){for(;c=f[e++];)1===c.nodeType&&d.push(c);return d}return f};r.find.CLASS=v.getElementsByClassName&&function(a,b){if(typeof b.getElementsByClassName!==K&&R)return b.getElementsByClassName(a)};
F=[];D=[];if(v.qsa=va.test(b.querySelectorAll))f(function(a){a.innerHTML="<select msallowclip=''><option selected=''></option></select>";a.querySelectorAll("[msallowclip^='']").length&&D.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|\"\")");a.querySelectorAll("[selected]").length||D.push("\\[[\\x20\\t\\r\\n\\f]*(?:value|checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)");a.querySelectorAll(":checked").length||D.push(":checked")}),f(function(a){var c=
b.createElement("input");c.setAttribute("type","hidden");a.appendChild(c).setAttribute("name","D");a.querySelectorAll("[name=d]").length&&D.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?=");a.querySelectorAll(":enabled").length||D.push(":enabled",":disabled");a.querySelectorAll("*,:x");D.push(",.*:")});(v.matchesSelector=va.test(ya=H.matches||H.webkitMatchesSelector||H.mozMatchesSelector||H.oMatchesSelector||H.msMatchesSelector))&&f(function(a){v.disconnectedMatch=ya.call(a,"div");ya.call(a,"[s!='']:x");
F.push("!=",U)});D=D.length&&RegExp(D.join("|"));F=F.length&&RegExp(F.join("|"));ta=(a=va.test(H.compareDocumentPosition))||va.test(H.contains)?function(a,b){var c=9===a.nodeType?a.documentElement:a,d=b&&b.parentNode;return a===d||!!(d&&1===d.nodeType&&(c.contains?c.contains(d):a.compareDocumentPosition&&a.compareDocumentPosition(d)&16))}:function(a,b){if(b)for(;b=b.parentNode;)if(b===a)return!0;return!1};M=a?function(a,c){if(a===c)return ra=!0,0;var d=!a.compareDocumentPosition-!c.compareDocumentPosition;
if(d)return d;d=(a.ownerDocument||a)===(c.ownerDocument||c)?a.compareDocumentPosition(c):1;return d&1||!v.sortDetached&&c.compareDocumentPosition(a)===d?a===b||a.ownerDocument===C&&ta(C,a)?-1:c===b||c.ownerDocument===C&&ta(C,c)?1:da?ha.call(da,a)-ha.call(da,c):0:d&4?-1:1}:function(a,c){if(a===c)return ra=!0,0;var d,e=0;d=a.parentNode;var f=c.parentNode,g=[a],k=[c];if(!d||!f)return a===b?-1:c===b?1:d?-1:f?1:da?ha.call(da,a)-ha.call(da,c):0;if(d===f)return h(a,c);for(d=a;d=d.parentNode;)g.unshift(d);
for(d=c;d=d.parentNode;)k.unshift(d);for(;g[e]===k[e];)e++;return e?h(g[e],k[e]):g[e]===C?-1:k[e]===C?1:0};return b};b.matches=function(a,c){return b(a,null,null,c)};b.matchesSelector=function(a,c){(a.ownerDocument||a)!==B&&ba(a);c=c.replace(la,"='$1']");if(v.matchesSelector&&R&&!(F&&F.test(c)||D&&D.test(c)))try{var d=ya.call(a,c);if(d||v.disconnectedMatch||a.document&&11!==a.document.nodeType)return d}catch(e){}return 0<b(c,B,null,[a]).length};b.contains=function(a,b){(a.ownerDocument||a)!==B&&ba(a);
return ta(a,b)};b.attr=function(a,b){(a.ownerDocument||a)!==B&&ba(a);var c=r.attrHandle[b.toLowerCase()],c=c&&X.call(r.attrHandle,b.toLowerCase())?c(a,b,!R):void 0;return void 0!==c?c:v.attributes||!R?a.getAttribute(b):(c=a.getAttributeNode(b))&&c.specified?c.value:null};b.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};b.uniqueSort=function(a){var b,c=[],d=0,e=0;ra=!v.detectDuplicates;da=!v.sortStable&&a.slice(0);a.sort(M);if(ra){for(;b=a[e++];)b===a[e]&&(d=c.push(e));
...
preFilter:{ATTR:function(a){a[1]=a[1].replace(fa,ga);a[3]=(a[3]||a[4]||a[5]||"").replace(fa,ga);"~="===a[2]&&(a[3]=" "+a[3]+" ");return a.slice(0,4)},CHILD:function(a){a[1]=a[1].toLowerCase();"nth"===a[1].slice(0,3)?(a[3]||b.error(a[0]),a[4]=+(a[4]?a[5]+(a[6]||1):2*("even"===a[3]||"odd"===a[3])),a[5]=+(a[7]+a[8]||"odd"===a[3])):a[3]&&b.error(a[0]);return a},PSEUDO:function(a){var b,c=!a[6]&&a[2];if(T.CHILD.test(a[0]))return null;a[3]?a[2]=a[4]||a[5]||"":c&&ma.test(c)&&(b=ua(c,!0))&&(b=c.indexOf(")",
c.length-b)-c.length)&&(a[0]=a[0].slice(0,b),a[2]=c.slice(0,b));return a.slice(0,3)}},filter:{TAG:function(a){var b=a.replace(fa,ga).toLowerCase();return"*"===a?function(){return!0}:function(a){return a.nodeName&&a.nodeName.toLowerCase()===b}},CLASS:function(a){var b=N[a+" "];return b||(b=RegExp("(^|[\\x20\\t\\r\\n\\f])"+a+"([\\x20\\t\\r\\n\\f]|$)"))&&N(a,function(a){return b.test("string"===typeof a.className&&a.className||typeof a.getAttribute!==K&&a.getAttribute("class")||"")})},ATTR:function(a,
c,d){return function(e){e=b.attr(e,a);if(null==e)return"!="===c;if(!c)return!0;e+="";return"="===c?e===d:"!="===c?e!==d:"^="===c?d&&0===e.indexOf(d):"*="===c?d&&-1<e.indexOf(d):"$="===c?d&&e.slice(-d.length)===d:"~="===c?-1<(" "+e+" ").indexOf(d):"|="===c?e===d||e.slice(0,d.length+1)===d+"-":!1}},CHILD:function(a,b,c,d,e){var f="nth"!==a.slice(0,3),g="last"!==a.slice(-4),h="of-type"===b;return 1===d&&0===e?function(a){return!!a.parentNode}:function(b,c,k){var l,m,p,q,t;c=f!==g?"nextSibling":"previousSibling";
var n=b.parentNode,nb=h&&b.nodeName.toLowerCase();k=!k&&!h;if(n){if(f){for(;c;){for(m=b;m=m[c];)if(h?m.nodeName.toLowerCase()===nb:1===m.nodeType)return!1;t=c="only"===a&&!t&&"nextSibling"}return!0}t=[g?n.firstChild:n.lastChild];if(g&&k)for(k=n[E]||(n[E]={}),l=k[a]||[],q=l[0]===I&&l[1],p=l[0]===I&&l[2],m=q&&n.childNodes[q];m=++q&&m&&m[c]||(p=q=0)||t.pop();){if(1===m.nodeType&&++p&&m===b){k[a]=[I,q,p];break}}else if(k&&(l=(b[E]||(b[E]={}))[a])&&l[0]===I)p=l[1];else for(;(m=++q&&m&&m[c]||(p=q=0)||t.pop())&&
((h?m.nodeName.toLowerCase()!==nb:1!==m.nodeType)||!++p||(k&&((m[E]||(m[E]={}))[a]=[I,p]),m!==b)););p-=e;return p===d||0===p%d&&0<=p/d}}},PSEUDO:function(a,c){var f,g=r.pseudos[a]||r.setFilters[a.toLowerCase()]||b.error("unsupported pseudo: "+a);return g[E]?g(c):1<g.length?(f=[a,a,"",c],r.setFilters.hasOwnProperty(a.toLowerCase())?d(function(a,b){for(var d,e=g(a,c),f=e.length;f--;)d=ha.call(a,e[f]),a[d]=!(b[d]=e[f])}):function(a){return g(a,0,f)}):g}},pseudos:{not:d(function(a){var b=[],c=[],f=Na(a.replace(Q,
"$1"));return f[E]?d(function(a,b,c,d){d=f(a,null,d,[]);for(var e=a.length;e--;)if(c=d[e])a[e]=!(b[e]=c)}):function(a,d,e){b[0]=a;f(b,null,e,c);return!c.pop()}}),has:d(function(a){return function(c){return 0<b(a,c).length}}),contains:d(function(a){return function(b){return-1<(b.textContent||b.innerText||x(b)).indexOf(a)}}),lang:d(function(a){na.test(a||"")||b.error("unsupported lang: "+a);a=a.replace(fa,ga).toLowerCase();return function(b){var c;do if(c=R?b.lang:b.getAttribute("xml:lang")||b.getAttribute("lang"))return c=
...
!!a.selected},selected:function(a){a.parentNode&&a.parentNode.selectedIndex;return!0===a.selected},empty:function(a){for(a=a.firstChild;a;a=a.nextSibling)if(6>a.nodeType)return!1;return!0},parent:function(a){return!r.pseudos.empty(a)},header:function(a){return pa.test(a.nodeName)},input:function(a){return oa.test(a.nodeName)},button:function(a){var b=a.nodeName.toLowerCase();return"input"===b&&"button"===a.type||"button"===b},text:function(a){var b;return"input"===a.nodeName.toLowerCase()&&"text"===
a.type&&(null==(b=a.getAttribute("type"))||"text"===b.toLowerCase())},first:p(function(){return[0]}),last:p(function(a,b){return[b-1]}),eq:p(function(a,b,c){return[0>c?c+b:c]}),even:p(function(a,b){for(var c=0;c<b;c+=2)a.push(c);return a}),odd:p(function(a,b){for(var c=1;c<b;c+=2)a.push(c);return a}),lt:p(function(a,b,c){for(b=0>c?c+b:c;0<=--b;)a.push(b);return a}),gt:p(function(a,b,c){for(c=0>c?c+b:c;++c<b;)a.push(c);return a})}};r.pseudos.nth=r.pseudos.eq;for(J in{radio:!0,checkbox:!0,file:!0,password:!0,
image:!0})r.pseudos[J]=k(J);for(J in{submit:!0,reset:!0})r.pseudos[J]=l(J);m.prototype=r.filters=r.pseudos;r.setFilters=new m;ua=b.tokenize=function(a,c){var d,e,f,g,h,k,l;if(h=O[a+" "])return c?0:h.slice(0);h=a;k=[];for(l=r.preFilter;h;){if(!d||(e=ja.exec(h)))e&&(h=h.slice(e[0].length)||h),k.push(f=[]);d=!1;if(e=ka.exec(h))d=e.shift(),f.push({value:d,type:e[0].replace(Q," ")}),h=h.slice(d.length);for(g in r.filter)!(e=T[g].exec(h))||l[g]&&!(e=l[g](e))||(d=e.shift(),f.push({value:d,type:g,matches:e}),
h=h.slice(d.length));if(!d)break}return c?h.length:h?b.error(a):O(a,k).slice(0)};Na=b.compile=function(a,b){var c,d=[],e=[],f=P[a+" "];if(!f){b||(b=ua(a));for(c=b.length;c--;)f=w(b[c]),f[E]?d.push(f):e.push(f);f=P(a,G(e,d));f.selector=a}return f};A=b.select=function(a,b,c,d){var e,f,g,h,k="function"===typeof a&&a,l=!d&&ua(a=k.selector||a);c=c||[];if(1===l.length){f=l[0]=l[0].slice(0);if(2<f.length&&"ID"===(g=f[0]).type&&v.getById&&9===b.nodeType&&R&&r.relative[f[1].type]){b=(r.find.ID(g.matches[0].replace(fa,
ga),b)||[])[0];if(!b)return c;k&&(b=b.parentNode);a=a.slice(f.shift().value.length)}for(e=T.needsContext.test(a)?0:f.length;e--;){g=f[e];if(r.relative[h=g.type])break;if(h=r.find[h])if(d=h(g.matches[0].replace(fa,ga),aa.test(f[0].type)&&q(b.parentNode)||b)){f.splice(e,1);a=d.length&&t(f);if(!a)return ca.apply(c,d),c;break}}}(k||Na(a,l))(d,b,!R,c,aa.test(a)&&q(b.parentNode)||b);return c};v.sortStable=E.split("").sort(M).join("")===E;v.detectDuplicates=!!ra;ba();v.sortDetached=f(function(a){return a.compareDocumentPosition(B.createElement("div"))&
1});f(function(a){a.innerHTML="<a href='#'></a>";return"#"===a.firstChild.getAttribute("href")})||g("type|href|height|width",function(a,b,c){if(!c)return a.getAttribute(b,"type"===b.toLowerCase()?1:2)});v.attributes&&f(function(a){a.innerHTML="<input/>";a.firstChild.setAttribute("value","");return""===a.firstChild.getAttribute("value")})||g("value",function(a,b,c){if(!c&&"input"===a.nodeName.toLowerCase())return a.defaultValue});f(function(a){return null==a.getAttribute("disabled")})||g("checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped",
function(a,b,c){var d;if(!c)return!0===a[b]?b.toLowerCase():(d=a.getAttributeNode(b))&&d.specified?d.value:null});return b}(u);d.find=V;d.expr=V.selectors;d.expr[":"]=d.expr.pseudos;d.unique=V.uniqueSort;d.text=V.getText;d.isXMLDoc=V.isXML;d.contains=V.contains;var pb=d.expr.match.needsContext,qb=/^<(\w+)\s*\/?>(?:<\/\1>|)$/,Ib=/^.[^:#\[\.,]*$/;d.filter=function(a,b,c){var e=b[0];c&&(a=":not("+a+")");return 1===b.length&&1===e.nodeType?d.find.matchesSelector(e,a)?[e]:[]:d.find.matches(a,d.grep(b,
...
typeof a&&pb.test(a)?d(a):a||[],!1).length}});var sa,Xb=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;(d.fn.init=function(a,b){var c;if(!a)return this;if("string"===typeof a){c="<"===a[0]&&">"===a[a.length-1]&&3<=a.length?[null,a,null]:Xb.exec(a);if(!c||!c[1]&&b)return!b||b.jquery?(b||sa).find(a):this.constructor(b).find(a);if(c[1]){if(b=b instanceof d?b[0]:b,d.merge(this,d.parseHTML(c[1],b&&b.nodeType?b.ownerDocument||b:s,!0)),qb.test(c[1])&&d.isPlainObject(b))for(c in b)if(d.isFunction(this[c]))this[c](b[c]);
else this.attr(c,b[c])}else(c=s.getElementById(c[2]))&&c.parentNode&&(this.length=1,this[0]=c),this.context=s,this.selector=a;return this}if(a.nodeType)return this.context=this[0]=a,this.length=1,this;if(d.isFunction(a))return"undefined"!==typeof sa.ready?sa.ready(a):a(d);void 0!==a.selector&&(this.selector=a.selector,this.context=a.context);return d.makeArray(a,this)}).prototype=d.fn;sa=d(s);var Yb=/^(?:parents|prev(?:Until|All))/,Zb={children:!0,contents:!0,next:!0,prev:!0};d.extend({dir:function(a,
...
{}).firstChild,a)},children:function(a){return d.sibling(a.firstChild)},contents:function(a){return a.contentDocument||d.merge([],a.childNodes)}},function(a,b){d.fn[a]=function(c,e){var f=d.map(this,b,c);"Until"!==a.slice(-5)&&(e=c);e&&"string"===typeof e&&(f=d.filter(e,f));1<this.length&&(Zb[a]||d.unique(f),Yb.test(a)&&f.reverse());return this.pushStack(f)}});var L=/\S+/g,Ta={};d.Callbacks=function(a){a="string"===typeof a?Ta[a]||Jb(a):d.extend({},a);var b,c,e,f,g,h,k=[],l=!a.once&&[],p=function(d){b=
...
e:0,g=1===f?a:d.Deferred(),h=function(a,b,c){return function(d){b[a]=this;c[a]=1<arguments.length?N.call(arguments):d;c===k?g.notifyWith(b,c):--f||g.resolveWith(b,c)}},k,l,p;if(1<e)for(k=Array(e),l=Array(e),p=Array(e);b<e;b++)c[b]&&d.isFunction(c[b].promise)?c[b].promise().done(h(b,p,c)).fail(g.reject).progress(h(b,l,k)):--f;f||g.resolveWith(p,c);return g.promise()}});var wa;d.fn.ready=function(a){d.ready.promise().done(a);return this};d.extend({isReady:!1,readyWait:1,holdReady:function(a){a?d.readyWait++:
d.ready(!0)},ready:function(a){(!0===a?--d.readyWait:d.isReady)||(d.isReady=!0,!0!==a&&0<--d.readyWait||(wa.resolveWith(s,[d]),d.fn.triggerHandler&&(d(s).triggerHandler("ready"),d(s).off("ready"))))}});d.ready.promise=function(a){wa||(wa=d.Deferred(),"complete"===s.readyState?setTimeout(d.ready):(s.addEventListener("DOMContentLoaded",ma,!1),u.addEventListener("load",ma,!1)));return wa.promise(a)};d.ready.promise();var O=d.access=function(a,b,c,e,f,g,h){var k=0,l=a.length,p=null==c;if("object"===d.type(c))for(k in f=
...
c?c:b},remove:function(a,b){var c,e;c=this.key(a);var f=this.cache[c];if(void 0===b)this.cache[c]={};else for(d.isArray(b)?e=b.concat(b.map(d.camelCase)):(c=d.camelCase(b),b in f?e=[b,c]:(e=c,e=e in f?[e]:e.match(L)||[])),c=e.length;c--;)delete f[e[c]]},hasData:function(a){return!d.isEmptyObject(this.cache[a[this.expando]]||{})},discard:function(a){a[this.expando]&&delete this.cache[a[this.expando]]}};var n=new M,G=new M,Lb=/^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,Kb=/([A-Z])/g;d.extend({hasData:function(a){return G.hasData(a)||
...
typeof a?this.each(function(){G.set(this,a)}):O(this,function(b){var c,e=d.camelCase(a);if(g&&void 0===b){c=G.get(g,a);if(void 0!==c)return c;c=G.get(g,e);if(void 0!==c)return c;c=Ua(g,e,void 0);if(void 0!==c)return c}else this.each(function(){var c=G.get(this,e);G.set(this,e,b);-1!==a.indexOf("-")&&void 0!==c&&G.set(this,a,b)})},null,b,1<arguments.length,null,!0)},removeData:function(a){return this.each(function(){G.remove(this,a)})}});d.extend({queue:function(a,b,c){var e;if(a)return b=(b||"fx")+
...
typeof a&&(b=a,a=void 0);for(a=a||"fx";h--;)(c=n.get(g[h],a+"queueHooks"))&&c.empty&&(e++,c.empty.add(k));k();return f.promise(b)}});var za=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,K=["Top","Right","Bottom","Left"],U=function(a,b){a=b||a;return"none"===d.css(a,"display")||!d.contains(a.ownerDocument,a)},rb=/^(?:checkbox|radio)$/i;(function(){var a=s.createDocumentFragment().appendChild(s.createElement("div")),b=s.createElement("input");b.setAttribute("type","radio");b.setAttribute("checked","checked");
b.setAttribute("name","t");a.appendChild(b);w.checkClone=a.cloneNode(!0).cloneNode(!0).lastChild.checked;a.innerHTML="<textarea>x</textarea>";w.noCloneChecked=!!a.cloneNode(!0).lastChild.defaultValue})();w.focusinBubbles="onfocusin"in u;var $b=/^key/,ac=/^(?:mouse|pointer|contextmenu)|click/,sb=/^(?:focusinfocus|focusoutblur)$/,tb=/^([^.]*)(?:\.(.+)|)$/;d.event={global:{},add:function(a,b,c,e,f){var g,h,k,l,p,q,m,t,y;if(p=n.get(a))for(c.handler&&(g=c,c=g.handler,f=g.selector),c.guid||(c.guid=d.guid++),
(l=p.events)||(l=p.events={}),(h=p.handle)||(h=p.handle=function(b){return"undefined"!==typeof d&&d.event.triggered!==b.type?d.event.dispatch.apply(a,arguments):void 0}),b=(b||"").match(L)||[""],p=b.length;p--;)k=tb.exec(b[p])||[],t=q=k[1],y=(k[2]||"").split(".").sort(),t&&(k=d.event.special[t]||{},t=(f?k.delegateType:k.bindType)||t,k=d.event.special[t]||{},q=d.extend({type:t,origType:q,data:e,handler:c,guid:c.guid,selector:f,needsContext:f&&d.expr.match.needsContext.test(f),namespace:y.join(".")},
g),(m=l[t])||(m=l[t]=[],m.delegateCount=0,k.setup&&!1!==k.setup.call(a,e,y,h)||a.addEventListener&&a.addEventListener(t,h,!1)),k.add&&(k.add.call(a,q),q.handler.guid||(q.handler.guid=c.guid)),f?m.splice(m.delegateCount++,0,q):m.push(q),d.event.global[t]=!0)},remove:function(a,b,c,e,f){var g,h,k,l,p,q,m,t,y,s,u,w=n.hasData(a)&&n.get(a);if(w&&(l=w.events)){b=(b||"").match(L)||[""];for(p=b.length;p--;)if(k=tb.exec(b[p])||[],y=u=k[1],s=(k[2]||"").split(".").sort(),y){m=d.event.special[y]||{};y=(e?m.delegateType:
m.bindType)||y;t=l[y]||[];k=k[2]&&RegExp("(^|\\.)"+s.join("\\.(?:.*\\.|)")+"(\\.|$)");for(h=g=t.length;g--;)q=t[g],!f&&u!==q.origType||c&&c.guid!==q.guid||k&&!k.test(q.namespace)||e&&!(e===q.selector||"**"===e&&q.selector)||(t.splice(g,1),q.selector&&t.delegateCount--,m.remove&&m.remove.call(a,q));h&&!t.length&&(m.teardown&&!1!==m.teardown.call(a,s,w.handle)||d.removeEvent(a,y,w.handle),delete l[y])}else for(y in l)d.event.remove(a,y+b[p],c,e,!0);d.isEmptyObject(l)&&(delete w.handle,n.remove(a,"events"))}},
trigger:function(a,b,c,e){var f,g,h,k,l,p,q=[c||s],m=La.call(a,"type")?a.type:a;p=La.call(a,"namespace")?a.namespace.split("."):[];g=f=c=c||s;if(3!==c.nodeType&&8!==c.nodeType&&!sb.test(m+d.event.triggered)&&(0<=m.indexOf(".")&&(p=m.split("."),m=p.shift(),p.sort()),k=0>m.indexOf(":")&&"on"+m,a=a[d.expando]?a:new d.Event(m,"object"===typeof a&&a),a.isTrigger=e?2:3,a.namespace=p.join("."),a.namespace_re=a.namespace?RegExp("(^|\\.)"+p.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,a.result=void 0,a.target||(a.target=
c),b=null==b?[a]:d.makeArray(b,[a]),p=d.event.special[m]||{},e||!p.trigger||!1!==p.trigger.apply(c,b))){if(!e&&!p.noBubble&&!d.isWindow(c)){h=p.delegateType||m;sb.test(h+m)||(g=g.parentNode);for(;g;g=g.parentNode)q.push(g),f=g;f===(c.ownerDocument||s)&&q.push(f.defaultView||f.parentWindow||u)}for(f=0;(g=q[f++])&&!a.isPropagationStopped();)a.type=1<f?h:p.bindType||m,(l=(n.get(g,"events")||{})[a.type]&&n.get(g,"handle"))&&l.apply(g,b),(l=k&&g[k])&&l.apply&&d.acceptData(g)&&(a.result=l.apply(g,b),!1===
a.result&&a.preventDefault());a.type=m;e||a.isDefaultPrevented()||p._default&&!1!==p._default.apply(q.pop(),b)||!d.acceptData(c)||!k||!d.isFunction(c[m])||d.isWindow(c)||((f=c[k])&&(c[k]=null),d.event.triggered=m,c[m](),d.event.triggered=void 0,f&&(c[k]=f));return a.result}},dispatch:function(a){a=d.event.fix(a);var b,c,e,f,g=[],h=N.call(arguments);b=(n.get(this,"events")||{})[a.type]||[];var k=d.event.special[a.type]||{};h[0]=a;a.delegateTarget=this;if(!k.preDispatch||!1!==k.preDispatch.call(this,
...
b){a=null==a?!1:a;b=null==b?a:b;return this.map(function(){return d.clone(this,a,b)})},html:function(a){return O(this,function(a){var c=this[0]||{},e=0,f=this.length;if(void 0===a&&1===c.nodeType)return c.innerHTML;if("string"===typeof a&&!cc.test(a)&&!z[(vb.exec(a)||["",""])[1].toLowerCase()]){a=a.replace(ub,"<$1></$2>");try{for(;e<f;e++)c=this[e]||{},1===c.nodeType&&(d.cleanData(x(c,!1)),c.innerHTML=a);c=0}catch(g){}}c&&this.empty().append(a)},null,a,arguments.length)},replaceWith:function(){var a=
arguments[0];this.domManip(arguments,function(b){a=this.parentNode;d.cleanData(x(this));a&&a.replaceChild(b,this)});return a&&(a.length||a.nodeType)?this:this.remove()},detach:function(a){return this.remove(a,!0)},domManip:function(a,b){a=mb.apply([],a);var c,e,f,g,h=0,k=this.length,l=this,p=k-1,q=a[0],m=d.isFunction(q);if(m||1<k&&"string"===typeof q&&!w.checkClone&&dc.test(q))return this.each(function(c){var d=l.eq(c);m&&(a[0]=q.call(this,c,d.html()));d.domManip(a,b)});if(k&&(c=d.buildFragment(a,
this[0].ownerDocument,!1,this),e=c.firstChild,1===c.childNodes.length&&(c=e),e)){e=d.map(x(c,"script"),Mb);for(f=e.length;h<k;h++)g=c,h!==p&&(g=d.clone(g,!0,!0),f&&d.merge(e,x(g,"script"))),b.call(this[h],g,h);if(f)for(c=e[e.length-1].ownerDocument,d.map(e,Nb),h=0;h<f;h++)g=e[h],wb.test(g.type||"")&&!n.access(g,"globalEval")&&d.contains(c,g)&&(g.src?d._evalUrl&&d._evalUrl(g.src):d.globalEval(g.textContent.replace(ec,"")))}return this}});d.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",
insertAfter:"after",replaceAll:"replaceWith"},function(a,b){d.fn[a]=function(a){for(var e=[],f=d(a),g=f.length-1,h=0;h<=g;h++)a=h===g?this:this.clone(!0),d(f[h])[b](a),Ka.apply(e,a.get());return this.pushStack(e)}});var T,Za={},$a=/^margin/,Ga=RegExp("^("+za+")(?!px)[a-z%]+$","i"),oa=function(a){return a.ownerDocument.defaultView.getComputedStyle(a,null)};(function(){function a(){g.style.cssText="-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;display:block;margin-top:1%;top:1%;border:1px;padding:1px;width:4px;position:absolute";
...
a.style[f],a.style[f]=b[f];c=c.apply(a,d||[]);for(f in b)a.style[f]=g[f];return c};var fc=/^(none|table(?!-c[ea]).+)/,Pb=RegExp("^("+za+")(.*)$","i"),gc=RegExp("^([+-])=("+za+")","i"),hc={position:"absolute",visibility:"hidden",display:"block"},xb={letterSpacing:"0",fontWeight:"400"},cb=["Webkit","O","Moz","ms"];d.extend({cssHooks:{opacity:{get:function(a,b){if(b){var c=Y(a,"opacity");return""===c?"1":c}}}},cssNumber:{columnCount:!0,fillOpacity:!0,flexGrow:!0,flexShrink:!0,fontWeight:!0,lineHeight:!0,
opacity:!0,order:!0,orphans:!0,widows:!0,zIndex:!0,zoom:!0},cssProps:{"float":"cssFloat"},style:function(a,b,c,e){if(a&&3!==a.nodeType&&8!==a.nodeType&&a.style){var f,g,h,k=d.camelCase(b),l=a.style;b=d.cssProps[k]||(d.cssProps[k]=bb(l,k));h=d.cssHooks[b]||d.cssHooks[k];if(void 0!==c)g=typeof c,"string"===g&&(f=gc.exec(c))&&(c=(f[1]+1)*f[2]+parseFloat(d.css(a,b)),g="number"),null!=c&&c===c&&("number"!==g||d.cssNumber[k]||(c+="px"),w.clearCloneStyle||""!==c||0!==b.indexOf("background")||(l[b]="inherit"),
h&&"set"in h&&void 0===(c=h.set(a,c,e))||(l[b]=c));else return h&&"get"in h&&void 0!==(f=h.get(a,!1,e))?f:l[b]}},css:function(a,b,c,e){var f,g;g=d.camelCase(b);b=d.cssProps[g]||(d.cssProps[g]=bb(a.style,g));(g=d.cssHooks[b]||d.cssHooks[g])&&"get"in g&&(f=g.get(a,!0,c));void 0===f&&(f=Y(a,b,e));"normal"===f&&b in xb&&(f=xb[b]);return""===c||c?(a=parseFloat(f),!0===c||d.isNumeric(a)?a||0:f):f}});d.each(["height","width"],function(a,b){d.cssHooks[b]={get:function(a,e,f){if(e)return fc.test(d.css(a,"display"))&&
0===a.offsetWidth?d.swap(a,hc,function(){return fb(a,b,f)}):fb(a,b,f)},set:function(a,e,f){var g=f&&oa(a);return db(a,e,f?eb(a,b,f,"border-box"===d.css(a,"boxSizing",!1,g),g):0)}}});d.cssHooks.marginRight=ab(w.reliableMarginRight,function(a,b){if(b)return d.swap(a,{display:"inline-block"},Y,[a,"marginRight"])});d.each({margin:"",padding:"",border:"Width"},function(a,b){d.cssHooks[a+b]={expand:function(c){var d=0,f={};for(c="string"===typeof c?c.split(" "):[c];4>d;d++)f[a+K[d]+b]=c[d]||c[d-2]||c[0];
return f}};$a.test(a)||(d.cssHooks[a+b].set=db)});d.fn.extend({css:function(a,b){return O(this,function(a,b,f){var g,h={},k=0;if(d.isArray(b)){f=oa(a);for(g=b.length;k<g;k++)h[b[k]]=d.css(a,b[k],!1,f);return h}return void 0!==f?d.style(a,b,f):d.css(a,b)},a,b,1<arguments.length)},show:function(){return gb(this,!0)},hide:function(){return gb(this)},toggle:function(a){return"boolean"===typeof a?a?this.show():this.hide():this.each(function(){U(this)?d(this).show():d(this).hide()})}});d.Tween=A;A.prototype=
{constructor:A,init:function(a,b,c,e,f,g){this.elem=a;this.prop=c;this.easing=f||"swing";this.options=b;this.start=this.now=this.cur();this.end=e;this.unit=g||(d.cssNumber[c]?"":"px")},cur:function(){var a=A.propHooks[this.prop];return a&&a.get?a.get(this):A.propHooks._default.get(this)},run:function(a){var b,c=A.propHooks[this.prop];this.pos=this.options.duration?b=d.easing[this.easing](a,this.options.duration*a,0,1,this.options.duration):b=a;this.now=(this.end-this.start)*b+this.start;this.options.step&&
this.options.step.call(this.elem,this.now,this);c&&c.set?c.set(this):A.propHooks._default.set(this);return this}};A.prototype.init.prototype=A.prototype;A.propHooks={_default:{get:function(a){return null==a.elem[a.prop]||a.elem.style&&null!=a.elem.style[a.prop]?(a=d.css(a.elem,a.prop,""))&&"auto"!==a?a:0:a.elem[a.prop]},set:function(a){if(d.fx.step[a.prop])d.fx.step[a.prop](a);else a.elem.style&&(null!=a.elem.style[d.cssProps[a.prop]]||d.cssHooks[a.prop])?d.style(a.elem,a.prop,a.now+a.unit):a.elem[a.prop]=
a.now}}};A.propHooks.scrollTop=A.propHooks.scrollLeft={set:function(a){a.elem.nodeType&&a.elem.parentNode&&(a.elem[a.prop]=a.now)}};d.easing={linear:function(a){return a},swing:function(a){return 0.5-Math.cos(a*Math.PI)/2}};d.fx=A.prototype.init;d.fx.step={};var Z,Aa,ic=/^(?:toggle|show|hide)$/,yb=RegExp("^(?:([+-])=|)("+za+")([a-z%]*)$","i"),jc=/queueHooks$/,qa=[function(a,b,c){var e,f,g,h,k,l,p=this,q={},m=a.style,t=a.nodeType&&U(a),s=n.get(a,"fxshow");c.queue||(h=d._queueHooks(a,"fx"),null==h.unqueued&&
...
c.overflow[1];m.overflowY=c.overflow[2]}));for(e in b)if(f=b[e],ic.exec(f)){delete b[e];g=g||"toggle"===f;if(f===(t?"hide":"show"))if("show"===f&&s&&void 0!==s[e])t=!0;else continue;q[e]=s&&s[e]||d.style(a,e)}else l=void 0;if(d.isEmptyObject(q))"inline"===("none"===l?Fa(a.nodeName):l)&&(m.display=l);else for(e in s?"hidden"in s&&(t=s.hidden):s=n.access(a,"fxshow",{}),g&&(s.hidden=!t),t?d(a).show():p.done(function(){d(a).hide()}),p.done(function(){var b;n.remove(a,"fxshow");for(b in q)d.style(a,b,
q[b])}),q)b=ib(t?s[e]:0,e,p),e in s||(s[e]=b.start,t&&(b.end=b.start,b.start="width"===e||"height"===e?1:0))}],Q={"*":[function(a,b){var c=this.createTween(a,b),e=c.cur(),f=yb.exec(b),g=f&&f[3]||(d.cssNumber[a]?"":"px"),h=(d.cssNumber[a]||"px"!==g&&+e)&&yb.exec(d.css(c.elem,a)),k=1,l=20;if(h&&h[3]!==g){g=g||h[3];f=f||[];h=+e||1;do k=k||".5",h/=k,d.style(c.elem,a,h+g);while(k!==(k=c.cur()/e)&&1!==k&&--l)}f&&(h=c.start=+h||+e||0,c.unit=g,c.end=f[1]?h+(f[1]+1)*f[2]:+f[2]);return c}]};d.Animation=d.extend(jb,
{tweener:function(a,b){d.isFunction(a)?(b=a,a=["*"]):a=a.split(" ");for(var c,e=0,f=a.length;e<f;e++)c=a[e],Q[c]=Q[c]||[],Q[c].unshift(b)},prefilter:function(a,b){b?qa.unshift(a):qa.push(a)}});d.speed=function(a,b,c){var e=a&&"object"===typeof a?d.extend({},a):{complete:c||!c&&b||d.isFunction(a)&&a,duration:a,easing:c&&b||b&&!d.isFunction(b)&&b};e.duration=d.fx.off?0:"number"===typeof e.duration?e.duration:e.duration in d.fx.speeds?d.fx.speeds[e.duration]:d.fx.speeds._default;if(null==e.queue||!0===
...
function(a){var b=a.stop;delete a.stop;b(c)};"string"!==typeof a&&(c=b,b=a,a=void 0);b&&!1!==a&&this.queue(a||"fx",[]);return this.each(function(){var b=!0,g=null!=a&&a+"queueHooks",h=d.timers,k=n.get(this);if(g)k[g]&&k[g].stop&&e(k[g]);else for(g in k)k[g]&&k[g].stop&&jc.test(g)&&e(k[g]);for(g=h.length;g--;)h[g].elem!==this||null!=a&&h[g].queue!==a||(h[g].anim.stop(c),b=!1,h.splice(g,1));!b&&c||d.dequeue(this,a)})},finish:function(a){!1!==a&&(a=a||"fx");return this.each(function(){var b,c=n.get(this),
e=c[a+"queue"];b=c[a+"queueHooks"];var f=d.timers,g=e?e.length:0;c.finish=!0;d.queue(this,a,[]);b&&b.stop&&b.stop.call(this,!0);for(b=f.length;b--;)f[b].elem===this&&f[b].queue===a&&(f[b].anim.stop(!0),f.splice(b,1));for(b=0;b<g;b++)e[b]&&e[b].finish&&e[b].finish.call(this);delete c.finish})}});d.each(["toggle","show","hide"],function(a,b){var c=d.fn[b];d.fn[b]=function(a,d,g){return null==a||"boolean"===typeof a?c.apply(this,arguments):this.animate(pa(b,!0),a,d,g)}});d.each({slideDown:pa("show"),
...
a.type="radio";w.radioValue="t"===a.value})();var zb,ja=d.expr.attrHandle;d.fn.extend({attr:function(a,b){return O(this,d.attr,a,b,1<arguments.length)},removeAttr:function(a){return this.each(function(){d.removeAttr(this,a)})}});d.extend({attr:function(a,b,c){var e,f,g=a.nodeType;if(a&&3!==g&&8!==g&&2!==g){if("undefined"===typeof a.getAttribute)return d.prop(a,b,c);1===g&&d.isXMLDoc(a)||(b=b.toLowerCase(),e=d.attrHooks[b]||(d.expr.match.bool.test(b)?zb:void 0));if(void 0!==c)if(null===c)d.removeAttr(a,
...
zb={set:function(a,b,c){!1===b?d.removeAttr(a,c):a.setAttribute(c,c);return c}};d.each(d.expr.match.bool.source.match(/\w+/g),function(a,b){var c=ja[b]||d.find.attr;ja[b]=function(a,b,d){var h,k;d||(k=ja[b],ja[b]=h,h=null!=c(a,b,d)?b.toLowerCase():null,ja[b]=k);return h}});var kc=/^(?:input|select|textarea|button)$/i;d.fn.extend({prop:function(a,b){return O(this,d.prop,a,b,1<arguments.length)},removeProp:function(a){return this.each(function(){delete this[d.propFix[a]||a]})}});d.extend({propFix:{"for":"htmlFor",
"class":"className"},prop:function(a,b,c){var e,f,g;g=a.nodeType;if(a&&3!==g&&8!==g&&2!==g){if(g=1!==g||!d.isXMLDoc(a))b=d.propFix[b]||b,f=d.propHooks[b];return void 0!==c?f&&"set"in f&&void 0!==(e=f.set(a,c,b))?e:a[b]=c:f&&"get"in f&&null!==(e=f.get(a,b))?e:a[b]}},propHooks:{tabIndex:{get:function(a){return a.hasAttribute("tabindex")||kc.test(a.nodeName)||a.href?a.tabIndex:-1}}}});w.optSelected||(d.propHooks.selected={get:function(a){(a=a.parentNode)&&a.parentNode&&a.parentNode.selectedIndex;return null}});
d.each("tabIndex readOnly maxLength cellSpacing cellPadding rowSpan colSpan useMap frameBorder contentEditable".split(" "),function(){d.propFix[this.toLowerCase()]=this});var Oa=/[\t\r\n\f]/g;d.fn.extend({addClass:function(a){var b,c,e,f,g;b="string"===typeof a&&a;var h=0,k=this.length;if(d.isFunction(a))return this.each(function(b){d(this).addClass(a.call(this,b,this.className))});if(b)for(b=(a||"").match(L)||[];h<k;h++)if(c=this[h],e=1===c.nodeType&&(c.className?(" "+c.className+" ").replace(Oa,
" "):" ")){for(g=0;f=b[g++];)0>e.indexOf(" "+f+" ")&&(e+=f+" ");e=d.trim(e);c.className!==e&&(c.className=e)}return this},removeClass:function(a){var b,c,e,f,g;b=0===arguments.length||"string"===typeof a&&a;var h=0,k=this.length;if(d.isFunction(a))return this.each(function(b){d(this).removeClass(a.call(this,b,this.className))});if(b)for(b=(a||"").match(L)||[];h<k;h++)if(c=this[h],e=1===c.nodeType&&(c.className?(" "+c.className+" ").replace(Oa," "):"")){for(g=0;f=b[g++];)for(;0<=e.indexOf(" "+f+" ");)e=
...
c=a.options,e=a.selectedIndex,f=(a="select-one"===a.type||0>e)?null:[],g=a?e+1:c.length,h=0>e?g:a?e:0;h<g;h++)if(b=c[h],!(!b.selected&&h!==e||(w.optDisabled?b.disabled:null!==b.getAttribute("disabled"))||b.parentNode.disabled&&d.nodeName(b.parentNode,"optgroup"))){b=d(b).val();if(a)return b;f.push(b)}return f},set:function(a,b){for(var c,e,f=a.options,g=d.makeArray(b),h=f.length;h--;)if(e=f[h],e.selected=0<=d.inArray(e.value,g))c=!0;c||(a.selectedIndex=-1);return g}}}});d.each(["radio","checkbox"],
...
b=c.parseFromString(a,"text/xml")}catch(e){b=void 0}b&&!b.getElementsByTagName("parsererror").length||d.error("Invalid XML: "+a);return b};var S,P,mc=/#.*$/,Ab=/([?&])_=[^&]*/,nc=/^(.*?):[ \t]*([^\r\n]*)$/mg,oc=/^(?:GET|HEAD)$/,pc=/^\/\//,Bb=/^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/,Cb={},Ha={},Db="*/".concat("*");try{P=location.href}catch(xc){P=s.createElement("a"),P.href="",P=P.href}S=Bb.exec(P.toLowerCase())||[];d.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:P,type:"GET",
isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(S[1]),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":Db,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/xml/,html:/html/,json:/json/},responseFields:{xml:"responseXML",text:"responseText",json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":d.parseJSON,"text xml":d.parseXML},
...
x={},A={},J=0,v="canceled",r={readyState:0,getResponseHeader:function(a){var b;if(2===J){if(!h)for(h={};b=nc.exec(g);)h[b[1].toLowerCase()]=b[2];b=h[a.toLowerCase()]}return null==b?null:b},getAllResponseHeaders:function(){return 2===J?g:null},setRequestHeader:function(a,b){var c=a.toLowerCase();J||(a=A[c]=A[c]||a,x[a]=b);return this},overrideMimeType:function(a){J||(m.mimeType=a);return this},statusCode:function(a){var b;if(a)if(2>J)for(b in a)G[b]=[G[b],a[b]];else r.always(a[r.status]);return this},
abort:function(a){a=a||v;e&&e.abort(a);c(0,a);return this}};u.promise(r).complete=w.add;r.success=r.done;r.error=r.fail;m.url=((a||m.url||P)+"").replace(mc,"").replace(pc,S[1]+"//");m.type=b.method||b.type||m.method||m.type;m.dataTypes=d.trim(m.dataType||"*").toLowerCase().match(L)||[""];null==m.crossDomain&&(l=Bb.exec(m.url.toLowerCase()),m.crossDomain=!(!l||l[1]===S[1]&&l[2]===S[2]&&(l[3]||("http:"===l[1]?"80":"443"))===(S[3]||("http:"===S[1]?"80":"443"))));m.data&&m.processData&&"string"!==typeof m.data&&
(m.data=d.param(m.data,m.traditional));lb(Cb,m,b,r);if(2===J)return r;(p=m.global)&&0===d.active++&&d.event.trigger("ajaxStart");m.type=m.type.toUpperCase();m.hasContent=!oc.test(m.type);f=m.url;m.hasContent||(m.data&&(f=m.url+=(Qa.test(f)?"&":"?")+m.data,delete m.data),!1===m.cache&&(m.url=Ab.test(f)?f.replace(Ab,"$1_="+Pa++):f+(Qa.test(f)?"&":"?")+"_="+Pa++));m.ifModified&&(d.lastModified[f]&&r.setRequestHeader("If-Modified-Since",d.lastModified[f]),d.etag[f]&&r.setRequestHeader("If-None-Match",
d.etag[f]));(m.data&&m.hasContent&&!1!==m.contentType||b.contentType)&&r.setRequestHeader("Content-Type",m.contentType);r.setRequestHeader("Accept",m.dataTypes[0]&&m.accepts[m.dataTypes[0]]?m.accepts[m.dataTypes[0]]+("*"!==m.dataTypes[0]?", "+Db+"; q=0.01":""):m.accepts["*"]);for(n in m.headers)r.setRequestHeader(n,m.headers[n]);if(m.beforeSend&&(!1===m.beforeSend.call(t,r,m)||2===J))return r.abort();v="abort";for(n in{success:1,error:1,complete:1})r[n](m[n]);if(e=lb(Ha,m,b,r)){r.readyState=1;p&&
s.trigger("ajaxSend",[r,m]);m.async&&0<m.timeout&&(k=setTimeout(function(){r.abort("timeout")},m.timeout));try{J=1,e.send(x,c)}catch(z){if(2>J)c(-1,z);else throw z;}}else c(-1,"No Transport");return r},getJSON:function(a,b,c){return d.get(a,b,c,"json")},getScript:function(a,b){return d.get(a,void 0,b,"script")}});d.each(["get","post"],function(a,b){d[b]=function(a,e,f,g){d.isFunction(e)&&(g=g||f,f=e,e=void 0);return d.ajax({url:a,type:b,dataType:g,data:e,success:f})}});d.each("ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(" "),
function(a,b){d.fn[b]=function(a){return this.on(b,a)}});d._evalUrl=function(a){return d.ajax({url:a,type:"GET",dataType:"script",async:!1,global:!1,"throws":!0})};d.fn.extend({wrapAll:function(a){var b;if(d.isFunction(a))return this.each(function(b){d(this).wrapAll(a.call(this,b))});this[0]&&(b=d(a,this[0].ownerDocument).eq(0).clone(!0),this[0].parentNode&&b.insertBefore(this[0]),b.map(function(){for(var a=this;a.firstElementChild;)a=a.firstElementChild;return a}).append(this));return this},wrapInner:function(a){return d.isFunction(a)?
...
var qc=/%20/g,Rb=/\[\]$/,Eb=/\r?\n/g,rc=/^(?:submit|button|image|reset|file)$/i,sc=/^(?:input|select|textarea|keygen)/i;d.param=function(a,b){var c,e=[],f=function(a,b){b=d.isFunction(b)?b():null==b?"":b;e[e.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};void 0===b&&(b=d.ajaxSettings&&d.ajaxSettings.traditional);if(d.isArray(a)||a.jquery&&!d.isPlainObject(a))d.each(a,function(){f(this.name,this.value)});else for(c in a)Ja(c,a[c],b,f);return e.join("&").replace(qc,"+")};d.fn.extend({serialize:function(){return d.param(this.serializeArray())},
...
var Fb=[],Ra=/(=)\?(?=&|$)|\?\?/;d.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var a=Fb.pop()||d.expando+"_"+Pa++;this[a]=!0;return a}});d.ajaxPrefilter("json jsonp",function(a,b,c){var e,f,g,h=!1!==a.jsonp&&(Ra.test(a.url)?"url":"string"===typeof a.data&&!(a.contentType||"").indexOf("application/x-www-form-urlencoded")&&Ra.test(a.data)&&"data");if(h||"jsonp"===a.dataTypes[0])return e=a.jsonpCallback=d.isFunction(a.jsonpCallback)?a.jsonpCallback():a.jsonpCallback,h?a[h]=a[h].replace(Ra,"$1"+
e):!1!==a.jsonp&&(a.url+=(Qa.test(a.url)?"&":"?")+a.jsonp+"="+e),a.converters["script json"]=function(){g||d.error(e+" was not called");return g[0]},a.dataTypes[0]="json",f=u[e],u[e]=function(){g=arguments},c.always(function(){u[e]=f;a[e]&&(a.jsonpCallback=b.jsonpCallback,Fb.push(e));g&&d.isFunction(f)&&f(g[0]);g=f=void 0}),"script"});d.parseHTML=function(a,b,c){if(!a||"string"!==typeof a)return null;"boolean"===typeof b&&(c=b,b=!1);b=b||s;var e=qb.exec(a);c=!c&&[];if(e)return[b.createElement(e[1])];
e=d.buildFragment([a],b,c);c&&c.length&&d(c).remove();return d.merge([],e.childNodes)};var Gb=d.fn.load;d.fn.load=function(a,b,c){if("string"!==typeof a&&Gb)return Gb.apply(this,arguments);var e,f,g,h=this,k=a.indexOf(" ");0<=k&&(e=d.trim(a.slice(k)),a=a.slice(0,k));d.isFunction(b)?(c=b,b=void 0):b&&"object"===typeof b&&(f="POST");0<h.length&&d.ajax({url:a,type:f,dataType:"html",data:b}).done(function(a){g=arguments;h.html(e?d("<div>").append(d.parseHTML(a)).find(e):a)}).complete(c&&function(a,b){h.each(c,
g||[a.responseText,b,a])});return this};d.expr.filters.animated=function(a){return d.grep(d.timers,function(b){return a===b.elem}).length};var Hb=u.document.documentElement;d.offset={setOffset:function(a,b,c){var e,f,g,h=d.css(a,"position"),k=d(a),l={};"static"===h&&(a.style.position="relative");g=k.offset();f=d.css(a,"top");e=d.css(a,"left");("absolute"===h||"fixed"===h)&&-1<(f+e).indexOf("auto")?(e=k.position(),f=e.top,e=e.left):(f=parseFloat(f)||0,e=parseFloat(e)||0);d.isFunction(b)&&(b=b.call(a,
...
a],c["client"+a])):void 0===e?d.css(b,c,k):d.style(b,c,e,k)},b,h?e:void 0,h,null)}})});d.fn.size=function(){return this.length};d.fn.andSelf=d.fn.addBack;"function"===typeof define&&define.amd&&define("jquery",[],function(){return d});var vc=u.jQuery,wc=u.$;d.noConflict=function(a){u.$===d&&(u.$=wc);a&&u.jQuery===d&&(u.jQuery=vc);return d};"undefined"===typeof W&&(u.jQuery=u.$=d);return d});
