...
return a in b?b.value:null},set:function(a,c){var d=(a.nodeName||"").toLowerCase();if("button"===d)return A.apply(this,arguments);"input"!==d&&"option"!==d&&g("jQuery.fn.attr('value', val) no longer sets properties");a.value=c}};var n,k,t=a.fn.init,F=a.parseJSON,G=/^([^<]*)(<[\w\W]+>)([^>]*)$/;a.fn.init=function(b,c,d){var e;if(b&&"string"===typeof b&&!a.isPlainObject(c)&&(e=G.exec(a.trim(b)))&&e[0])if("<"!==b.charAt(0)&&g("$(html) HTML strings must start with '<' character"),e[3]&&g("$(html) HTML text after last tag is ignored"),
"#"===e[0].charAt(0)&&(g("HTML string cannot start with a '#' character"),a.error("JQMIGRATE: Invalid selector string (XSS)")),c&&c.context&&(c=c.context),a.parseHTML)return t.call(this,a.parseHTML(e[2],c,!0),c,d);return t.apply(this,arguments)};a.fn.init.prototype=a.fn;a.parseJSON=function(a){return!a&&null!==a?(g("jQuery.parseJSON requires a valid JSON string"),null):F.apply(this,arguments)};a.uaMatch=function(a){a=a.toLowerCase();a=/(chrome)[ \/]([\w.]+)/.exec(a)||/(webkit)[ \/]([\w.]+)/.exec(a)||
/(opera)(?:.*version|)[ \/]([\w.]+)/.exec(a)||/(msie) ([\w.]+)/.exec(a)||0>a.indexOf("compatible")&&/(mozilla)(?:.*? rv:([\w.]+)|)/.exec(a)||[];return{browser:a[1]||"",version:a[2]||"0"}};a.browser||(n=a.uaMatch(navigator.userAgent),k={},n.browser&&(k[n.browser]=!0,k.version=n.version),k.chrome?k.webkit=!0:k.webkit&&(k.safari=!0),a.browser=k);q(a,"browser",a.browser,"jQuery.browser is deprecated");a.sub=function(){function b(a,c){return new b.fn.init(a,c)}a.extend(!0,b,this);b.superclass=this;b.fn=
b.prototype=this();b.fn.constructor=b;b.sub=this.sub;b.fn.init=function(d,e){e&&(e instanceof a&&!(e instanceof b))&&(e=b(e));return a.fn.init.call(this,d,e,c)};b.fn.init.prototype=b.fn;var c=b(document);g("jQuery.sub() is deprecated");return b};a.ajaxSetup({converters:{"text json":a.parseJSON}});var H=a.fn.data;a.fn.data=function(b){var c,d;if((d=this[0])&&"events"===b&&1===arguments.length)if(c=a.data(d,b),d=a._data(d,b),(c===l||c===d)&&d!==l)return g("Use of jQuery.fn.data('events') is deprecated"),
d;return H.apply(this,arguments)};var I=/\/(java|ecma)script/i,J=a.fn.andSelf||a.fn.addBack;a.fn.andSelf=function(){g("jQuery.fn.andSelf() replaced by jQuery.fn.addBack()");return J.apply(this,arguments)};a.clean||(a.clean=function(b,c,d,e){c=c||document;c=!c.nodeType&&c[0]||c;c=c.ownerDocument||c;g("jQuery.clean() is deprecated");var f,h=[];a.merge(h,a.buildFragment(b,c).childNodes);if(d){c=function(a){if(!a.type||I.test(a.type))return e?e.push(a.parentNode?a.parentNode.removeChild(a):a):d.appendChild(a)};
for(b=0;null!=(f=h[b]);b++)if(!a.nodeName(f,"script")||!c(f))d.appendChild(f),"undefined"!==typeof f.getElementsByTagName&&(f=a.grep(a.merge([],f.getElementsByTagName("script")),c),h.splice.apply(h,[b+1,0].concat(f)),b+=f.length)}return h});var K=a.event.add,L=a.event.remove,M=a.event.trigger,N=a.fn.toggle,u=a.fn.live,v=a.fn.die,w=/\b(?:ajaxStart|ajaxStop|ajaxSend|ajaxComplete|ajaxError|ajaxSuccess)\b/,x=/(?:^|\s)hover(\.\S+|)\b/,y=function(b){if("string"!==typeof b||a.event.special.hover)return b;
x.test(b)&&g("'hover' pseudo-event is deprecated, use 'mouseenter mouseleave'");return b&&b.replace(x,"mouseenter$1 mouseleave$1")};a.event.props&&"attrChange"!==a.event.props[0]&&a.event.props.unshift("attrChange","attrName","relatedNode","srcElement");a.event.dispatch&&q(a.event,"handle",a.event.dispatch,"jQuery.event.handle is undocumented and deprecated");a.event.add=function(a,c,d,e,f){a!==document&&w.test(c)&&g("AJAX events should be attached to document: "+c);K.call(this,a,y(c||""),d,e,f)};
a.event.remove=function(a,c,d,e,f){L.call(this,a,y(c)||"",d,e,f)};a.fn.error=function(){var a=Array.prototype.slice.call(arguments,0);g("jQuery.fn.error() is deprecated");a.splice(0,0,"error");if(arguments.length)return this.bind.apply(this,a);this.triggerHandler.apply(this,a);return this};a.fn.toggle=function(b,c){if(!a.isFunction(b)||!a.isFunction(c))return N.apply(this,arguments);g("jQuery.fn.toggle(handler, handler...) is deprecated");var d=arguments,e=b.guid||a.guid++,f=0,h=function(c){var e=
