(function(d){function h(k){var h=k.handler,e=(k.namespace||"").toLowerCase().split(" "),e=d.map(e,function(a){return a.split(".")});1===e.length&&(""===e[0]||"autocomplete"===e[0])||(k.handler=function(a){if(!(this!==a.target&&(/textarea|select/i.test(a.target.nodeName)||"text"===a.target.type||"true"==$(a.target).prop("contenteditable")))){var c="keypress"!==a.type&&d.hotkeys.specialKeys[a.which],f=String.fromCharCode(a.which).toLowerCase(),b="",g={};a.altKey&&"alt"!==c&&(b+="alt_");a.ctrlKey&&"ctrl"!==
