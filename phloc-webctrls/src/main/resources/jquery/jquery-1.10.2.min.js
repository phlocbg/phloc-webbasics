...
typeof b||"function"===typeof b)e?h[k]=c.extend(h[k],b):h[k].data=c.extend(h[k].data,b);a=h[k];e||(a.data||(a.data={}),a=a.data);d!==n&&(a[c.camelCase(b)]=d);"string"===typeof b?(d=a[b],null==d&&(d=a[c.camelCase(b)])):d=a;return d}}}function Ta(a,b,d){if(c.acceptData(a)){var e,f,g=a.nodeType,h=g?c.cache:a,k=g?a[c.expando]:c.expando;if(h[k]){if(b&&(e=d?h[k]:h[k].data)){c.isArray(b)?b=b.concat(c.map(b,c.camelCase)):b in e?b=[b]:(b=c.camelCase(b),b=b in e?[b]:b.split(" "));for(f=b.length;f--;)delete e[b[f]];
...
"globalEval",!b||c._data(b[e],"globalEval"))}function bb(a,b){if(1===b.nodeType&&c.hasData(a)){var d,e,f;e=c._data(a);var g=c._data(b,e),h=e.events;if(h)for(d in delete g.handle,g.events={},h){e=0;for(f=h[d].length;e<f;e++)c.event.add(b,d,h[d][e])}g.data&&(g.data=c.extend({},g.data))}}function B(a,b){var d,e,f=0,g=typeof a.getElementsByTagName!==z?a.getElementsByTagName(b||"*"):typeof a.querySelectorAll!==z?a.querySelectorAll(b||"*"):n;if(!g){g=[];for(d=a.childNodes||a;null!=(e=d[f]);f++)!b||c.nodeName(e,
...
f=parseFloat(f)||0}return f+hb(a,b,d||(h?"border":"content"),e,g)+"px"}function fb(a){var b=p,d=jb[a];if(!d){d=kb(a,b);if("none"===d||!d)ga=(ga||c("<iframe frameborder='0' width='0' height='0'/>").css("cssText","display:block !important")).appendTo(b.documentElement),b=(ga[0].contentWindow||ga[0].contentDocument).document,b.write("<!doctype html><html><body>"),b.close(),d=kb(a,b),ga.detach();jb[a]=d}return d}function kb(a,b){var d=c(b.createElement(a)).appendTo(b.body),e=c.css(d[0],"display");d.remove();
...
c,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:Da,sort:[].sort,splice:[].splice};c.fn.init.prototype=c.fn;c.extend=c.fn.extend=function(){var a,b,d,e,f,g=arguments[0]||{},h=1,k=arguments.length,l=!1;"boolean"===typeof g&&(l=g,g=arguments[1]||{},h=2);"object"!==typeof g&&!c.isFunction(g)&&(g={});k===h&&(g=this,--h);for(;h<k;h++)if(null!=(f=arguments[h]))for(e in f)a=g[e],d=f[e],g!==d&&(l&&d&&(c.isPlainObject(d)||(b=c.isArray(d)))?(b?(b=!1,a=a&&c.isArray(a)?a:[]):a=a&&
c.isPlainObject(a)?a:{},g[e]=c.extend(l,a,d)):d!==n&&(g[e]=d));return g};c.extend({expando:"jQuery"+("1.10.2"+Math.random()).replace(/\D/g,""),noConflict:function(a){s.$===c&&(s.$=cc);a&&s.jQuery===c&&(s.jQuery=bc);return c},isReady:!1,readyWait:1,holdReady:function(a){a?c.readyWait++:c.ready(!0)},ready:function(a){if(!(!0===a?--c.readyWait:c.isReady)){if(!p.body)return setTimeout(c.ready);c.isReady=!0;!0!==a&&0<--c.readyWait||(ba.resolveWith(p,[c]),c.fn.trigger&&c(p).trigger("ready").off("ready"))}},
isFunction:function(a){return"function"===c.type(a)},isArray:Array.isArray||function(a){return"array"===c.type(a)},isWindow:function(a){return null!=a&&a==a.window},isNumeric:function(a){return!isNaN(parseFloat(a))&&isFinite(a)},type:function(a){return null==a?String(a):"object"===typeof a||"function"===typeof a?oa[dc.call(a)]||"object":typeof a},isPlainObject:function(a){var b;if(!a||"object"!==c.type(a)||a.nodeType||c.isWindow(a))return!1;try{if(a.constructor&&!V.call(a,"constructor")&&!V.call(a.constructor.prototype,
"isPrototypeOf"))return!1}catch(d){return!1}if(c.support.ownLast)for(b in a)return V.call(a,b);for(b in a);return b===n||V.call(a,b)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw Error(a);},parseHTML:function(a,b,d){if(!a||"string"!==typeof a)return null;"boolean"===typeof b&&(d=b,b=!1);b=b||p;var e=wb.exec(a);d=!d&&[];if(e)return[b.createElement(e[1])];e=c.buildFragment([a],b,d);d&&c(d).remove();return c.merge([],e.childNodes)},parseJSON:function(a){if(s.JSON&&
s.JSON.parse)return s.JSON.parse(a);if(null===a)return a;if("string"===typeof a&&(a=c.trim(a))&&gc.test(a.replace(ic,"@").replace(jc,"]").replace(hc,"")))return(new Function("return "+a))();c.error("Invalid JSON: "+a)},parseXML:function(a){var b,d;if(!a||"string"!==typeof a)return null;try{s.DOMParser?(d=new DOMParser,b=d.parseFromString(a,"text/xml")):(b=new ActiveXObject("Microsoft.XMLDOM"),b.async="false",b.loadXML(a))}catch(e){b=n}(!b||!b.documentElement||b.getElementsByTagName("parsererror").length)&&
c.error("Invalid XML: "+a);return b},noop:function(){},globalEval:function(a){a&&c.trim(a)&&(s.execScript||function(a){s.eval.call(s,a)})(a)},camelCase:function(a){return a.replace(kc,"ms-").replace(lc,mc)},nodeName:function(a,b){return a.nodeName&&a.nodeName.toLowerCase()===b.toLowerCase()},each:function(a,b,c){var e,f=0,g=a.length;e=ta(a);if(c)if(e)for(;f<g&&!(e=b.apply(a[f],c),!1===e);f++);else for(f in a){if(e=b.apply(a[f],c),!1===e)break}else if(e)for(;f<g&&!(e=b.call(a[f],f,a[f]),!1===e);f++);
else for(f in a)if(e=b.call(a[f],f,a[f]),!1===e)break;return a},trim:Ea&&!Ea.call("﻿ ")?function(a){return null==a?"":Ea.call(a)}:function(a){return null==a?"":(a+"").replace(ec,"")},makeArray:function(a,b){var d=b||[];null!=a&&(ta(Object(a))?c.merge(d,"string"===typeof a?[a]:a):Da.call(d,a));return d},inArray:function(a,b,c){var e;if(b){if(vb)return vb.call(b,a,c);e=b.length;for(c=c?0>c?Math.max(0,e+c):c:0;c<e;c++)if(c in b&&b[c]===a)return c}return-1},merge:function(a,b){var c=b.length,e=a.length,
f=0;if("number"===typeof c)for(;f<c;f++)a[e++]=b[f];else for(;b[f]!==n;)a[e++]=b[f++];a.length=e;return a},grep:function(a,b,c){var e,f=[],g=0,h=a.length;for(c=!!c;g<h;g++)e=!!b(a[g],g),c!==e&&f.push(a[g]);return f},map:function(a,b,c){var e,f=0,g=a.length,h=[];if(ta(a))for(;f<g;f++)e=b(a[f],f,c),null!=e&&(h[h.length]=e);else for(f in a)e=b(a[f],f,c),null!=e&&(h[h.length]=e);return ub.apply([],h)},guid:1,proxy:function(a,b){var d,e;"string"===typeof b&&(e=a[b],b=a,a=e);if(!c.isFunction(a))return n;
d=C.call(arguments,2);e=function(){return a.apply(b||this,d.concat(C.call(arguments)))};e.guid=a.guid=a.guid||c.guid++;return e},access:function(a,b,d,e,f,g,h){var k=0,l=a.length,q=null==d;if("object"===c.type(d))for(k in f=!0,d)c.access(a,b,k,d[k],!0,g,h);else if(e!==n&&(f=!0,c.isFunction(e)||(h=!0),q&&(h?(b.call(a,e),b=null):(q=b,b=function(a,b,d){return q.call(c(a),d)})),b))for(;k<l;k++)b(a[k],d,h?e:e.call(a[k],k,b(a[k],d)));return f?a:q?b.call(a):l?b(a[0],d):g},now:function(){return(new Date).getTime()},
...
!(d[e]=c[e])})})}function m(){}function n(a,b){var c,e,f,g,h,k,m;if(h=O[a+" "])return b?0:h.slice(0);h=a;k=[];for(m=u.preFilter;h;){if(!c||(e=ga.exec(h)))e&&(h=h.slice(e[0].length)||h),k.push(f=[]);c=!1;if(e=ha.exec(h))c=e.shift(),f.push({value:c,type:e[0].replace(P," ")}),h=h.slice(c.length);for(g in u.filter)if((e=U[g].exec(h))&&(!m[g]||(e=m[g](e))))c=e.shift(),f.push({value:c,type:g,matches:e}),h=h.slice(c.length);if(!c)break}return b?h.length:h?d.error(a):O(a,k).slice(0)}function K(a){for(var b=
...
c,d){for(var e=a.length;e--;)if(!a[e](b,c,d))return!1;return!0}:a[0]}function ua(a,b,c,d,e){for(var f,g=[],h=0,k=a.length,m=null!=b;h<k;h++)if(f=a[h])if(!c||c(f,d,e))g.push(f),m&&b.push(h);return g}function B(a,b,c,e,g,h){e&&!e[w]&&(e=B(e));g&&!g[w]&&(g=B(g,h));return f(function(f,h,k,m){var l,q,t=[],n=[],v=h.length,u;if(!(u=f)){u=b||"*";for(var r=k.nodeType?[k]:k,K=[],p=0,s=r.length;p<s;p++)d(u,r[p],K);u=K}u=a&&(f||!b)?ua(u,t,a,k,m):u;r=c?g||(f?a:v||e)?[]:h:u;c&&c(u,r,k,m);if(e){l=ua(r,n);e(l,[],
k,m);for(k=l.length;k--;)if(q=l[k])r[n[k]]=!(u[n[k]]=q)}if(f){if(g||a){if(g){l=[];for(k=r.length;k--;)if(q=r[k])l.push(u[k]=q);g(null,r=[],l,m)}for(k=r.length;k--;)if((q=r[k])&&-1<(l=g?ja.call(f,q):t[k]))f[l]=!(h[l]=q)}}else r=ua(r===h?r.splice(v,r.length):r),g?g(null,h,r,m):ca.apply(h,r)})}function F(a){var b,c,d,e=a.length,f=u.relative[a[0].type];c=f||u.relative[" "];for(var g=f?1:0,h=p(function(a){return a===b},c,!0),k=p(function(a){return-1<ja.call(b,a)},c,!0),m=[function(a,c,d){return!f&&(d||
c!==z)||((b=c).nodeType?h(a,c,d):k(a,c,d))}];g<e;g++)if(c=u.relative[a[g].type])m=[p(s(m),c)];else{c=u.filter[a[g].type].apply(null,a[g].matches);if(c[w]){for(d=++g;d<e&&!u.relative[a[d].type];d++);return B(1<g&&s(m),1<g&&K(a.slice(0,g-1).concat({value:" "===a[g-2].type?"*":""})).replace(P,"$1"),c,g<d&&F(a.slice(g,d)),d<e&&F(a=a.slice(d)),d<e&&K(a))}m.push(c)}return s(m)}function pc(a,b){var c=0,e=0<b.length,g=0<a.length,h=function(f,h,k,m,l){var q,t,n=[],r=0,v="0",p=f&&[],K=null!=l,s=z,nc=f||g&&
u.find.TAG("*",l&&h.parentNode||h),w=D+=null==s?1:Math.random()||0.1;K&&(z=h!==x&&h,E=c);for(;null!=(l=nc[v]);v++){if(g&&l){for(q=0;t=a[q++];)if(t(l,h,k)){m.push(l);break}K&&(D=w,E=++c)}e&&((l=!t&&l)&&r--,f&&p.push(l))}r+=v;if(e&&v!==r){for(q=0;t=b[q++];)t(p,n,h,k);if(f){if(0<r)for(;v--;)!p[v]&&!n[v]&&(n[v]=$.call(m));n=ua(n)}ca.apply(m,n);K&&(!f&&0<n.length&&1<r+b.length)&&d.uniqueSort(m)}K&&(D=w,z=s);return p};return e?f(h):h}var y,r,E,u,va,yb,Ga,z,ka,ia,x,I,G,J,L,A,sa,w="sizzle"+-new Date,W=a.document,
D=0,oc=0,N=e(),O=e(),Q=e(),H=!1,M=function(a,b){a===b&&(H=!0);return 0},C=typeof b,R=-2147483648,Y={}.hasOwnProperty,fa=[],$=fa.pop,aa=fa.push,ca=fa.push,T=fa.slice,ja=fa.indexOf||function(a){for(var b=0,c=this.length;b<c;b++)if(this[b]===a)return b;return-1},V="(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w","w#"),X="\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)[\\x20\\t\\r\\n\\f]*(?:([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|("+V+")|)|)[\\x20\\t\\r\\n\\f]*\\]",
S=":((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|"+X.replace(3,8)+")*)|.*)\\)|)",P=/^[\x20\t\r\n\f]+|((?:^|[^\\])(?:\\.)*)[\x20\t\r\n\f]+$/g,ga=/^[\x20\t\r\n\f]*,[\x20\t\r\n\f]*/,ha=/^[\x20\t\r\n\f]*([>+~]|[\x20\t\r\n\f])[\x20\t\r\n\f]*/,Z=/[\x20\t\r\n\f]*[+~]/,la=/=[\x20\t\r\n\f]*([^\]'"]*)[\x20\t\r\n\f]*\]/g,ma=RegExp(S),na=RegExp("^"+V+"$"),U={ID:/^#((?:\\.|[\w-]|[^\x00-\xa0])+)/,CLASS:/^\.((?:\\.|[\w-]|[^\x00-\xa0])+)/,TAG:RegExp("^("+"(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w",
"w*")+")"),ATTR:RegExp("^"+X),PSEUDO:RegExp("^"+S),CHILD:RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\([\\x20\\t\\r\\n\\f]*(even|odd|(([+-]|)(\\d*)n|)[\\x20\\t\\r\\n\\f]*(?:([+-]|)[\\x20\\t\\r\\n\\f]*(\\d+)|))[\\x20\\t\\r\\n\\f]*\\)|)","i"),bool:RegExp("^(?:checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)$","i"),needsContext:RegExp("^[\\x20\\t\\r\\n\\f]*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\([\\x20\\t\\r\\n\\f]*((?:-\\d)?\\d*)[\\x20\\t\\r\\n\\f]*\\)|)(?=[^-]|$)",
"i")},ba=/^[^{]+\{\s*\[native \w/,oa=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,pa=/^(?:input|select|textarea|button)$/i,qa=/^h\d$/i,ra=/'|\\/g,da=/\\([\da-f]{1,6}[\x20\t\r\n\f]?|([\x20\t\r\n\f])|.)/ig,ea=function(a,b,c){a="0x"+b-65536;return a!==a||c?b:0>a?String.fromCharCode(a+65536):String.fromCharCode(a>>10|55296,a&1023|56320)};try{ca.apply(fa=T.call(W.childNodes),W.childNodes),fa[W.childNodes.length].nodeType}catch(ta){ca={apply:fa.length?function(a,b){aa.apply(a,T.call(b))}:function(a,b){for(var c=
a.length,d=0;a[c++]=b[d++];);a.length=c-1}}}yb=d.isXML=function(a){return(a=a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};r=d.support={};ia=d.setDocument=function(a){var b=a?a.ownerDocument||a:W;a=b.defaultView;if(b===x||9!==b.nodeType||!b.documentElement)return x;x=b;I=b.documentElement;G=!yb(b);a&&(a.attachEvent&&a!==a.top)&&a.attachEvent("onbeforeunload",function(){ia()});r.attributes=g(function(a){a.className="i";return!a.getAttribute("className")});r.getElementsByTagName=g(function(a){a.appendChild(b.createComment(""));
return!a.getElementsByTagName("*").length});r.getElementsByClassName=g(function(a){a.innerHTML="<div class='a'></div><div class='a i'></div>";a.firstChild.className="i";return 2===a.getElementsByClassName("i").length});r.getById=g(function(a){I.appendChild(a).id=w;return!b.getElementsByName||!b.getElementsByName(w).length});r.getById?(u.find.ID=function(a,b){if(typeof b.getElementById!==C&&G){var c=b.getElementById(a);return c&&c.parentNode?[c]:[]}},u.filter.ID=function(a){var b=a.replace(da,ea);
return function(a){return a.getAttribute("id")===b}}):(delete u.find.ID,u.filter.ID=function(a){var b=a.replace(da,ea);return function(a){return(a=typeof a.getAttributeNode!==C&&a.getAttributeNode("id"))&&a.value===b}});u.find.TAG=r.getElementsByTagName?function(a,b){if(typeof b.getElementsByTagName!==C)return b.getElementsByTagName(a)}:function(a,b){var c,d=[],e=0,f=b.getElementsByTagName(a);if("*"===a){for(;c=f[e++];)1===c.nodeType&&d.push(c);return d}return f};u.find.CLASS=r.getElementsByClassName&&
function(a,b){if(typeof b.getElementsByClassName!==C&&G)return b.getElementsByClassName(a)};L=[];J=[];if(r.qsa=ba.test(b.querySelectorAll))g(function(a){a.innerHTML="<select><option selected=''></option></select>";a.querySelectorAll("[selected]").length||J.push("\\[[\\x20\\t\\r\\n\\f]*(?:value|checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped)");a.querySelectorAll(":checked").length||J.push(":checked")}),g(function(a){var c=
b.createElement("input");c.setAttribute("type","hidden");a.appendChild(c).setAttribute("t","");a.querySelectorAll("[t^='']").length&&J.push("[*^$]=[\\x20\\t\\r\\n\\f]*(?:''|\"\")");a.querySelectorAll(":enabled").length||J.push(":enabled",":disabled");a.querySelectorAll("*,:x");J.push(",.*:")});(r.matchesSelector=ba.test(A=I.webkitMatchesSelector||I.mozMatchesSelector||I.oMatchesSelector||I.msMatchesSelector))&&g(function(a){r.disconnectedMatch=A.call(a,"div");A.call(a,"[s!='']:x");L.push("!=",S)});
...
var d=u.attrHandle[c.toLowerCase()],d=d&&Y.call(u.attrHandle,c.toLowerCase())?d(a,c,!G):b;return d===b?r.attributes||!G?a.getAttribute(c):(d=a.getAttributeNode(c))&&d.specified?d.value:null:d};d.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};d.uniqueSort=function(a){var b,c=[],d=0,e=0;H=!r.detectDuplicates;ka=!r.sortStable&&a.slice(0);a.sort(M);if(H){for(;b=a[e++];)b===a[e]&&(d=c.push(e));for(;d--;)a.splice(c[d],1)}return a};va=d.getText=function(a){var b,c="",d=0;if(b=
a.nodeType)if(1===b||9===b||11===b){if("string"===typeof a.textContent)return a.textContent;for(a=a.firstChild;a;a=a.nextSibling)c+=va(a)}else{if(3===b||4===b)return a.nodeValue}else for(;b=a[d];d++)c+=va(b);return c};u=d.selectors={cacheLength:50,createPseudo:f,match:U,attrHandle:{},find:{},relative:{">":{dir:"parentNode",first:!0}," ":{dir:"parentNode"},"+":{dir:"previousSibling",first:!0},"~":{dir:"previousSibling"}},preFilter:{ATTR:function(a){a[1]=a[1].replace(da,ea);a[3]=(a[4]||a[5]||"").replace(da,
ea);"~="===a[2]&&(a[3]=" "+a[3]+" ");return a.slice(0,4)},CHILD:function(a){a[1]=a[1].toLowerCase();"nth"===a[1].slice(0,3)?(a[3]||d.error(a[0]),a[4]=+(a[4]?a[5]+(a[6]||1):2*("even"===a[3]||"odd"===a[3])),a[5]=+(a[7]+a[8]||"odd"===a[3])):a[3]&&d.error(a[0]);return a},PSEUDO:function(a){var c,d=!a[5]&&a[2];if(U.CHILD.test(a[0]))return null;if(a[3]&&a[4]!==b)a[2]=a[4];else if(d&&ma.test(d)&&(c=n(d,!0))&&(c=d.indexOf(")",d.length-c)-d.length))a[0]=a[0].slice(0,c),a[2]=d.slice(0,c);return a.slice(0,3)}},
filter:{TAG:function(a){var b=a.replace(da,ea).toLowerCase();return"*"===a?function(){return!0}:function(a){return a.nodeName&&a.nodeName.toLowerCase()===b}},CLASS:function(a){var b=N[a+" "];return b||(b=RegExp("(^|[\\x20\\t\\r\\n\\f])"+a+"([\\x20\\t\\r\\n\\f]|$)"))&&N(a,function(a){return b.test("string"===typeof a.className&&a.className||typeof a.getAttribute!==C&&a.getAttribute("class")||"")})},ATTR:function(a,b,c){return function(e){e=d.attr(e,a);if(null==e)return"!="===b;if(!b)return!0;e+="";
return"="===b?e===c:"!="===b?e!==c:"^="===b?c&&0===e.indexOf(c):"*="===b?c&&-1<e.indexOf(c):"$="===b?c&&e.slice(-c.length)===c:"~="===b?-1<(" "+e+" ").indexOf(c):"|="===b?e===c||e.slice(0,c.length+1)===c+"-":!1}},CHILD:function(a,b,c,d,e){var f="nth"!==a.slice(0,3),g="last"!==a.slice(-4),h="of-type"===b;return 1===d&&0===e?function(a){return!!a.parentNode}:function(b,c,k){var m,l,q,t,n;c=f!==g?"nextSibling":"previousSibling";var r=b.parentNode,v=h&&b.nodeName.toLowerCase();k=!k&&!h;if(r){if(f){for(;c;){for(l=
b;l=l[c];)if(h?l.nodeName.toLowerCase()===v:1===l.nodeType)return!1;n=c="only"===a&&!n&&"nextSibling"}return!0}n=[g?r.firstChild:r.lastChild];if(g&&k){k=r[w]||(r[w]={});m=k[a]||[];t=m[0]===D&&m[1];q=m[0]===D&&m[2];for(l=t&&r.childNodes[t];l=++t&&l&&l[c]||(q=t=0)||n.pop();)if(1===l.nodeType&&++q&&l===b){k[a]=[D,t,q];break}}else if(k&&(m=(b[w]||(b[w]={}))[a])&&m[0]===D)q=m[1];else for(;l=++t&&l&&l[c]||(q=t=0)||n.pop();)if((h?l.nodeName.toLowerCase()===v:1===l.nodeType)&&++q)if(k&&((l[w]||(l[w]={}))[a]=
...
clearQueue:function(a){return this.queue(a||"fx",[])},promise:function(a,b){var d,e=1,f=c.Deferred(),g=this,h=this.length,k=function(){--e||f.resolveWith(g,[g])};"string"!==typeof a&&(b=a,a=n);for(a=a||"fx";h--;)if((d=c._data(g[h],a+"queueHooks"))&&d.empty)e++,d.empty.add(k);k();return f.promise(b)}});var X,zb,Ha=/[\t\r\n\f]/g,qc=/\r/g,rc=/^(?:input|select|textarea|button|object)$/i,sc=/^(?:a|area)$/i,Ia=/^(?:checked|selected)$/i,R=c.support.getSetAttribute,qa=c.support.input;c.fn.extend({attr:function(a,
...
add:function(a,b,d,e,f){var g,h,k,l,q,t,m,v,p;if(k=c._data(a)){d.handler&&(l=d,d=l.handler,f=l.selector);d.guid||(d.guid=c.guid++);if(!(h=k.events))h=k.events={};if(!(q=k.handle))q=k.handle=function(a){return typeof c!==z&&(!a||c.event.triggered!==a.type)?c.event.dispatch.apply(q.elem,arguments):n},q.elem=a;b=(b||"").match(E)||[""];for(k=b.length;k--;)if(g=Bb.exec(b[k])||[],v=t=g[1],p=(g[2]||"").split(".").sort(),v){g=c.event.special[v]||{};v=(f?g.delegateType:g.bindType)||v;g=c.event.special[v]||
{};t=c.extend({type:v,origType:t,data:e,handler:d,guid:d.guid,selector:f,needsContext:f&&c.expr.match.needsContext.test(f),namespace:p.join(".")},l);if(!(m=h[v]))if(m=h[v]=[],m.delegateCount=0,!g.setup||!1===g.setup.call(a,e,p,q))a.addEventListener?a.addEventListener(v,q,!1):a.attachEvent&&a.attachEvent("on"+v,q);g.add&&(g.add.call(a,t),t.handler.guid||(t.handler.guid=d.guid));f?m.splice(m.delegateCount++,0,t):m.push(t);c.event.global[v]=!0}a=null}},remove:function(a,b,d,e,f){var g,h,k,l,q,n,m,v,
p,s,B,y=c.hasData(a)&&c._data(a);if(y&&(n=y.events)){b=(b||"").match(E)||[""];for(q=b.length;q--;)if(k=Bb.exec(b[q])||[],p=B=k[1],s=(k[2]||"").split(".").sort(),p){m=c.event.special[p]||{};p=(e?m.delegateType:m.bindType)||p;v=n[p]||[];k=k[2]&&RegExp("(^|\\.)"+s.join("\\.(?:.*\\.|)")+"(\\.|$)");for(l=g=v.length;g--;)if(h=v[g],(f||B===h.origType)&&(!d||d.guid===h.guid)&&(!k||k.test(h.namespace))&&(!e||e===h.selector||"**"===e&&h.selector))v.splice(g,1),h.selector&&v.delegateCount--,m.remove&&m.remove.call(a,
h);l&&!v.length&&((!m.teardown||!1===m.teardown.call(a,s,y.handle))&&c.removeEvent(a,p,y.handle),delete n[p])}else for(p in n)c.event.remove(a,p+b[q],d,e,!0);c.isEmptyObject(n)&&(delete y.handle,c._removeData(a,"events"))}},trigger:function(a,b,d,e){var f,g,h,k,l,q,t=[d||p],m=V.call(a,"type")?a.type:a;l=V.call(a,"namespace")?a.namespace.split("."):[];h=f=d=d||p;if(!(3===d.nodeType||8===d.nodeType)&&!Ab.test(m+c.event.triggered))if(0<=m.indexOf(".")&&(l=m.split("."),m=l.shift(),l.sort()),g=0>m.indexOf(":")&&
"on"+m,a=a[c.expando]?a:new c.Event(m,"object"===typeof a&&a),a.isTrigger=e?2:3,a.namespace=l.join("."),a.namespace_re=a.namespace?RegExp("(^|\\.)"+l.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,a.result=n,a.target||(a.target=d),b=null==b?[a]:c.makeArray(b,[a]),l=c.event.special[m]||{},e||!(l.trigger&&!1===l.trigger.apply(d,b))){if(!e&&!l.noBubble&&!c.isWindow(d)){k=l.delegateType||m;Ab.test(k+m)||(h=h.parentNode);for(;h;h=h.parentNode)t.push(h),f=h;if(f===(d.ownerDocument||p))t.push(f.defaultView||f.parentWindow||
s)}for(q=0;(h=t[q++])&&!a.isPropagationStopped();)a.type=1<q?k:l.bindType||m,(f=(c._data(h,"events")||{})[a.type]&&c._data(h,"handle"))&&f.apply(h,b),(f=g&&h[g])&&(c.acceptData(h)&&f.apply&&!1===f.apply(h,b))&&a.preventDefault();a.type=m;if(!e&&!a.isDefaultPrevented()&&(!l._default||!1===l._default.apply(t.pop(),b))&&c.acceptData(d)&&g&&d[m]&&!c.isWindow(d)){(f=d[g])&&(d[g]=null);c.event.triggered=m;try{d[m]()}catch(v){}c.event.triggered=n;f&&(d[g]=f)}return a.result}},dispatch:function(a){a=c.event.fix(a);
var b,d,e,f,g=[],h=C.call(arguments);b=(c._data(this,"events")||{})[a.type]||[];var k=c.event.special[a.type]||{};h[0]=a;a.delegateTarget=this;if(!(k.preDispatch&&!1===k.preDispatch.call(this,a))){g=c.event.handlers.call(this,a,b);for(b=0;(e=g[b++])&&!a.isPropagationStopped();){a.currentTarget=e.elem;for(f=0;(d=e.handlers[f++])&&!a.isImmediatePropagationStopped();)if(!a.namespace_re||a.namespace_re.test(d.namespace))if(a.handleObj=d,a.data=d.data,d=((c.event.special[d.origType]||{}).handle||d.handler).apply(e.elem,
...
n&&q.text!==f.text)$a(q).text=f.text,ab(q);else if("object"===n)q.parentNode&&(q.outerHTML=f.outerHTML),c.support.html5Clone&&(f.innerHTML&&!c.trim(q.innerHTML))&&(q.innerHTML=f.innerHTML);else if("input"===n&&za.test(f.type))q.defaultChecked=q.checked=f.checked,q.value!==f.value&&(q.value=f.value);else if("option"===n)q.defaultSelected=q.selected=f.defaultSelected;else if("input"===n||"textarea"===n)q.defaultValue=f.defaultValue}}}if(b)if(d){k=k||B(a);e=e||B(g);for(h=0;null!=(f=k[h]);h++)bb(f,e[h])}else bb(a,
g);e=B(g,"script");0<e.length&&ya(e,!l&&B(a,"script"));return g},buildFragment:function(a,b,d,e){for(var f,g,h,k,l,q,n=a.length,m=Xa(b),p=[],s=0;s<n;s++)if((g=a[s])||0===g)if("object"===c.type(g))c.merge(p,g.nodeType?[g]:g);else if(yc.test(g)){h=h||m.appendChild(b.createElement("div"));k=(Fb.exec(g)||["",""])[1].toLowerCase();q=y[k]||y._default;h.innerHTML=q[1]+g.replace(Eb,"<$1></$2>")+q[2];for(f=q[0];f--;)h=h.lastChild;!c.support.leadingWhitespace&&Ka.test(g)&&p.push(b.createTextNode(Ka.exec(g)[0]));
if(!c.support.tbody)for(f=(g="table"===k&&!Gb.test(g)?h.firstChild:"<table>"===q[1]&&!Gb.test(g)?h:0)&&g.childNodes.length;f--;)c.nodeName(l=g.childNodes[f],"tbody")&&!l.childNodes.length&&g.removeChild(l);c.merge(p,h.childNodes);for(h.textContent="";h.firstChild;)h.removeChild(h.firstChild);h=m.lastChild}else p.push(b.createTextNode(g));h&&m.removeChild(h);c.support.appendChecked||c.grep(B(p,"input"),Xb);for(s=0;g=p[s++];)if(!(e&&-1!==c.inArray(g,e))&&(a=c.contains(g.ownerDocument,g),h=B(m.appendChild(g),
...
n,f&&(h.onreadystatechange=c.noop,Qa&&delete S[f]),g)4!==h.readyState&&h.abort();else{s={};k=h.status;m=h.getAllResponseHeaders();"string"===typeof h.responseText&&(s.text=h.responseText);try{p=h.statusText}catch(y){p=""}!k&&a.isLocal&&!a.crossDomain?k=s.text?200:404:1223===k&&(k=204)}}catch(z){g||e(-1,z)}s&&e(k,p,s,m)};a.async?4===h.readyState?setTimeout(b):(f=++Oc,Qa&&(S||(S={},c(s).unload(Qa)),S[f]=b),h.onreadystatechange=b):b()},abort:function(){b&&b(n,!0)}}}});var T,ra,Pc=/^(?:toggle|show|hide)$/,
Rb=RegExp("^(?:([+-])=|)("+pa+")([a-z%]*)$","i"),Qc=/queueHooks$/,na=[function(a,b,d){var e,f,g,h,k,l=this,n={},p=a.style,m=a.nodeType&&P(a),s=c._data(a,"fxshow");d.queue||(h=c._queueHooks(a,"fx"),null==h.unqueued&&(h.unqueued=0,k=h.empty.fire,h.empty.fire=function(){h.unqueued||k()}),h.unqueued++,l.always(function(){l.always(function(){h.unqueued--;c.queue(a,"fx").length||h.empty.fire()})}));if(1===a.nodeType&&("height"in b||"width"in b))d.overflow=[p.overflow,p.overflowX,p.overflowY],"inline"===
c.css(a,"display")&&"none"===c.css(a,"float")&&(!c.support.inlineBlockNeedsLayout||"inline"===fb(a.nodeName)?p.display="inline-block":p.zoom=1);d.overflow&&(p.overflow="hidden",c.support.shrinkWrapBlocks||l.always(function(){p.overflow=d.overflow[0];p.overflowX=d.overflow[1];p.overflowY=d.overflow[2]}));for(e in b)if(f=b[e],Pc.exec(f)&&(delete b[e],g=g||"toggle"===f,f!==(m?"hide":"show")))n[e]=s&&s[e]||c.style(a,e);if(!c.isEmptyObject(n))for(e in s?"hidden"in s&&(m=s.hidden):s=c._data(a,"fxshow",
...
F.prototype;F.propHooks={_default:{get:function(a){if(null!=a.elem[a.prop]&&(!a.elem.style||null==a.elem.style[a.prop]))return a.elem[a.prop];a=c.css(a.elem,a.prop,"");return!a||"auto"===a?0:a},set:function(a){if(c.fx.step[a.prop])c.fx.step[a.prop](a);else a.elem.style&&(null!=a.elem.style[c.cssProps[a.prop]]||c.cssHooks[a.prop])?c.style(a.elem,a.prop,a.now+a.unit):a.elem[a.prop]=a.now}}};F.propHooks.scrollTop=F.propHooks.scrollLeft={set:function(a){a.elem.nodeType&&a.elem.parentNode&&(a.elem[a.prop]=
a.now)}};c.each(["toggle","show","hide"],function(a,b){var d=c.fn[b];c.fn[b]=function(a,c,g){return null==a||"boolean"===typeof a?d.apply(this,arguments):this.animate(U(b,!0),a,c,g)}});c.fn.extend({fadeTo:function(a,b,c,e){return this.filter(P).css("opacity",0).show().end().animate({opacity:b},a,c,e)},animate:function(a,b,d,e){var f=c.isEmptyObject(a),g=c.speed(b,d,e);b=function(){var b=qb(this,c.extend({},a),g);(f||c._data(this,"finish"))&&b.stop(!0)};b.finish=b;return f||!1===g.queue?this.each(b):
...
e.queue)};return e};c.easing={linear:function(a){return a},swing:function(a){return 0.5-Math.cos(a*Math.PI)/2}};c.timers=[];c.fx=F.prototype.init;c.fx.tick=function(){var a,b=c.timers,d=0;for(T=c.now();d<b.length;d++)a=b[d],!a()&&b[d]===a&&b.splice(d--,1);b.length||c.fx.stop();T=n};c.fx.timer=function(a){a()&&c.timers.push(a)&&c.fx.start()};c.fx.interval=13;c.fx.start=function(){ra||(ra=setInterval(c.fx.tick,c.fx.interval))};c.fx.stop=function(){clearInterval(ra);ra=null};c.fx.speeds={slow:600,fast:200,
_default:400};c.fx.step={};c.expr&&c.expr.filters&&(c.expr.filters.animated=function(a){return c.grep(c.timers,function(b){return a===b.elem}).length});c.fn.offset=function(a){if(arguments.length)return a===n?this:this.each(function(b){c.offset.setOffset(this,a,b)});var b,d,e={top:0,left:0},f=(d=this[0])&&d.ownerDocument;if(f){b=f.documentElement;if(!c.contains(b,d))return e;typeof d.getBoundingClientRect!==z&&(e=d.getBoundingClientRect());d=rb(f);return{top:e.top+(d.pageYOffset||b.scrollTop)-(b.clientTop||
0),left:e.left+(d.pageXOffset||b.scrollLeft)-(b.clientLeft||0)}}};c.offset={setOffset:function(a,b,d){var e=c.css(a,"position");"static"===e&&(a.style.position="relative");var f=c(a),g=f.offset(),h=c.css(a,"top"),k=c.css(a,"left"),l={},n={};("absolute"===e||"fixed"===e)&&-1<c.inArray("auto",[h,k])?(n=f.position(),e=n.top,k=n.left):(e=parseFloat(h)||0,k=parseFloat(k)||0);c.isFunction(b)&&(b=b.call(a,d,g));null!=b.top&&(l.top=b.top-g.top+e);null!=b.left&&(l.left=b.left-g.left+k);"using"in b?b.using.call(a,
l):f.css(l)}};c.fn.extend({position:function(){if(this[0]){var a,b,d={top:0,left:0},e=this[0];"fixed"===c.css(e,"position")?b=e.getBoundingClientRect():(a=this.offsetParent(),b=this.offset(),c.nodeName(a[0],"html")||(d=a.offset()),d.top+=c.css(a[0],"borderTopWidth",!0),d.left+=c.css(a[0],"borderLeftWidth",!0));return{top:b.top-d.top-c.css(e,"marginTop",!0),left:b.left-d.left-c.css(e,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var a=this.offsetParent||tb;a&&!c.nodeName(a,
"html")&&"static"===c.css(a,"position");)a=a.offsetParent;return a||tb})}});c.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(a,b){var d=/Y/.test(b);c.fn[a]=function(e){return c.access(this,function(a,e,h){var k=rb(a);if(h===n)return k?b in k?k[b]:k.document.documentElement[e]:a[e];k?k.scrollTo(!d?h:c(k).scrollLeft(),d?h:c(k).scrollTop()):a[e]=h},a,e,arguments.length,null)}});c.each({Height:"height",Width:"width"},function(a,b){c.each({padding:"inner"+a,content:b,"":"outer"+a},function(d,
e){c.fn[e]=function(e,g){var h=arguments.length&&(d||"boolean"!==typeof e),k=d||(!0===e||!0===g?"margin":"border");return c.access(this,function(b,d,e){return c.isWindow(b)?b.document.documentElement["client"+a]:9===b.nodeType?(d=b.documentElement,Math.max(b.body["scroll"+a],d["scroll"+a],b.body["offset"+a],d["offset"+a],d["client"+a])):e===n?c.css(b,d,k):c.style(b,d,e,k)},b,h?e:n,h,null)}})});c.fn.size=function(){return this.length};c.fn.andSelf=c.fn.addBack;"object"===typeof module&&module&&"object"===
typeof module.exports?module.exports=c:(s.jQuery=s.$=c,"function"===typeof define&&define.amd&&define("jquery",[],function(){return c}))})(window);
