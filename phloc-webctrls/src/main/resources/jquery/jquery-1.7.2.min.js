...
e,!d);b=c.filter(b,e)}return c.grep(a,function(a,e){return 0<=c.inArray(a,b)===d})}function ta(a){var b=ua.split("|");a=a.createDocumentFragment();if(a.createElement)for(;b.length;)a.createElement(b.pop());return a}function va(a,b){if(1===b.nodeType&&c.hasData(a)){var d,e,f;e=c._data(a);var g=c._data(b,e),k=e.events;if(k)for(d in delete g.handle,g.events={},k){e=0;for(f=k[d].length;e<f;e++)c.event.add(b,d,k[d][e])}g.data&&(g.data=c.extend({},g.data))}}function wa(a,b){var d;1===b.nodeType&&(b.clearAttributes&&
...
d,f.val()):a,null==d?d="":"number"===typeof d?d+="":c.isArray(d)&&(d=c.map(d,function(a){return null==a?"":a+""})),b=c.valHooks[this.type]||c.valHooks[this.nodeName.toLowerCase()],!b||!("set"in b)||b.set(this,d,"value")===p))this.value=d});if(f){if((b=c.valHooks[f.type]||c.valHooks[f.nodeName.toLowerCase()])&&"get"in b&&(d=b.get(f,"value"))!==p)return d;d=f.value;return"string"===typeof d?d.replace(sb,""):null==d?"":d}}});c.extend({valHooks:{option:{get:function(a){var b=a.attributes.value;return!b||
...
e||"boolean"!==typeof e&&(d=a.getAttributeNode(b))&&!1!==d.nodeValue?b.toLowerCase():p},set:function(a,b,d){!1===b?c.removeAttr(a,d):(b=c.propFix[d]||d,b in a&&(a[b]=!0),a.setAttribute(d,d.toLowerCase()));return d}};Ma||(Oa={name:!0,id:!0,coords:!0},z=c.valHooks.button={get:function(a,b){var c;return(c=a.getAttributeNode(b))&&(Oa[b]?""!==c.nodeValue:c.specified)?c.nodeValue:p},set:function(a,b,c){var e=a.getAttributeNode(c);e||(e=m.createAttribute(c),a.setAttributeNode(e));return e.nodeValue=b+""}},
c.attrHooks.tabindex.set=z.set,c.each(["width","height"],function(a,b){c.attrHooks[b]=c.extend(c.attrHooks[b],{set:function(a,c){if(""===c)return a.setAttribute(b,"auto"),c}})}),c.attrHooks.contenteditable={get:z.get,set:function(a,b,c){""===b&&(b="false");z.set(a,b,c)}});c.support.hrefNormalized||c.each(["href","src","width","height"],function(a,b){c.attrHooks[b]=c.extend(c.attrHooks[b],{get:function(a){a=a.getAttribute(b,2);return null===a?p:a}})});c.support.style||(c.attrHooks.style={get:function(a){return a.style.cssText.toLowerCase()||
...
c.event={add:function(a,b,d,e,f){var g,k,h,l,q,s,n,m,r;if(!(3===a.nodeType||8===a.nodeType||!b||!d||!(g=c._data(a)))){d.handler&&(n=d,d=n.handler,f=n.selector);d.guid||(d.guid=c.guid++);h=g.events;h||(g.events=h={});k=g.handle;k||(g.handle=k=function(a){return"undefined"!==typeof c&&(!a||c.event.triggered!==a.type)?c.event.dispatch.apply(k.elem,arguments):p},k.elem=a);b=c.trim(Ra(b)).split(" ");for(g=0;g<b.length;g++){l=Pa.exec(b[g])||[];q=l[1];s=(l[2]||"").split(".").sort();r=c.event.special[q]||
{};q=(f?r.delegateType:r.bindType)||q;r=c.event.special[q]||{};l=c.extend({type:q,origType:l[1],data:e,handler:d,guid:d.guid,selector:f,quick:f&&Ab(f),namespace:s.join(".")},n);m=h[q];if(!m&&(m=h[q]=[],m.delegateCount=0,!r.setup||!1===r.setup.call(a,e,s,k)))a.addEventListener?a.addEventListener(q,k,!1):a.attachEvent&&a.attachEvent("on"+q,k);r.add&&(r.add.call(a,l),l.handler.guid||(l.handler.guid=d.guid));f?m.splice(m.delegateCount++,0,l):m.push(l);c.event.global[q]=!0}a=null}},global:{},remove:function(a,
b,d,e,f){var g=c.hasData(a)&&c._data(a),k,h,l,q,s,n,m,r,p,u;if(g&&(m=g.events)){b=c.trim(Ra(b||"")).split(" ");for(k=0;k<b.length;k++)if(h=Pa.exec(b[k])||[],l=q=h[1],h=h[2],l){r=c.event.special[l]||{};l=(e?r.delegateType:r.bindType)||l;p=m[l]||[];s=p.length;h=h?RegExp("(^|\\.)"+h.split(".").sort().join("\\.(?:.*\\.)?")+"(\\.|$)"):null;for(n=0;n<p.length;n++)if(u=p[n],(f||q===u.origType)&&(!d||d.guid===u.guid)&&(!h||h.test(u.namespace))&&(!e||e===u.selector||"**"===e&&u.selector))p.splice(n--,1),u.selector&&
p.delegateCount--,r.remove&&r.remove.call(a,u);0===p.length&&s!==p.length&&((!r.teardown||!1===r.teardown.call(a,h))&&c.removeEvent(a,l,g.handle),delete m[l])}else for(l in m)c.event.remove(a,l+b[k],d,e,!0);if(c.isEmptyObject(m)){if(b=g.handle)b.elem=null;c.removeData(a,["events","handle"],!0)}}},customEvent:{getData:!0,setData:!0,changeData:!0},trigger:function(a,b,d,e){if(!d||!(3===d.nodeType||8===d.nodeType)){var f=a.type||a,g=[],k,h,l,q,s;if(!Qa.test(f+c.event.triggered)&&(0<=f.indexOf("!")&&
...
b))){s=[[d,l.bindType||f]];if(!e&&!l.noBubble&&!c.isWindow(d)){q=l.delegateType||f;g=Qa.test(q+f)?d:d.parentNode;for(h=null;g;g=g.parentNode)s.push([g,q]),h=g;h&&h===d.ownerDocument&&s.push([h.defaultView||h.parentWindow||u,q])}for(h=0;h<s.length&&!a.isPropagationStopped();h++)g=s[h][0],a.type=s[h][1],(q=(c._data(g,"events")||{})[a.type]&&c._data(g,"handle"))&&q.apply(g,b),(q=k&&g[k])&&(c.acceptData(g)&&!1===q.apply(g,b))&&a.preventDefault();a.type=f;if(!e&&!a.isDefaultPrevented()&&(!l._default||
!1===l._default.apply(d.ownerDocument,b))&&!("click"===f&&c.nodeName(d,"a"))&&c.acceptData(d))if(k&&d[f]&&("focus"!==f&&"blur"!==f||0!==a.target.offsetWidth)&&!c.isWindow(d))(h=d[k])&&(d[k]=null),c.event.triggered=f,d[f](),c.event.triggered=p,h&&(d[k]=h);return a.result}}else for(h in d=c.cache,d)d[h].events&&d[h].events[f]&&c.event.trigger(a,b,d[h].handle.elem,!0)}},dispatch:function(a){a=c.event.fix(a||u.event);var b=(c._data(this,"events")||{})[a.type]||[],d=b.delegateCount,e=[].slice.call(arguments,
0),f=!a.exclusive&&!a.namespace,g=c.event.special[a.type]||{},k=[],h,l,q,s,n,m,r;e[0]=a;a.delegateTarget=this;if(!(g.preDispatch&&!1===g.preDispatch.call(this,a))){if(d&&!(a.button&&"click"===a.type)){q=c(this);q.context=this.ownerDocument||this;for(l=a.target;l!=this;l=l.parentNode||this)if(!0!==l.disabled){n={};m=[];q[0]=l;for(h=0;h<d;h++){s=b[h];r=s.selector;if(n[r]===p){var ga=n,y=r,w;if(s.quick){w=s.quick;var x=l.attributes||{};w=(!w[1]||l.nodeName.toLowerCase()===w[1])&&(!w[2]||(x.id||{}).value===
w[2])&&(!w[3]||w[3].test((x["class"]||{}).value))}else w=q.is(r);ga[y]=w}n[r]&&m.push(s)}m.length&&k.push({elem:l,matches:m})}}b.length>d&&k.push({elem:this,matches:b.slice(d)});for(h=0;h<k.length&&!a.isPropagationStopped();h++){d=k[h];a.currentTarget=d.elem;for(b=0;b<d.matches.length&&!a.isImmediatePropagationStopped();b++)if(s=d.matches[b],f||!a.namespace&&!s.namespace||a.namespace_re&&a.namespace_re.test(s.namespace))a.data=s.data,a.handleObj=s,s=((c.event.special[s.origType]||{}).handle||s.handler).apply(d.elem,
e),s!==p&&(a.result=s,!1===s&&(a.preventDefault(),a.stopPropagation()))}g.postDispatch&&g.postDispatch.call(this,a);return a.result}},props:"attrChange attrName relatedNode srcElement altKey bubbles cancelable ctrlKey currentTarget eventPhase metaKey relatedTarget shiftKey target timeStamp view which".split(" "),fixHooks:{},keyHooks:{props:["char","charCode","key","keyCode"],filter:function(a,b){null==a.which&&(a.which=null!=b.charCode?b.charCode:b.keyCode);return a}},mouseHooks:{props:"button buttons clientX clientY fromElement offsetX offsetY pageX pageY screenX screenY toElement".split(" "),
...
(c.event.special.submit={setup:function(){if(c.nodeName(this,"form"))return!1;c.event.add(this,"click._submit keypress._submit",function(a){a=a.target;if((a=c.nodeName(a,"input")||c.nodeName(a,"button")?a.form:p)&&!a._submit_attached)c.event.add(a,"submit._submit",function(a){a._submit_bubble=!0}),a._submit_attached=!0})},postDispatch:function(a){a._submit_bubble&&(delete a._submit_bubble,this.parentNode&&!a.isTrigger&&c.event.simulate("submit",this.parentNode,a,!0))},teardown:function(){if(c.nodeName(this,
...
t.length&&9===b.nodeType&&!u&&r.match.ID.test(t[0])&&!r.match.ID.test(t[t.length-1]))&&(k=n.find(t.shift(),b,u),b=k.expr?n.filter(k.expr,k.set)[0]:k.set[0]),b){k=e?{expr:t.pop(),set:x(e)}:n.find(t.pop(),1===t.length&&("~"===t[0]||"+"===t[0])&&b.parentNode?b.parentNode:b,u);h=k.expr?n.filter(k.expr,k.set):k.set;for(0<t.length?l=x(h):p=!1;t.length;)k=s=t.pop(),r.relative[s]?k=t.pop():s="",null==k&&(k=b),r.relative[s](l,k,u)}else l=[];l||(l=h);l||n.error(s||a);if("[object Array]"===g.call(l))if(p)if(b&&
...
e[2])if(l=r.filter[g],h=e[1],f=!1,e.splice(1,1),"\\"!==h.substr(h.length-1)){u===t&&(t=[]);if(r.preFilter[g])if(e=r.preFilter[g](e,u,c,t,d,w)){if(!0===e)continue}else f=k=!0;if(e)for(q=0;null!=(h=u[q]);q++)h&&(k=l(h,e,q,u),s=d^k,c&&null!=k?s?f=!0:u[q]=!1:s&&(t.push(h),f=!0));if(k!==p){c||(u=t);a=a.replace(r.match[g],"");if(!f)return[];break}}if(a===m)if(null==f)n.error(a);else break;m=a}return u};n.error=function(a){throw Error("Syntax error, unrecognized expression: "+a);};var u=n.getText=function(a){var b,
...
b){c.fn[a]=function(d,e){var f=c.map(this,b,d);Bb.test(a)||(e=d);e&&"string"===typeof e&&(f=c.filter(e,f));f=1<this.length&&!Fb[a]?c.unique(f):f;if((1<this.length||Db.test(e))&&Cb.test(a))f=f.reverse();return this.pushStack(f,a,Eb.call(arguments).join(","))}});c.extend({filter:function(a,b,d){d&&(a=":not("+a+")");return 1===b.length?c.find.matchesSelector(b[0],a)?[b[0]]:[]:c.find.matches(a,b)},dir:function(a,b,d){var e=[];for(a=a[b];a&&9!==a.nodeType&&(d===p||1!==a.nodeType||!c(a).is(d));)1===a.nodeType&&
...
style:function(a,b,d,e){if(a&&!(3===a.nodeType||8===a.nodeType||!a.style)){var f,g=c.camelCase(b),k=a.style,h=c.cssHooks[g];b=c.cssProps[g]||g;if(d!==p){e=typeof d;if("string"===e&&(f=Pb.exec(d)))d=+(f[1]+1)*+f[2]+parseFloat(c.css(a,b)),e="number";if(!(null==d||"number"===e&&isNaN(d)))if("number"===e&&!c.cssNumber[g]&&(d+="px"),!h||!("set"in h)||(d=h.set(a,d))!==p)try{k[b]=d}catch(l){}}else return h&&"get"in h&&(f=h.get(a,!1,e))!==p?f:k[b]}},css:function(a,b,d){var e,f;b=c.camelCase(b);f=c.cssHooks[b];
b=c.cssProps[b]||b;"cssFloat"===b&&(b="float");if(f&&"get"in f&&(e=f.get(a,!0,d))!==p)return e;if(I)return I(a,b)},swap:function(a,b,c){var e={},f;for(f in b)e[f]=a.style[f],a.style[f]=b[f];c=c.call(a);for(f in b)a.style[f]=e[f];return c}});c.curCSS=c.css;m.defaultView&&m.defaultView.getComputedStyle&&(Ya=function(a,b){var d,e,f,g=a.style;b=b.replace(Nb,"-$1").toLowerCase();if((e=a.ownerDocument.defaultView)&&(f=e.getComputedStyle(a,null)))d=f.getPropertyValue(b),""===d&&!c.contains(a.ownerDocument.documentElement,
...
return this},abort:function(a){a=a||"abort";u&&u.abort(a);d(0,a);return this}};k.promise(t);t.success=t.done;t.error=t.fail;t.complete=h.add;t.statusCode=function(a){if(a){var b;if(2>x)for(b in a)l[b]=[l[b],a[b]];else b=a[t.status],t.then(b,b)}return this};e.url=((a||e.url)+"").replace(Tb,"").replace(Xb,L[1]+"//");e.dataTypes=c.trim(e.dataType||"*").toLowerCase().split(Ba);null==e.crossDomain&&(w=bb.exec(e.url.toLowerCase()),e.crossDomain=!(!w||!(w[1]!=L[1]||w[2]!=L[2]||(w[3]||("http:"===w[1]?80:
443))!=(L[3]||("http:"===L[1]?80:443)))));e.data&&(e.processData&&"string"!==typeof e.data)&&(e.data=c.param(e.data,e.traditional));W(da,e,b,t);if(2===x)return!1;B=e.global;e.type=e.type.toUpperCase();e.hasContent=!Wb.test(e.type);B&&0===c.active++&&c.event.trigger("ajaxStart");if(!e.hasContent&&(e.data&&(e.url+=(ab.test(e.url)?"&":"?")+e.data,delete e.data),q=e.url,!1===e.cache)){w=c.now();var E=e.url.replace($b,"$1_="+w);e.url=E+(E===e.url?(ab.test(e.url)?"&":"?")+"_="+w:"")}(e.data&&e.hasContent&&
!1!==e.contentType||b.contentType)&&t.setRequestHeader("Content-Type",e.contentType);e.ifModified&&(q=q||e.url,c.lastModified[q]&&t.setRequestHeader("If-Modified-Since",c.lastModified[q]),c.etag[q]&&t.setRequestHeader("If-None-Match",c.etag[q]));t.setRequestHeader("Accept",e.dataTypes[0]&&e.accepts[e.dataTypes[0]]?e.accepts[e.dataTypes[0]]+("*"!==e.dataTypes[0]?", "+eb+"; q=0.01":""):e.accepts["*"]);for(C in e.headers)t.setRequestHeader(C,e.headers[C]);if(e.beforeSend&&(!1===e.beforeSend.call(f,t,
e)||2===x))return t.abort(),!1;for(C in{success:1,error:1,complete:1})t[C](e[C]);if(u=W(db,e,b,t)){t.readyState=1;B&&g.trigger("ajaxSend",[t,e]);e.async&&0<e.timeout&&(y=setTimeout(function(){t.abort("timeout")},e.timeout));try{x=1,u.send(s,d)}catch(v){if(2>x)d(-1,v);else throw v;}}else d(-1,"No Transport");return t},param:function(a,b){var d=[],e=function(a,b){b=c.isFunction(b)?b():b;d[d.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};b===p&&(b=c.ajaxSettings.traditional);if(c.isArray(a)||
a.jquery&&!c.isPlainObject(a))c.each(a,function(){e(this.name,this.value)});else for(var f in a)ea(f,a[f],b,e);return d.join("&").replace(Sb,"+")}});c.extend({active:0,lastModified:{},etag:{}});var ac=c.now(),$=/(\=)\?(&|$)|\?\?/i;c.ajaxSetup({jsonp:"callback",jsonpCallback:function(){return c.expando+"_"+ac++}});c.ajaxPrefilter("json jsonp",function(a,b,d){b="string"===typeof a.data&&/^application\/x\-www\-form\-urlencoded/.test(a.contentType);if("jsonp"===a.dataTypes[0]||!1!==a.jsonp&&($.test(a.url)||
b&&$.test(a.data))){var e,f=a.jsonpCallback=c.isFunction(a.jsonpCallback)?a.jsonpCallback():a.jsonpCallback,g=u[f],k=a.url,h=a.data,l="$1"+f+"$2";!1!==a.jsonp&&(k=k.replace($,l),a.url===k&&(b&&(h=h.replace($,l)),a.data===h&&(k+=(/\?/.test(k)?"&":"?")+a.jsonp+"="+f)));a.url=k;a.data=h;u[f]=function(a){e=[a]};d.always(function(){u[f]=g;if(e&&c.isFunction(g))u[f](e[0])});a.converters["script json"]=function(){e||c.error(f+" was not called");return e[0]};a.dataTypes[0]="json";return"script"}});c.ajaxSetup({accepts:{script:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript"},
...
d[k])}catch(h){}f.send(a.hasContent&&a.data||null);b=function(d,h){var k,n,m,r,u;try{if(b&&(h||4===f.readyState))if(b=p,g&&(f.onreadystatechange=c.noop,oa&&delete G[g]),h)4!==f.readyState&&f.abort();else{k=f.status;m=f.getAllResponseHeaders();r={};if((u=f.responseXML)&&u.documentElement)r.xml=u;try{r.text=f.responseText}catch(y){}try{n=f.statusText}catch(w){n=""}!k&&a.isLocal&&!a.crossDomain?k=r.text?200:404:1223===k&&(k=204)}}catch(x){h||e(-1,x)}r&&e(k,n,r,m)};!a.async||4===f.readyState?b():(g=++bc,
oa&&(G||(G={},c(u).unload(oa)),G[g]=b),f.onreadystatechange=b)},abort:function(){b&&b(0,1)}}}});var fa={},B,J,cc=/^(?:toggle|show|hide)$/,dc=/^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i,aa,Y=[["height","marginTop","marginBottom","paddingTop","paddingBottom"],["width","marginLeft","marginRight","paddingLeft","paddingRight"],["opacity"]],X;c.fn.extend({show:function(a,b,d){if(a||0===a)return this.animate(O("show",3),a,b,d);d=0;for(var e=this.length;d<e;d++)a=this[d],a.style&&(b=a.style.display,!c._data(a,"olddisplay")&&
...
g.queue&&c._mark(this);var b=c.extend({},g),d=1===this.nodeType,e=d&&c(this).is(":hidden"),f,m,n,p,r;b.animatedProperties={};for(n in a)if(f=c.camelCase(n),n!==f&&(a[f]=a[n],delete a[n]),(m=c.cssHooks[f])&&"expand"in m)for(n in p=m.expand(a[f]),delete a[f],p)n in a||(a[n]=p[n]);for(f in a){m=a[f];c.isArray(m)?(b.animatedProperties[f]=m[1],m=a[f]=m[0]):b.animatedProperties[f]=b.specialEasing&&b.specialEasing[f]||b.easing||"swing";if("hide"===m&&e||"show"===m&&!e)return b.complete.call(this);if(d&&
("height"===f||"width"===f))b.overflow=[this.style.overflow,this.style.overflowX,this.style.overflowY],"inline"===c.css(this,"display")&&"none"===c.css(this,"float")&&(!c.support.inlineBlockNeedsLayout||"inline"===Fa(this.nodeName)?this.style.display="inline-block":this.style.zoom=1)}null!=b.overflow&&(this.style.overflow="hidden");for(n in a)if(d=new c.fx(this,b,n),m=a[n],cc.test(m))if(f=c._data(this,"toggle"+n)||("toggle"===m?e?"show":"hide":0))c._data(this,"toggle"+n,"show"===f?"hide":"show"),
d[f]();else d[m]();else f=dc.exec(m),p=d.cur(),f?(m=parseFloat(f[2]),r=f[3]||(c.cssNumber[n]?"":"px"),"px"!==r&&(c.style(this,n,(m||1)+r),p*=(m||1)/d.cur(),c.style(this,n,p+r)),f[1]&&(m=("-="===f[1]?-1:1)*m+p),d.custom(p,m,r)):d.custom(p,m,"");return!0}var g=c.speed(b,d,e);if(c.isEmptyObject(a))return this.each(g.complete,[!1]);a=c.extend({},a);return!1===g.queue?this.each(f):this.queue(g.queue,f)},stop:function(a,b,d){"string"!==typeof a&&(d=b,b=a,a=p);b&&!1!==a&&this.queue(a||"fx",[]);return this.each(function(){var b,
...
var a,b=c.css(this.elem,this.prop);return isNaN(a=parseFloat(b))?!b||"auto"===b?0:b:a},custom:function(a,b,d){function e(a){return f.step(a)}var f=this,g=c.fx;this.startTime=X||Ea();this.end=b;this.now=this.start=a;this.pos=this.state=0;this.unit=d||this.unit||(c.cssNumber[this.prop]?"":"px");e.queue=this.options.queue;e.elem=this.elem;e.saveState=function(){c._data(f.elem,"fxshow"+f.prop)===p&&(f.options.hide?c._data(f.elem,"fxshow"+f.prop,f.start):f.options.show&&c._data(f.elem,"fxshow"+f.prop,
f.end))};e()&&(c.timers.push(e)&&!aa)&&(aa=setInterval(g.tick,g.interval))},show:function(){var a=c._data(this.elem,"fxshow"+this.prop);this.options.orig[this.prop]=a||c.style(this.elem,this.prop);this.options.show=!0;a!==p?this.custom(this.cur(),a):this.custom("width"===this.prop||"height"===this.prop?1:0,this.cur());c(this.elem).show()},hide:function(){this.options.orig[this.prop]=c._data(this.elem,"fxshow"+this.prop)||c.style(this.elem,this.prop);this.options.hide=!0;this.custom(this.cur(),0)},
step:function(a){var b,d=X||Ea(),e=!0,f=this.elem,g=this.options;if(a||d>=g.duration+this.startTime){this.now=this.end;this.pos=this.state=1;this.update();g.animatedProperties[this.prop]=!0;for(b in g.animatedProperties)!0!==g.animatedProperties[b]&&(e=!1);if(e){null!=g.overflow&&!c.support.shrinkWrapBlocks&&c.each(["","X","Y"],function(a,b){f.style["overflow"+b]=g.overflow[a]});g.hide&&c(f).hide();if(g.hide||g.show)for(b in g.animatedProperties)c.style(f,b,g.orig[b]),c.removeData(f,"fxshow"+b,!0),
c.removeData(f,"toggle"+b,!0);if(a=g.complete)g.complete=!1,a.call(f)}return!1}Infinity==g.duration?this.now=d:(a=d-this.startTime,this.state=a/g.duration,this.pos=c.easing[g.animatedProperties[this.prop]](this.state,a,0,1,g.duration),this.now=this.start+(this.end-this.start)*this.pos);this.update();return!0}};c.extend(c.fx,{tick:function(){for(var a,b=c.timers,d=0;d<b.length;d++)a=b[d],!a()&&b[d]===a&&b.splice(d--,1);b.length||c.fx.stop()},interval:13,stop:function(){clearInterval(aa);aa=null},speeds:{slow:600,
fast:200,_default:400},step:{opacity:function(a){c.style(a.elem,"opacity",a.now)},_default:function(a){a.elem.style&&null!=a.elem.style[a.prop]?a.elem.style[a.prop]=a.now+a.unit:a.elem[a.prop]=a.now}}});c.each(Y.concat.apply([],Y),function(a,b){b.indexOf("margin")&&(c.fx.step[b]=function(a){c.style(a.elem,b,Math.max(0,a.now)+a.unit)})});c.expr&&c.expr.filters&&(c.expr.filters.animated=function(a){return c.grep(c.timers,function(b){return a===b.elem}).length});var fb,ec=/^t(?:able|d|h)$/i,gb=/^(?:body|html)$/i;
