...
g.removeAttribute("id");var k=m.createElement("div");k.style.position="absolute";k.style.top="0px";k.style.left="0px";k.className+=" FixedHeader_Cloned "+a+" "+b;"fixedHeader"==a&&(k.style.zIndex=f.oZIndexes.top);"fixedFooter"==a&&(k.style.zIndex=f.oZIndexes.bottom);"fixedLeft"==a?k.style.zIndex=f.oZIndexes.left:"fixedRight"==a&&(k.style.zIndex=f.oZIndexes.right);g.style.margin="0";k.appendChild(g);m.body.appendChild(k);return{nNode:g,nWrapper:k,sType:a,sPosition:"",sTop:"",sLeft:"",fnClone:c,iCells:d}},
...
"sLeft",c.iTableLeft+"px","left",f.style))},_fnScrollFixedHeader:function(a){for(var b=this.fnGetSettings(),c=b.oMes,d=FixedHeader.oWin,e=a.nWrapper,g=0,k=b.nTable.getElementsByTagName("tbody"),h=0;h<k.length;++h)g+=k[h].offsetHeight;c.iTableTop>d.iScrollTop+b.oOffset.top?(this._fnUpdateCache(a,"sPosition","absolute","position",e.style),this._fnUpdateCache(a,"sTop",c.iTableTop+"px","top",e.style),this._fnUpdateCache(a,"sLeft",c.iTableLeft+"px","left",e.style)):d.iScrollTop+b.oOffset.top>c.iTableTop+
...
e(l),b=e(m),c=FixedHeader.oWin,d=FixedHeader.oDoc;d.iHeight=b.height();d.iWidth=b.width();c.iHeight=a.height();c.iWidth=a.width();c.iScrollTop=a.scrollTop();c.iScrollLeft=a.scrollLeft();c.iScrollRight=d.iWidth-c.iScrollLeft-c.iWidth;c.iScrollBottom=d.iHeight-c.iScrollTop-c.iHeight};FixedHeader.version="2.1.0";e(l).scroll(function(){FixedHeader.fnMeasure();for(var a=0,b=FixedHeader.afnScroll.length;a<b;a++)FixedHeader.afnScroll[a]()});e.fn.dataTable.FixedHeader=FixedHeader;return e.fn.DataTable.FixedHeader=
FixedHeader};"function"===typeof define&&define.amd?define("datatables-fixedheader",["jquery","datatables"],n):jQuery&&!jQuery.fn.dataTable.FixedHeader&&n(jQuery,jQuery.fn.dataTable)})(window,document);
