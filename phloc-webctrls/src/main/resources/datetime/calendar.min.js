...
return}f=new Date(c.date);0===a.navtype&&f.setDateOnly(new Date);c.dateClicked=!1;var g=f.getFullYear(),k=f.getMonth(),h=function(a){var b=f.getDate(),c=f.getMonthDays(a);b>c&&f.setDate(c);f.setMonth(a)};switch(a.navtype){case 400:Calendar.removeClass(a,"hilite");d=Calendar._TT.ABOUT;d="undefined"!==typeof d?d+(c.showsTime?Calendar._TT.ABOUT_TIME:""):'Help and about box text is not translated into this language.\nIf you know this language and you feel generous please update\nthe corresponding file in "lang" subdir to match calendar-en.js\nand send it back to <mihai_bazon@yahoo.com> to get it into the distribution  ;-)\n\nThank you!\nhttp://dynarch.com/mishoo/calendar.epl\n';
alert(d);return;case -2:g>c.minYear&&f.setFullYear(g-1);break;case -1:0<k?h(k-1):g-- >c.minYear&&(f.setFullYear(g),h(11));break;case 1:11>k?h(k+1):g<c.maxYear&&(f.setFullYear(g+1),h(0));break;case 2:g<c.maxYear&&f.setFullYear(g+1);break;case 100:c.setFirstDayOfWeek(a.fdow);return;case 50:d=a._range;e=a.innerHTML;for(g=d.length;0<=--g&&d[g]!=e;);b&&b.shiftKey?0>--g&&(g=d.length-1):++g>=d.length&&(g=0);a.innerHTML=d[g];c.onUpdateTime();return;case 0:if("function"==typeof c.getDateStatus&&c.getDateStatus(f,
...
f));for(var h=7;0<h;--h)e=Calendar.createElement("td",f),e.calendar=this,Calendar._add_evs(e)}if(this.showsTime){f=Calendar.createElement("tr",k);f.className="time";e=Calendar.createElement("td",f);e.className="time";e.colSpan=2;e.innerHTML=Calendar._TT.TIME||"&#160;";e=Calendar.createElement("td",f);e.className="time";e.colSpan=this.weekNumbers?4:3;var d=function(a,b,c,d){var f=Calendar.createElement("span",e);f.className=a;f.innerHTML=b;f.calendar=g;f.ttip=Calendar._TT.TIME_PART;f.navtype=50;f._range=
[];if("number"!=typeof c)f._range=c;else for(a=c;a<=d;++a)f._range[f._range.length]=10>a&&10<=d?"0"+a:""+a;Calendar._add_evs(f);return f},j=g.date.getHours(),k=g.date.getMinutes(),l=!g.time24,h=12<j;l&&h&&(j-=12);var m=d("hour",j,l?1:0,l?12:23),j=Calendar.createElement("span",e);j.innerHTML=":";j.className="colon";var n=d("minute",k,0,59),i=null,e=Calendar.createElement("td",f);e.className="time";e.colSpan=2;l?i=d("ampm",h?"pm":"am",["am","pm"]):e.innerHTML="&#160;";g.onSetTime=function(){var a,b=
this.date.getHours(),c=this.date.getMinutes();l&&((a=12<=b)&&(b-=12),0===b&&(b=12),i.innerHTML=a?"pm":"am");m.innerHTML=10>b?"0"+b:b;n.innerHTML=10>c?"0"+c:c};g.onUpdateTime=function(){var a=this.date,b=parseInt(m.innerHTML,10);l&&(/pm/i.test(i.innerHTML)&&12>b?b+=12:/am/i.test(i.innerHTML)&&12==b&&(b=0));var c=a.getDate(),d=a.getMonth(),e=a.getFullYear();a.setHours(b);a.setMinutes(parseInt(n.innerHTML,10));a.setFullYear(e);a.setMonth(d);a.setDate(c);this.dateClicked=!1;this.callHandler()}}else this.onSetTime=
...
case 37:case 38:case 39:case 40:if(c){var e,f,g,k,h,c=37==d||38==d;h=37==d||39==d?1:7;var j=function(){k=b.currentDateEl;var a=k.pos;e=a&15;f=a>>4;g=b.ar_days[f][e]};j();for(var l=function(){var a=new Date(b.date);a.setDate(a.getDate()-h);b.setDate(a)},m=function(){var a=new Date(b.date);a.setDate(a.getDate()+h);b.setDate(a)};;){switch(d){case 37:if(0<=--e)g=b.ar_days[f][e];else{e=6;d=38;continue}break;case 38:0<=--f?g=b.ar_days[f][e]:(l(),j());break;case 39:if(7>++e)g=b.ar_days[f][e];else{e=0;d=
...
Calendar.prototype._init=function(a,b){var c=new Date,d=c.getFullYear(),e=c.getMonth(),c=c.getDate();this.table.style.visibility="hidden";var f=b.getFullYear();f<this.minYear?(f=this.minYear,b.setFullYear(f)):f>this.maxYear&&(f=this.maxYear,b.setFullYear(f));this.firstDayOfWeek=a;this.date=new Date(b);var g=b.getMonth(),k=b.getDate();b.getMonthDays();b.setDate(1);var h=(b.getDay()-this.firstDayOfWeek)%7;0>h&&(h+=7);b.setDate(-h);b.setDate(b.getDate()+1);for(var h=this.tbody.firstChild,j=this.ar_days=
[],l=Calendar._TT.WEEKEND,m=this.multiple?this.datesCells={}:null,n=0;6>n;++n,h=h.nextSibling){var i=h.firstChild;this.weekNumbers&&(i.className="day wn",i.innerHTML=b.getWeekNumber(),i=i.nextSibling);h.className="daysrow";for(var s=!1,p,v=j[n]=[],q=0;7>q;++q,i=i.nextSibling,b.setDate(p+1)){p=b.getDate();var w=b.getDay();i.className="day";i.pos=n<<4|q;v[q]=i;var t=b.getMonth()==g;if(t)i.otherMonth=!1,s=!0;else if(this.showsOtherMonths)i.className+=" othermonth",i.otherMonth=!0;else{i.className="emptycell";
i.innerHTML="&#160;";i.disabled=!0;continue}i.disabled=!1;i.innerHTML=this.getDateText?this.getDateText(b,p):p;m&&(m[b.print("%Y%m%d")]=i);if(this.getDateStatus){var r=this.getDateStatus(b,f,g,p);if(this.getDateToolTip){var u=this.getDateToolTip(b,f,g,p);u&&(i.title=u)}!0===r?(i.className+=" disabled",i.disabled=!0):(/disabled/i.test(r)&&(i.disabled=!0),i.className+=" "+r)}i.disabled||(i.caldate=new Date(b),i.ttip="_",!this.multiple&&(t&&p==k&&this.hiliteToday)&&(i.className+=" selected",this.currentDateEl=
i),b.getFullYear()==d&&(b.getMonth()==e&&p==c)&&(i.className+=" today",i.ttip+=Calendar._TT.PART_TODAY),-1!=l.indexOf(w.toString())&&(i.className+=i.otherMonth?" oweekend":" weekend"))}!s&&!this.showsOtherMonths&&(h.className="emptyrow")}this.title.innerHTML=Calendar._MN[g]+", "+f;this.onSetTime();this.table.style.visibility="visible";this._initMultipleDates()};
...
k;)for(var h=document.getElementsByTagName(b[--k]),j=null,l=h.length;0<l;){var j=h[--l],d=Calendar.getAbsolutePos(j),m=d.x,n=j.offsetWidth+m,d=d.y,i=j.offsetHeight+d;this.hidden||m>f||n<e||d>c||i<g?(j.__msh_save_visibility||(j.__msh_save_visibility=a(j)),j.style.visibility=j.__msh_save_visibility):(j.__msh_save_visibility||(j.__msh_save_visibility=a(j)),j.style.visibility="hidden")}};
...
Date.parseDate=function(a,b){for(var c=new Date,d=0,e=-1,f=0,g=a.split(/\W+/),k=b.match(/%./g),h=0,j=0,l=0,m=0,h=0;h<g.length;++h)if(g[h])switch(k[h]){case "%d":case "%e":f=parseInt(g[h],10);break;case "%m":e=parseInt(g[h],10)-1;break;case "%Y":case "%y":d=parseInt(g[h],10);100>d&&(d+=29<d?1900:2E3);break;case "%b":case "%B":for(j=0;12>j;++j)if(Calendar._MN[j].substr(0,g[h].length).toLowerCase()==g[h].toLowerCase()){e=j;break}break;case "%H":case "%I":case "%k":case "%l":l=parseInt(g[h],10);break;
case "%P":case "%p":/pm/i.test(g[h])&&12>l?l+=12:/am/i.test(g[h])&&12<=l&&(l-=12);break;case "%M":m=parseInt(g[h],10)}isNaN(d)&&(d=c.getFullYear());isNaN(e)&&(e=c.getMonth());isNaN(f)&&(f=c.getDate());isNaN(l)&&(l=c.getHours());isNaN(m)&&(m=c.getMinutes());if(0!==d&&-1!==e&&0!==f)return new Date(d,e,f,l,m,0);d=0;e=-1;for(h=f=0;h<g.length;++h)if(-1!=g[h].search(/[a-zA-Z]+/)){k=-1;for(j=0;12>j;++j)if(Calendar._MN[j].substr(0,g[h].length).toLowerCase()==g[h].toLowerCase()){k=j;break}-1!==k&&(-1!==e&&
(f=e+1),e=k)}else 12>=parseInt(g[h],10)&&-1===e?e=g[h]-1:31<parseInt(g[h],10)&&0===d?(d=parseInt(g[h],10),100>d&&(d+=29<d?1900:2E3)):0===f&&(f=g[h]);0===d&&(d=c.getFullYear());return-1!==e&&0!==f?new Date(d,e,f,l,m,0):c};Date.prototype.getMonthDays=function(a){var b=this.getFullYear();"undefined"===typeof a&&(a=this.getMonth());return 0===b%4&&(0!==b%100||0===b%400)&&1===a?29:Date._MD[a]};
...
Date.prototype.print=function(a){var b=this.getMonth(),c=this.getDate(),d=this.getFullYear(),e=this.getWeekNumber(),f=this.getDay(),g={},k=this.getHours(),h=12<=k,j=h?k-12:k,l=this.getDayOfYear();0===j&&(j=12);var m=this.getMinutes(),n=this.getSeconds();g["%a"]=Calendar._SDN[f];g["%A"]=Calendar._DN[f];g["%b"]=Calendar._SMN[b];g["%B"]=Calendar._MN[b];g["%C"]=1+Math.floor(d/100);g["%d"]=10>c?"0"+c:c;g["%e"]=c;g["%H"]=10>k?"0"+k:k;g["%I"]=10>j?"0"+j:j;g["%j"]=100>l?10>l?"00"+l:"0"+l:l;g["%k"]=k;g["%l"]=
j;g["%m"]=9>b?"0"+(1+b):1+b;g["%M"]=10>m?"0"+m:m;g["%n"]="\n";g["%p"]=h?"PM":"AM";g["%P"]=h?"pm":"am";g["%s"]=Math.floor(this.getTime()/1E3);g["%S"]=10>n?"0"+n:n;g["%t"]="\t";g["%U"]=g["%W"]=g["%V"]=10>e?"0"+e:e;g["%u"]=f+1;g["%w"]=f;g["%y"]=(""+d).substr(2,2);g["%Y"]=d;g["%%"]="%";b=/%./g;if(!Calendar.is_ie5&&!Calendar.is_khtml)return a.replace(b,function(a){return g[a]||a});c=a.match(b);for(d=0;d<c.length;d++)if(e=g[c[d]])b=RegExp(c[d],"g"),a=a.replace(b,e);return a};
