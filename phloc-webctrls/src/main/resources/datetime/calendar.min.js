...
Calendar.dayMouseOver=function(a){var b=Calendar.getElement(a);if(Calendar.isRelated(b,a)||Calendar._C||b.disabled)return!1;if(b.ttip){if("_"==b.ttip.substr(0,1))b.ttip=b.caldate.print(b.calendar.ttDateFormat)+b.ttip.substr(1);b.calendar.tooltips.innerHTML=b.ttip}300!=b.navtype&&(Calendar.addClass(b,"hilite"),b.caldate&&Calendar.addClass(b.parentNode,"rowhilite"));return Calendar.stopEvent(a)};
...
Calendar.cellClick=function(a,b){var c=a.calendar,d=!1,e=!1,f=null;if("undefined"==typeof a.navtype){if(c.currentDateEl&&(Calendar.removeClass(c.currentDateEl,"selected"),Calendar.addClass(a,"selected"),d=c.currentDateEl==a,!d))c.currentDateEl=a;c.date.setDateOnly(a.caldate);var f=c.date,g=!(c.dateClicked=!a.otherMonth);!g&&!c.currentDateEl?c._toggleMultipleDate(new Date(f)):e=!a.disabled;g&&c._init(c.firstDayOfWeek,f)}else{if(200==a.navtype){Calendar.removeClass(a,"hilite");c.callCloseHandler();
return}f=new Date(c.date);0==a.navtype&&f.setDateOnly(new Date);c.dateClicked=!1;var g=f.getFullYear(),i=f.getMonth(),h=function(a){var b=f.getDate(),c=f.getMonthDays(a);b>c&&f.setDate(c);f.setMonth(a)};switch(a.navtype){case 400:Calendar.removeClass(a,"hilite");d=Calendar._TT.ABOUT;d="undefined"!=typeof d?d+(c.showsTime?Calendar._TT.ABOUT_TIME:""):'Help and about box text is not translated into this language.\nIf you know this language and you feel generous please update\nthe corresponding file in "lang" subdir to match calendar-en.js\nand send it back to <mihai_bazon@yahoo.com> to get it into the distribution  ;-)\n\nThank you!\nhttp://dynarch.com/mishoo/calendar.epl\n';
alert(d);return;case -2:g>c.minYear&&f.setFullYear(g-1);break;case -1:0<i?h(i-1):g-- >c.minYear&&(f.setFullYear(g),h(11));break;case 1:11>i?h(i+1):g<c.maxYear&&(f.setFullYear(g+1),h(0));break;case 2:g<c.maxYear&&f.setFullYear(g+1);break;case 100:c.setFirstDayOfWeek(a.fdow);return;case 50:d=a._range;e=a.innerHTML;for(g=d.length;0<=--g&&!(d[g]==e););b&&b.shiftKey?0>--g&&(g=d.length-1):++g>=d.length&&(g=0);a.innerHTML=d[g];c.onUpdateTime();return;case 0:if("function"==typeof c.getDateStatus&&c.getDateStatus(f,
...
f=Calendar.createElement("tr",d);f.className="daynames";if(this.weekNumbers)e=Calendar.createElement("td",f),e.className="name wn",e.innerHTML=Calendar._TT.WK;for(d=7;0<d;--d)if(e=Calendar.createElement("td",f),!d)e.navtype=100,e.calendar=this,Calendar._add_evs(e);this.firstdayname=this.weekNumbers?f.firstChild.nextSibling:f.firstChild;this._displayWeekdays();this.tbody=i=Calendar.createElement("tbody",a);for(d=6;0<d;--d){f=Calendar.createElement("tr",i);this.weekNumbers&&(e=Calendar.createElement("td",
f));for(var h=7;0<h;--h)e=Calendar.createElement("td",f),e.calendar=this,Calendar._add_evs(e)}this.showsTime?(f=Calendar.createElement("tr",i),f.className="time",e=Calendar.createElement("td",f),e.className="time",e.colSpan=2,e.innerHTML=Calendar._TT.TIME||"&#160;",e=Calendar.createElement("td",f),e.className="time",e.colSpan=this.weekNumbers?4:3,function(){function a(b,c,d,f){var h=Calendar.createElement("span",e);h.className=b;h.innerHTML=c;h.calendar=g;h.ttip=Calendar._TT.TIME_PART;h.navtype=50;
h._range=[];if("number"!=typeof d)h._range=d;else for(b=d;b<=f;++b)h._range[h._range.length]=10>b&&10<=f?"0"+b:""+b;Calendar._add_evs(h);return h}var b=g.date.getHours(),c=g.date.getMinutes(),d=!g.time24,h=12<b;d&&h&&(b-=12);var i=a("hour",b,d?1:0,d?12:23),b=Calendar.createElement("span",e);b.innerHTML=":";b.className="colon";var n=a("minute",c,0,59),p=null;e=Calendar.createElement("td",f);e.className="time";e.colSpan=2;d?p=a("ampm",h?"pm":"am",["am","pm"]):e.innerHTML="&#160;";g.onSetTime=function(){var a,
b=this.date.getHours(),c=this.date.getMinutes();if(d)(a=12<=b)&&(b-=12),0==b&&(b=12),p.innerHTML=a?"pm":"am";i.innerHTML=10>b?"0"+b:b;n.innerHTML=10>c?"0"+c:c};g.onUpdateTime=function(){var b=this.date,a=parseInt(i.innerHTML,10);d&&(/pm/i.test(p.innerHTML)&&12>a?a+=12:/am/i.test(p.innerHTML)&&12==a&&(a=0));var c=b.getDate(),e=b.getMonth(),f=b.getFullYear();b.setHours(a);b.setMinutes(parseInt(n.innerHTML,10));b.setFullYear(f);b.setMonth(e);b.setDate(c);this.dateClicked=!1;this.callHandler()}}()):this.onSetTime=
...
case 37:case 38:case 39:case 40:if(c){var e,f,g,i,h,c=37==d||38==d;h=37==d||39==d?1:7;var k=function(){i=b.currentDateEl;var a=i.pos;e=a&15;f=a>>4;g=b.ar_days[f][e]};k();for(var l=function(){var a=new Date(b.date);a.setDate(a.getDate()-h);b.setDate(a)},m=function(){var a=new Date(b.date);a.setDate(a.getDate()+h);b.setDate(a)};;){switch(d){case 37:if(0<=--e)g=b.ar_days[f][e];else{e=6;d=38;continue}break;case 38:0<=--f?g=b.ar_days[f][e]:(l(),k());break;case 39:if(7>++e)g=b.ar_days[f][e];else{e=0;d=
40;continue}break;case 40:++f<b.ar_days.length?g=b.ar_days[f][e]:(m(),k())}break}g&&(g.disabled?c?l():m():Calendar.cellClick(g))}break;case 13:c&&Calendar.cellClick(b.currentDateEl,a);break;default:return!1}return Calendar.stopEvent(a)};
Calendar.prototype._init=function(a,b){var c=new Date,d=c.getFullYear(),e=c.getMonth(),c=c.getDate();this.table.style.visibility="hidden";var f=b.getFullYear();if(f<this.minYear)f=this.minYear,b.setFullYear(f);else if(f>this.maxYear)f=this.maxYear,b.setFullYear(f);this.firstDayOfWeek=a;this.date=new Date(b);var g=b.getMonth(),i=b.getDate();b.getMonthDays();b.setDate(1);var h=(b.getDay()-this.firstDayOfWeek)%7;0>h&&(h+=7);b.setDate(-h);b.setDate(b.getDate()+1);for(var h=this.tbody.firstChild,k=this.ar_days=
[],l=Calendar._TT.WEEKEND,m=this.multiple?this.datesCells={}:null,o=0;6>o;++o,h=h.nextSibling){var j=h.firstChild;if(this.weekNumbers)j.className="day wn",j.innerHTML=b.getWeekNumber(),j=j.nextSibling;h.className="daysrow";for(var u=!1,n,p=k[o]=[],q=0;7>q;++q,j=j.nextSibling,b.setDate(n+1)){n=b.getDate();var v=b.getDay();j.className="day";j.pos=o<<4|q;p[q]=j;var s=b.getMonth()==g;if(s)j.otherMonth=!1,u=!0;else if(this.showsOtherMonths)j.className+=" othermonth",j.otherMonth=!0;else{j.className="emptycell";
j.innerHTML="&#160;";j.disabled=!0;continue}j.disabled=!1;j.innerHTML=this.getDateText?this.getDateText(b,n):n;m&&(m[b.print("%Y%m%d")]=j);if(this.getDateStatus){var r=this.getDateStatus(b,f,g,n);if(this.getDateToolTip){var t=this.getDateToolTip(b,f,g,n);if(t)j.title=t}if(!0===r)j.className+=" disabled",j.disabled=!0;else{if(/disabled/i.test(r))j.disabled=!0;j.className+=" "+r}}if(!j.disabled){j.caldate=new Date(b);j.ttip="_";if(!this.multiple&&s&&n==i&&this.hiliteToday)j.className+=" selected",this.currentDateEl=
j;b.getFullYear()==d&&b.getMonth()==e&&n==c&&(j.className+=" today",j.ttip+=Calendar._TT.PART_TODAY);-1!=l.indexOf(v.toString())&&(j.className+=j.otherMonth?" oweekend":" weekend")}}if(!u&&!this.showsOtherMonths)h.className="emptyrow"}this.title.innerHTML=Calendar._MN[g]+", "+f;this.onSetTime();this.table.style.visibility="visible";this._initMultipleDates()};
...
Date.parseDate=function(a,b){for(var c=new Date,d=0,e=-1,f=0,g=a.split(/\W+/),i=b.match(/%./g),h=0,k=0,l=0,m=0,h=0;h<g.length;++h)if(g[h])switch(i[h]){case "%d":case "%e":f=parseInt(g[h],10);break;case "%m":e=parseInt(g[h],10)-1;break;case "%Y":case "%y":d=parseInt(g[h],10);100>d&&(d+=29<d?1900:2E3);break;case "%b":case "%B":for(k=0;12>k;++k)if(Calendar._MN[k].substr(0,g[h].length).toLowerCase()==g[h].toLowerCase()){e=k;break}break;case "%H":case "%I":case "%k":case "%l":l=parseInt(g[h],10);break;
case "%P":case "%p":/pm/i.test(g[h])&&12>l?l+=12:/am/i.test(g[h])&&12<=l&&(l-=12);break;case "%M":m=parseInt(g[h],10)}isNaN(d)&&(d=c.getFullYear());isNaN(e)&&(e=c.getMonth());isNaN(f)&&(f=c.getDate());isNaN(l)&&(l=c.getHours());isNaN(m)&&(m=c.getMinutes());if(0!=d&&-1!=e&&0!=f)return new Date(d,e,f,l,m,0);d=0;e=-1;for(h=f=0;h<g.length;++h)if(-1!=g[h].search(/[a-zA-Z]+/)){i=-1;for(k=0;12>k;++k)if(Calendar._MN[k].substr(0,g[h].length).toLowerCase()==g[h].toLowerCase()){i=k;break}-1!=i&&(-1!=e&&(f=e+
1),e=i)}else 12>=parseInt(g[h],10)&&-1==e?e=g[h]-1:31<parseInt(g[h],10)&&0==d?(d=parseInt(g[h],10),100>d&&(d+=29<d?1900:2E3)):0==f&&(f=g[h]);0==d&&(d=c.getFullYear());return-1!=e&&0!=f?new Date(d,e,f,l,m,0):c};Date.prototype.getMonthDays=function(a){var b=this.getFullYear();"undefined"==typeof a&&(a=this.getMonth());return 0==b%4&&(0!=b%100||0==b%400)&&1==a?29:Date._MD[a]};
...
Date.prototype.print=function(a){var b=this.getMonth(),c=this.getDate(),d=this.getFullYear(),e=this.getWeekNumber(),f=this.getDay(),g={},i=this.getHours(),h=12<=i,k=h?i-12:i,l=this.getDayOfYear();0==k&&(k=12);var m=this.getMinutes(),o=this.getSeconds();g["%a"]=Calendar._SDN[f];g["%A"]=Calendar._DN[f];g["%b"]=Calendar._SMN[b];g["%B"]=Calendar._MN[b];g["%C"]=1+Math.floor(d/100);g["%d"]=10>c?"0"+c:c;g["%e"]=c;g["%H"]=10>i?"0"+i:i;g["%I"]=10>k?"0"+k:k;g["%j"]=100>l?10>l?"00"+l:"0"+l:l;g["%k"]=i;g["%l"]=
k;g["%m"]=9>b?"0"+(1+b):1+b;g["%M"]=10>m?"0"+m:m;g["%n"]="\n";g["%p"]=h?"PM":"AM";g["%P"]=h?"pm":"am";g["%s"]=Math.floor(this.getTime()/1E3);g["%S"]=10>o?"0"+o:o;g["%t"]="\t";g["%U"]=g["%W"]=g["%V"]=10>e?"0"+e:e;g["%u"]=f+1;g["%w"]=f;g["%y"]=(""+d).substr(2,2);g["%Y"]=d;g["%%"]="%";b=/%./g;if(!Calendar.is_ie5&&!Calendar.is_khtml)return a.replace(b,function(a){return g[a]||a});c=a.match(b);for(d=0;d<c.length;d++)if(e=g[c[d]])b=RegExp(c[d],"g"),a=a.replace(b,e);return a};
