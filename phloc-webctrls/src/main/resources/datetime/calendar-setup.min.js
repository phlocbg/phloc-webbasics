...
a.inputField||a.displayArea,c=a.inputField?a.ifFormat:a.daFormat,e=!1,d=window.calendar;if(b)a.date=Date.parseDate(b.value||b.innerHTML,c);!d||!a.cache?(window.calendar=d=new Calendar(a.firstDay,a.date,a.onSelect||g,a.onClose||function(a){a.hide()}),d.showsTime=a.showsTime,d.time24="24"==a.timeFormat,d.weekNumbers=a.weekNumbers,e=!0):(a.date&&d.setDate(a.date),d.hide());if(a.multiple){d.multiple={};for(b=a.multiple.length;0<=--b;){var f=a.multiple[b],i=f.print("%Y%m%d");d.multiple[i]=f}}d.showsOtherMonths=
