...
b("cache",!1);b("showOthers",!1);b("multiple",null);var e,f=["inputField","displayArea","button"];for(e in f)"string"===typeof a[f[e]]&&(a[f[e]]=document.getElementById(a[f[e]]));if(!a.flat&&!a.multiple&&!a.inputField&&!a.displayArea&&!a.button)return alert("Calendar.setup:\n  Nothing to setup (no fields found).  Please check your code"),!1;if(null!==a.flat){"string"===typeof a.flat&&(a.flat=document.getElementById(a.flat));if(!a.flat)return alert("Calendar.setup:\n  Flat specified but can't find parent."),
