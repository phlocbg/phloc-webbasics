 ...
 */
public class ComparatorTableFixedCurrencyFormat extends ComparatorTableBigDecimal
{
  private final ECurrency m_eCurrency;

  public ComparatorTableFixedCurrencyFormat (@Nonnull final Locale aLocale, @Nonnull final ECurrency eCurrency)
  {
    super (aLocale);
    if (eCurrency == null)
