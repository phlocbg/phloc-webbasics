...
public enum EOpenGraphObjectTypeBusiness implements IHasID <String>
{
  ...
  @Nullable
  public static EOpenGraphObjectTypeBusiness getFromID (@Nullable final String sID)
  {
    return EnumHelper.getFromIDOrNull (EOpenGraphObjectTypeBusiness.class, sID);
  }
}
