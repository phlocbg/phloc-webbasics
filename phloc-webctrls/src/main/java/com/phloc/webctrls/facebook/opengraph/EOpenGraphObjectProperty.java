...
public enum EOpenGraphObjectProperty implements IHasID <String>
{
 ...
 TITLE ("title"),
 /**
  * The URL of an image which is used in stories published about this object. We
  * suggest that you give us an image of at least 200x200 pixels. However,
  ...
  * section. Note that once an object's type is set and has been used in a story
  * that its type can not be changed. For a list of built-in types, please see
  * our list of common open graph object types.
  */
 TYPE ("type"),
 /**
 ...
 VIDEO ("video"),
 /**
  * The URL of audio that to accompany this object. See the Audio type reference
 ...
 SITE_NAME ("site_name"),
 /**
  * The word that appears before the object's title in a story or sentence (such
  * as "an Omelette"). The value of this property should be a string that is a
  * member of the Enum {a, an, the, "", auto}. When 'auto' is selected, Facebook
  * will choose between 'a' or 'an'. Default is blank.
  */
 ...
 APP_ID ("app_id");
  ...
  {
    this.m_sID = CFacebook.OPENGRAPH_PREFIX + ':' + sID;
  }
