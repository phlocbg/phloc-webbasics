...
public enum ESWFJSPathProvider implements IJSPathProvider
{
  SWFOBJECT ("swf/swfobject.js", true);

  private final String m_sPath;
  private final boolean m_bCanBeBundled;

  private ESWFJSPathProvider (@Nonnull @Nonempty final String sPath, final boolean bCanBeBundled)
  {
