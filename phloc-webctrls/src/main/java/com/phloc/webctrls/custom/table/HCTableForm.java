...
public class HCTableForm extends AbstractHCTable <HCTableForm> implements IHCTableForm <HCTableForm>
{
  ...
  public HCTableForm (@Nullable final HCCol aCol)
  {
    super (aCol);
  }

  public HCTableForm (@Nullable final HCCol... aCols)
  {
    super (aCols);
  }

  public HCTableForm (@Nullable final Iterable <? extends HCCol> aCols)
  {
    super (aCols);
  }

  @Nonnull
  public HCTableForm setFocusHandlingEnabled (final boolean bFocusHandlingEnabled)
  {
