...
public final class CBootstrapCSS
{
  ...
  public static final ICSSClassProvider BOTTOM_UP = DefaultCSSClassProvider.create ("bottom-up");
  ...
  public static final ICSSClassProvider POPOVER_INNER = DefaultCSSClassProvider.create ("popover-inner");
