 ...
 */
package com.phloc.tinymce4.config;
 ...
 */
@IsSPIImplementation
public final class ThirdPartyModuleProvider_phloc_tinymce4 implements IThirdPartyModuleProviderSPI
{
  public static final IThirdPartyModule TINYMCE4 = new ThirdPartyModule ("TinyMCE",
                                                                         "Moxiecode Systems AB",
                                                                         ELicense.LGPL21,
                                                                         CTinyMCE4.TINYMCE_VERSION_4_0_18,
                                                                         "http://www.tinymce.com");

  @Nullable
  public IThirdPartyModule [] getAllThirdPartyModules ()
  {
    return new IThirdPartyModule [] { TINYMCE4 };
  }
}
