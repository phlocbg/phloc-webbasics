...
public final class UserManager extends AbstractSimpleDAO implements IUserManager, IReloadableDAO
{
  ...
  protected EChange onInit ()
  {
    ...
    _addUser (new User (CSecurity.USER_ADMINISTRATOR_ID,
                        ...
                        GlobalPasswordManager.createUserDefaultPasswordHash (CSecurity.USER_ADMINISTRATOR_PASSWORD),
    ...
    _addUser (new User (CSecurity.USER_USER_ID,
                        ...
                        GlobalPasswordManager.createUserDefaultPasswordHash (CSecurity.USER_USER_PASSWORD),
    ...
    _addUser (new User (CSecurity.USER_GUEST_ID,
                        ...
                        GlobalPasswordManager.createUserDefaultPasswordHash (CSecurity.USER_GUEST_PASSWORD),
                              ...
                              final boolean bDisabled)
  {
    ...
    final User aUser = new User (sLoginName,
                                 sEmailAddress,
                                 GlobalPasswordManager.createUserDefaultPasswordHash (sPlainTextPassword),
                                 sFirstName,
                                 sLastName,
                                 aDesiredLocale,
                                 aCustomAttrs,
  ...
  public EChange setUserPassword (@Nullable final String sUserID, @Nonnull final String sNewPlainTextPassword)
  {
    ...
    final PasswordHash aPasswordHash = GlobalPasswordManager.createUserDefaultPasswordHash (sNewPlainTextPassword);
    m_aRWLock.writeLock ().lock ();
    try
    {
  ...
  public boolean areUserIDAndPasswordValid (@Nullable final String sUserID, @Nullable final String sPlainTextPassword)
  {
    ...
    final PasswordHash aPasswordHash = GlobalPasswordManager.createUserPasswordHash (sPasswordHashAlgorithm, sPlainTextPassword);
